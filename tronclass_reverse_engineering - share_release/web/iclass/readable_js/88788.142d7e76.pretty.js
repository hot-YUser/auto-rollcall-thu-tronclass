(self.webpackChunklms=self.webpackChunklms||[
  ...
  [
    ...
    5021:(e, t, r)=>{
      ...
      r(269193), e.exports=[
        "$rootScope", "$scope", "$routeParams", "$http", "ExamHelper", "ExamSubject", "activityRepository", function(e, t, o, s, a, c, u){
          var l, d;
          e.context=e.context||{
          }, e.progressUi||(e.progressUi={
            answeredNum:0, subjectsNum:0, inPreview:!0
          });
          var m=o.questionnaireId;
          e.progressUi.subjectsNum=0, t.calProgress=function(){
            e.progressUi.answeredNum=a.getCompletedSubjectsNum(t.subjects);
            var r=e.progressUi.answeredNum/e.progressUi.subjectsNum*100;
            return e.progressUi.progress=0<=r&&r<=100?"".concat(r, "%"):"0%"
          }, t.loadComponents=()=>{
            r.e(55883).then(r.bind(r, 678264))
          };
          var p=null===(l=window.globalData)||void 0===l?void 0:l.user.userNo, v=null===(d=window.globalData)||void 0===d?void 0:d.user.name;
          t.usernameAndUserNo="".concat(v, "***").concat(p), t.$watch("progressUi.inPreview", (e=>{
            e||i("#symbol-water-mark").remove()
          })), t.ui=a.getUIHelper(), t.getSubjectIndex=function(e, r){
            if(t.subjects)return a.getSubjectIndex(e, r, t.subjects)
          };
          return u.initQuestionnaire(m).then((function(r){
            return e.context.questionnaireIsAnonymous=r.is_anonymous, t.questionnaire=r
          })), s.get("/api/questionnaire/".concat(m, "/preview")).success((function(r){
            var i=n.map(r.subjects, (e=>c.createSubjectBySavedSubject(e, !1)));
            return t.subjects=i, e.progressUi.subjectsNum=a.getSubjectsNum(t.subjects)
          })).error((function(){
          }))
        }
      ]
      ...
      r(540590), r(658379), e.exports=[
        "$scope", "$http", "$routeParams", "$q", "toastr", (e, t, r, o, s)=>{
          var a;
          e.pageSize=20, e.pushAnswersOfSubject=(t, r)=>{
            return n=[
            ], t.forEach((t=>{
              var o=i.find(t.submission_data.subjects, {
                subject_id:r
              });
              o?(o.created_by=t.created_by, n.push(e.answers.push(o))):n.push(void 0)
            })), n;
            var n
          }, e.loadMore=()=>{
            if(!e.lockOfLoading){
              e.lockOfLoading=!0;
              var i=r.questionnaireId, n=o.defer();
              n.promise.then((t=>{
                e.lockOfLoading=!1, t.offset>=t.count&&t.count>e.pageSize||(e.offset=t.offset+t.len, e.pushAnswersOfSubject(t.submissions, e.subject.id))
              })), t.get("/api/questionnaires/".concat(i, "/all-submissions?offset=").concat(e.offset, "&limit=").concat(e.pageSize, "&subject_id=").concat(e.subject.id)).success((e=>n.resolve(e))).error(s.decorateError())
            }
          }, e.subjectTitleText=()=>{
            if(e.subject)return n(e.subject.description).text()
          }, e.viewSubjectAnswers=t=>{
            n("#short-answer-popup").foundation("reveal", "open"), e.subject=t, a(), e.loadMore()
          }, a=()=>{
            e.answers=[
            ], e.offset=0, e.lockOfLoading=!1;
            var t=n("#short-answer-popup .container"), r=n("#short-answer-popup .inner-container");
            return t.scroll((()=>{
              t.scrollTop()+t.height()>r.height()-100&&e.loadMore()
            }))
          }
        }
      ]
    }, 61004:(e, t, r)=>{
      r(418665), r(700533), r(14602), r(73215);
      ...
      var i=new(0, r(962893).default);
      i.$on("setLocalStorage", ((e, t)=>(window.localStorage.setItem(e, t), i.$emit("localStorageChanged")))), e.exports=i
    }, 71819:(e, t, r)=>{
      e.exports=r.p+"assets/audio/8d3d29385987dca9aa1c.mp3"
    }, 73215:(e, t, r)=>{
      var i=r(962893), n=r(846413), o=r(595738), s=r(671520), a=(r(269193), r(592207)), c=r.n(a), u=(r(207452), r(552979)), l=(r(906048), r(348825), r(754989), r(658379), function(e, t){
        void 0===t&&(t=!0);
        var r=e/1e3;
        (!r||r<0)&&(r=0);
        ...
        var r=(0, o.EW)((function(){
          ...
          (e, t)
        })), i=(0, o.WQ)("isInstructorView", !1), n=(0, o.WQ)("seekable", !0);
        return{
      ...
      const p=(0, o.pM)({
        props:{
          ...
          return(0, o.wB)(n, (t=>{
            ...
            formatTs:l, isActive:n, eleRef:i, clickItem:()=>{
              r("click", e.chapter)
            }
          }
        }
      ...
      ], !1, null, "393a67bf", null).exports;
      r(540590), r(418665), r(14602);
      var h=r(272505), b=r.n(h), g=r(218831), _=r(755373), y=function(e, t, r, i){
          ...
          return w(this, (function(i){
            switch(i.label){
              ...
              case 1:return(r=i.sent()).data.data&&r.data.data.length>0?[
                2, (0, g.camelizeKeys)(r.data.data)
              ]
              :[
                2, [
                ]
          ...
          return w(this, (function(o){
            switch(o.label){
              ...
              case 4:return o.trys.push([
                ...
                4, b().post("".concat(e.server, "/api/org/").concat(e.organization, "/media/chapter-task"), n)
              ];
              case 5:return[
          ...
          return w(this, (function(i){
            switch(i.label){
              case 0:return i.trys.push([
                ...
                4, b().get("".concat(e.server, "/api/org/").concat(e.organization, "/media/chapter-tasks"), {
        ...
        return void 0===t&&(t=1), void 0===r&&(r=10), y(void 0, void 0, void 0, (function(){
          var i;
          return w(this, (function(n){
            switch(n.label){
              case 0:return n.trys.push([
                ...
                4, b().get("".concat(e.server, "/api/org/").concat(e.organization, "/media/").concat(e.mediaId, "/captions"), {
                  params:{
                    page:t, page_size:r
                  }
                })
              ...
              case 1:return i=n.sent(), [
                2, (0, g.camelizeKeys)(i.data.data)
              ];
          ...
          return w(this, (function(o){
            switch(o.label){
              ...
              case 3:return r=i, n={
                ...
                4, b().post("".concat(e.server, "/api/org/").concat(e.organization, "/media/").concat(e.mediaId, "/caption-task"), n)
              ];
              case 4:return[
                2, o.sent().data.data.id
              ];
          ...
          return w(this, (function(r){
            switch(r.label){
              case 0:return r.trys.push([
                ...
                4, b().get("".concat(e.server, "/api/media/media-caption-tasks/progress"), {
                  params:{
                    media_ids:[
                      e.mediaId
                    ]
          ...
          return w(this, (function(n){
            switch(n.label){
              case 0:return n.trys.push([
                ...
                4, b().put("".concat(e.server, "/api/org/").concat(e.organization, "/media/").concat(e.mediaId, "/captions/").concat(t), i)
              ];
              case 1:return[
                2, n.sent()
              ];
          ...
          return w(this, (function(r){
            switch(r.label){
              case 0:return r.trys.push([
                ...
                4, b().delete("".concat(e.server, "/api/org/").concat(e.organization, "/media/").concat(e.mediaId, "/captions/").concat(t))
              ];
              case 1:return[
                2, r.sent()
              ];
        ...
        return y(void 0, void 0, void 0, (function(){
          return w(this, (function(t){
            switch(t.label){
              case 0:return[
                4, b().get("".concat(e.server, "/api/media-captions/supported-languages"))
              ];
              case 1:return[
                2, t.sent().data.data
              ]
        ...
        return y(void 0, void 0, void 0, (function(){
          ...
          return w(this, (function(c){
            switch(c.label){
              ...
              }, i.translateBridgeUrl?o=i.translateBridgeUrl:i.airAccessToken&&(s={
              ...
              case 4:return a=c.sent(), [
                2, (0, g.camelizeKeys)(a.data.data)
              ]
            }
          }))
        }))
      ...
      const M=(0, o.pM)({
        components:{
          ...
          var t=(0, o.KR)([
          ]), r=(0, o.KR)(), i=(0, o.KR)(""), n=u.default.t("airOptimization.loading"), a=(0, o.WQ)("airGenStatus", {
            hasCaptions:!1, processing:{
              type:"", status:!1
            }
          }), l=(0, o.WQ)("isInstructorView", !1), d=0, p=m(e).jumpTo, v=()=>{
            d=setInterval($(c().mark((function r(){
              var n, o;
              return c().wrap((function(r){
                for(;
                ;
                )switch(r.prev=r.next){
                  case 0:return r.next=2, I(e.config);
                  case 2:if("PROCESSING"===(n=r.sent).status){
                    r.next=11;
                    break
                  }
                  if(d&&clearInterval(d), d=0, "FINISHED"!==n.status){
                    r.next=11;
                    break
                  }
                  return r.next=9, k(e.config);
            ...
            var t=$(c().mark((function t(){
              return c().wrap((function(t){
                for(;
                ;
                )switch(t.prev=t.next){
                  case 0:return i.value="PROCESSING", t.next=3, S(e.config);
                  case 3:if(t.sent){
                    t.next=6;
                    break
                  }
          ...
          ();
          return(0, o.sV)($(c().mark((function n(){
            var u;
            return c().wrap((function(n){
              for(;
              ;
              )switch(n.prev=n.next){
                case 0:return n.next=2, k(e.config);
                case 2:return t.value=n.sent, n.next=5, (0, o.dY)();
                case 5:if(new s(r.value), t.value.length){
                  n.next=11;
                  break
                }
                return n.next=9, I(e.config);
                case 9:(u=n.sent)&&(i.value=u.status, "PROCESSING"===u.status&&(a.processing.status=u.status, a.processing.type="chapter", v()));
            ...
            }, jumpTo:p, progressStatus:i, generateText:n, generate:f, isInstructorView:l
          }
        }
      });
      const D=(0, v.A)(M, (function(){
        var e=this, t=e.$createElement, r=e._self._c||t;
        return r("div", {
      ...
      ], !1, null, "26ee356e", null).exports;
      var L=r(384027), U=r(769075), N=r(929119);
      ...
      const F=(0, o.pM)({
        props:{
          ...
          }).isActive, i=(0, o.WQ)("keywords", (0, o.KR)("")), n=(0, o.WQ)("isInstructorView", !1), s=(0, o.KR)(e.data.text), a=(0, o.KR)(!1), d=function(){
            var r=B(c().mark((function r(){
              return c().wrap((function(r){
                for(;
                ;
                )switch(r.prev=r.next){
                  case 0:return r.next=2, T(e.config, e.data.id, s.value);
                  case 2:r.sent&&(a.value=!1, t.emit("on-update-caption", e.data.id, s.value));
            ...
            var r=B(c().mark((function r(){
              return c().wrap((function(r){
                ...
                ;
                  ...
                  case 0:return r.next=2, U.A.open({
                  ...
                  case 5:return r.next=7, R(e.config, e.data.id);
          ...
          ();
          return(0, o.wB)((()=>e.data), (()=>{
            s.value=e.data.text
          })), {
            isActive:r, formatTs:l, clickItem:()=>{
              t.emit("click", e.data)
            }, save:d, cancel:()=>{
              s.value=e.data.text, a.value=!1
            }, text:s, del:p, editMode:a, edit:()=>{
              a.value=!0
            }, keywords:i, highlightKeyword:N.w, isInstructorView:n
          }
        }
      });
      const q=(0, v.A)(F, (function(){
        var e=this, t=e.$createElement, r=e._self._c||t;
        return r("div", {
          ...
          }), e._v(" "), !e.editMode&&e.isInstructorView?r("Dropdown", {
      ...
      ], !1, null, "5b28a054", null).exports, z=(0, o.pM)({
        components:{
          SubtitlesItem:q
        }, props:{
          data:{
      ...
      const G=(0, v.A)(z, (function(){
        var e=this, t=e.$createElement, r=e._self._c||t;
        return r("div", e._l(e.data, (function(t){
          return r("SubtitlesItem", {
            key:t.id, attrs:{
              data:t, player:e.player, config:e.config
            }, on:{
              click:function(r){
      ...
      const V=(0, o.pM)({
        props:{
          ...
          isActive:m(e, {
            ...
            t.emit("click", e.data)
          }, keywords:(0, o.WQ)("keywords", (0, o.KR)("")), highlightKeyword:N.w
        })
      });
      const W=(0, v.A)(V, (function(){
      ...
      ], !1, null, "795f510e", null).exports, Y=(0, o.pM)({
        components:{
          TranscriptItem:W
        }, props:{
          data:{
      ...
      ], !1, null, "1f1e724f", null).exports, X=(0, o.pM)({
        components:{
          TranscriptParagraph:K
        }, props:{
          data:{
            type:Array, required:!0
          }, player:{
      ...
      const re=(0, o.pM)({
        components:{
          Subtitles:G, Transcript:Q, Generating:P.A
        }, props:{
          config:{
            type:Object, required:!0
          }, player:{
          ...
          var t=(0, o.KR)("subtitles"), r=(0, o.KR)([
          ]), i=(0, o.KR)(""), n=u.default.t("airOptimization.loading"), s=(0, o.KR)([
          ]), a=(0, o.WQ)("airGenStatus", {
            hasCaptions:!1, processing:{
              type:"", status:!1
            }
          }), l=(0, o.KR)("origin"), m=(0, o.WQ)("isInstructorView", !1), p=(0, o.EW)((()=>s.value.map((t=>({
            label:e.player.i18n.global.t("multiPlayer.playerPlugin.caption.lang.".concat(t)), value:t
          }))))), v=(0, o.EW)((()=>e.player.i18n.global.t("multiPlayer.playerPlugin.caption.lang.".concat(l.value)))), f=(0, o.KR)(!1), h=(0, o.KR)("");
          (0, o.Gt)("keywords", h);
          var b=0, g=(0, o.EW)((()=>{
            var t=[
            ], i=0, n=[
            ...
            return r.value.forEach((r=>{
              r.startMs-i>e.config.paragraphSplitInterval?(n.length>0&&t.push(n), n=[
                r
              ]):n.push(r), i=r.endMs
            ...
            b=setInterval(te(c().mark((function t(){
              var n, o;
              return c().wrap((function(t){
                for(;
                ;
                )switch(t.prev=t.next){
                  case 0:return t.next=2, A(e.config);
                  case 2:if("PROCESSING"===(n=t.sent).status){
                    t.next=13;
                    break
                  }
                  if(b&&clearInterval(b), b=0, "FINISHED"!==n.status){
                    t.next=13;
                    break
                  }
                  return a.hasCaptions=!0, t.next=10, C(e.config, 1, 1e5);
                  case 10:o=t.sent, r.value=o.items, e.player.updateCaptions(d(r.value));
                  case 13:i.value=n.status;
                  case 14:case"end":return t.stop()
                }
              }), t)
            }))), 3e3)
          }, w=function(){
            var t=te(c().mark((function t(){
              return c().wrap((function(t){
                for(;
                ;
                )switch(t.prev=t.next){
                  case 0:return t.next=2, x(e.config);
                  case 2:if(t.sent){
                    t.next=6;
                    break
                  }
                  return L.Message.error(u.default.t("air.generateFail")), t.abrupt("return");
                  case 6:i.value="PROCESSING", r.value=[
                  ], y();
          ...
          (), k=function(){
            var t=te(c().mark((function t(i){
              var n;
              return c().wrap((function(t){
                for(;
                ;
                )switch(t.prev=t.next){
                  case 0:return l.value=i, t.next=3, j(e.config, i);
                  case 3:n=t.sent, r.value=n.items, e.player.updateCaptions(d(r.value));
          ...
          (), S=document.documentElement.getAttribute("lang");
          return(0, o.sV)(te(c().mark((function t(){
            var n, o, u, l, d;
            return c().wrap((function(t){
              for(;
              ;
                ...
                case 0:return t.next=2, Promise.all([
                  C(e.config, 1, 1e5), E(e.config)
                ]);
                case 2:if(n=t.sent, o=Z(n, 2), u=o[
                  0
                ], l=o[
                  1
                ], r.value=u.items, s.value=[
                  "origin", ...l
                ], 0!==r.value.length){
                  t.next=15;
                  break
                }
                return t.next=11, A(e.config);
                case 11:(d=t.sent)&&(i.value=d.status, "PROCESSING"===d.status&&(a.processing.status=d.status, a.processing.type="caption", y())), t.next=16;
                break;
                case 15:a.hasCaptions=!0;
                case 16:case"end":return t.stop()
              }
            }), t)
          })))), {
            tab:t, tabs:_, captions:r, paragraphs:g, generate:w, progressStatus:i, generateText:n, deleteCaption:t=>{
              r.value=r.value.filter((e=>e.id!==t)), e.player.updateCaptions(d(r.value))
            }, updateCaption:t=>{
              var i=t.id, n=t.text, o=r.value.find((e=>e.id===i));
              o&&(o.text=n, e.player.updateCaptions(d(r.value)))
            }, isSearchBarOpened:f, keywords:h, closeSearchbar:()=>{
              f.value=!1, h.value=""
            }, supportedLanguages:p, changeLanguage:k, currentLang:l, currentLangText:v, downloadCaption:t=>{
              window.location.href="".concat(e.config.server, "/api/media-captions/template?lang=").concat(S, "&format=").concat(t)
            }, isInstructorView:m
          }
        }
      });
      const ie=(0, v.A)(re, (function(){
        var e=this, t=e.$createElement, r=e._self._c||t;
        return r("div", {
                    ...
                    key:"list", fn:function(){
                      return[
                        r("DropdownMenu", [
                                  ...
                                  return[
                                    r("DropdownMenu", {
                                      ...
                                      return r("DropdownItem", {
                                        key:t.value, class:{
                                          active:e.currentLang===t.value
                                        }, attrs:{
                                          value:t.value
                                        }, nativeOn:{
                                          click:function(r){
                                            return e.changeLanguage(t.value)
                                          }
                                        }
                                      }, [
                                        e._v("\n                    "+e._s(t.label)+"\n                  ")
                          ...
                          ], 1), e._v(" "), e.isInstructorView?r("DropdownItem", {
                            nativeOn:{
                              click:function(t){
                                return e.generate(t)
                              }
      ...
      ], !1, null, "29300c3a", null).exports, ne=(0, o.pM)({
        components:{
          Chapter:D, Caption:ie
        }, props:[
          "player", "isInstructorView", "seekable"
        ], setup(e){
          var t=(0, o.KR)(), r=(0, o.KR)(), i={
            hasCaptions:!1, processing:{
              type:"", status:!1
            }
          };
          (0, o.Gt)("airGenStatus", i), (0, o.Gt)("isInstructorView", e.isInstructorView), (0, o.Gt)("seekable", e.seekable);
          var n=(0, o.KR)("caption"), a=(0, o.KR)(""), c=(0, o.KR)();
          return(0, o.wB)((()=>e.player), (e=>{
            var n, o=(null===(n=e.props)||void 0===n?void 0:n.plugins)||[
            ];
            o.chapter&&(t.value=o.chapter), o.caption?(i.hasCaptions=!1, r.value=o.caption):i.hasCaptions=!0
          })), (0, o.sV)((()=>{
            var e=new s(c.value, {
              suppressScrollX:!0
            });
            c.value.addEventListener("ps-scroll-y", (()=>{
              var t=getComputedStyle(c.value).height;
              a.value=t, e.update()
            }))
          })), {
            chapterConfig:t, captionConfig:r, tab:n, eleRef:c, height:a
          }
        }
      });
      const oe=(0, v.A)(ne, (function(){
        var e=this, t=e.$createElement, r=e._self._c||t;
        return r("div", {
      ...
      ], !1, null, "792f7a0c", null).exports;
      i.default.use(n.A), i.default.customElement("online-video-fullscreen", oe)
    }, 80623:(e, t, r)=>{
        ...
        "$rootScope", "$scope", "$window", "rubricRepository", "activityRepository", "modelHelper", (e, t, r, s, a, f)=>{
          ...
          t.changeReviewRule=e=>{
            ...
            ?(g("review_by"), [
              ...
              "review_by_instructor"===e?(g("instructor"), t.homeworkDetails.instructor_score_percentage=null):"review_by_intraGroup"===e?(g("intra"), t.homeworkDetails.intra_group_score_percentage=null):("review_by_inter"===e?t.homeworkDetails.inter_score_percentage=null:t.homeworkDetails.inter_group_score_percentage=null, g("inter"), delete t.errors.pieces_cnt, delete t.errors.rubric_id)
            })(e))
          };
          var y=e=>e&&"differentiated"===e.teaching_mode;
          t.$on("openReallocatePopup", (()=>{
            t.ui.submit_by_group=t.activity.submit_by_group, t.ui.hasNoGroup=null, h=!1, b.bindActivityForEdit(t.activity), t.activity.submit_by_group?t.homeworkDetails=l(t.activity, t, e):t.homeworkDetails=u(t.activity, e), t.homeworkBasics=c(t.activity), y(t.course)&&(t.differentiatedData=_(t.activity), t.vueParam={
            ...
            t.vueParam&&(y(t.$parent.course)&&(t.vueParam.errors=t.errors), t.errors&&t.errors.multiple_choice&&(t.multipleChoiceTitleDuplicateError=Object.values(t.errors.multiple_choice).includes("exam paper title duplicate")))
          })), t.save=()=>{
            ...
            y(t.course)&&t.differentiatedData&&(e=i.merge({
      ...
      const S={
        namespaced:!0, state:_(), actions:w, getters:k, mutations:y
      }
    }, 86886:(e, t, r)=>{
      r.r(t), r.d(t, {
        chatbotShims:()=>s
      ...
      var v=r(218831).camelizeKeys, f=r(111172), h=r(966491), b=r(709272).TaskMap, g=r(552979).default, _=r(841885);
      e.exports=[
        "$scope", "$rootScope", "$http", "modelHelper", "toastr", "homeworkRepository", "filter", "submissionListUtils", "$location", "$timeout", "$filter", "$routeParams", "homeworkApi", "momentService", function(e, t, a, u, m, p, y, w, k, S, I, C, x, A){
          var T, R, E, j, P=null===(T=window.globalData)||void 0===T||null===(R=T.course)||void 0===R?void 0:R.orgId;
          e.loadComponents=()=>{
          ...
          var O=null, $=C.activityId;
          e.paperZip={
            status:"before"
          };
          var M=0;
          null!=e&&null!==(E=e.homework)&&void 0!==E&&null!==(j=E.data)&&void 0!==j&&j.homework_score_percentage&&(e.homework.data.homework_score_percentage.inter_score_percentage||e.homework.data.homework_score_percentage.inter_group_score_percentage||e.homework.data.homework_score_percentage.intra_group_score_percentage)?e.showInstructorScoreColumn=!0:e.showInstructorScoreColumn=!1, e.vueParam={
          ...
          e.changePage=function(t){
            return e.pagination.changePageAtFrontEnd(t, e.filteredSubmissions, D), Q()
          ...
          e.autoSave=function(t){
            ...
            e.isAutoSave=!0;
            var c=Array.from(N(t, o)), u=l(c, 3), d=u[
              0
            ], m=u[
              1
            ], p=u[
            ...
            return v.then((function(r){
              if(n.merge(t.submission, r.submission), p.final_score!==r.data.final_score){
                var i=q(statistics.enums.HomeworkAction.update_final_score);
                statistics.track(i)
              }
            ...
            :null, i=Array.from(H(t, r)), n=l(i, 2), o=n[
              0
            ], s=n[
              1
          ...
          e.recommendHomework=function(){
            ...
            if(e.everySelectedCanChangeToRedo()){
              ...
              e.eventType="redo", e.popupTitle=g.t("homeworkRedo.redo");
              var o=F(t), s=e.homework.submit_by_group?"homeworkRedo.confirmTipForGroup":"homeworkRedo.confirmTipForStudent";
              return e.popupMessage=g.t(s, [
                r
            ...
            if(e.hasSelected()){
              var t=n.filter(e.submissions, (e=>e.selected)), r=G(t);
          ...
          e.openHomeworkCheckPopup=()=>{
            var t=G(n.filter(e.submissions, (e=>e.selected)));
            i("#homework-check-popup").foundation("reveal", "open"), S((()=>{
              e.$emit("homeworkCheckInit", e.homework, t)
            }))
          };
          var z=()=>(i("#confirmation-popup").foundation("reveal", "close"), n.each(e.filteredSubmissions, (e=>delete e.selected))), G=t=>{
            ...
            var r;
            if(!(1===t&&M>0&&M+1e3>Math.floor(Date.now()))){
              ...
              return M=Math.floor(Date.now()), a.put("/api/course/activities/".concat(e.homework.id, "/submission/marked_submitted"), {
                submission_ids:u, student_or_group_ids:c, marked_submitted:t, submittedStatus:s
              }).success((function(r){
                z(), window.dispatchEvent(new CustomEvent("homework-marked-action-success", {
                  detail:e.eventType
                ...
                var o=0===t?statistics.enums.HomeworkAction.marked_unsubmitted:statistics.enums.HomeworkAction.marked_submitted, s=q(o);
            ...
            [
              "remind", ()=>{
                ...
                return a.put("/api/homework/".concat(e.homework.id, "/remind"), {
                  ...
                  var r=q(statistics.enums.HomeworkAction.remind);
                  return statistics.track(r), z(), window.dispatchEvent(new CustomEvent("homework-marked-action-success", {
                    detail:e.eventType
              ...
              "recommend", ()=>{
                ...
                return a.put("/api/submission/recommend", {
                  ...
                  var r=q(statistics.enums.HomeworkAction.recommend);
                  return statistics.track(r), z(), window.dispatchEvent(new CustomEvent("homework-marked-action-success", {
                    detail:e.eventType
              ...
              "redo", ()=>{
                var t=n.filter(e.filteredSubmissions, (e=>e.selected)), r={
                  submission_ids:n.map(t, (e=>e.submission.id)), student_or_group_ids:G(t), submittedStatus:n.map(t, (e=>e.submittedStatus))
                };
                return x.markHomeworkSubmissionToRedo(e.homework.id, r, (t=>{
                  ...
                  var r=statistics.enums.HomeworkAction.is_redo, i=q(r);
                  statistics.track(i), m.success(t.message), z()
                }), (e=>{
                  m.error(e.message)
                }))
              }
              ...
              "unrecommend", ()=>{
                ...
                e.cancelRecommendSubmission(t), z()
              }
            ]
          ]);
          e.confirm=()=>{
          ...
          e.makeUpHomework=function(){
            ...
            var e=q(statistics.enums.HomeworkAction.recommend);
            statistics.track(e), te()
          })), e.$on("resubmitHomeworkNotifySend", (()=>te())), e.$on("setSameScoreNotifySend", (()=>{
            var e=q(statistics.enums.HomeworkAction.set_same_score);
            statistics.track(e), te()
          ...
          var Y=function(){
            ...
            var t, r=n.filter(e.submissions, (function(t){
              return t.student?!!y.filterEnrollments(e, t.student)&&(e.homework.submissions.push(t), !0):y.filterEnrollments(e, t.group)
            }));
          ...
          }, e.search=()=>Y(), e.updateMarkStatus=function(t){
          ...
          var X=function(){
            ...
            return X(), i(".sync-scroll").scroll((e=>i(".sync-scroll").scrollLeft(i(e.target).scrollLeft()))), function(){
          ...
          var Z=()=>{
            ...
            p.loadSubmissionsForInstructor(e.homework, !0, !1).then((t=>{
              var r;
              e.submissions=t, null!==(r=window.featureToggles)&&void 0!==r&&r.homeworkDuplicateDetect&&e.allowHomeworkSetting&&Z(), e.submissions.forEach((function(t){
                var r, i, o, s=e.homework.submit_by_group?t.group:t.student;
                if(function(t, r){
                  if(t.submittedStatus="", K(r), 0!==r.redo_count&&t.submission.is_redo)return t.submittedStatus="redo";
              ...
              })), e.submissions=n.sortBy(e.submissions, "group_created_at").reverse(), e.submissions=n.sortBy(e.submissions, "group_name"), e.submissions=n.sortBy(e.submissions, "group_sort")):y.initDepartmentsInfoForEnrollments(e, n.map(e.submissions, (e=>e.student))), y.initOrgDepartments(e, P).then((()=>{
                e.vueParam.departments=n.cloneDeep(e.departments), e.vueParam.disabled=!1
              })), Y(), e.loaded=!0, e.ui.shouldReviewedByStudents=U(), e.hasNoStudents=e.homework.submit_by_group?!n.some(e.submissions, (e=>e.students.length>0)):0===e.submissions.length
            }))
          };
          ...
          var ee=function(){
            return a.get("/api/zip-status/homework-zip/".concat($, "?no-intercept=true"), {
            }).success((t=>{
              var r, i, n, o;
          ...
          e.$on("getPaperZip", (function(){
            O||(O=setInterval(ee, 5e3))
          }));
          var te=function(){
            e.homework.submit_by_group?(e.isGroupHomework=!0, e.homework.inter_score_map&&e.homework.inter_score_map.id&&(e.showReviewStatus=!0), e.homework.intra_score_map&&e.homework.intra_score_map.id&&(e.showIntraReviewStatus=!0)):e.showReviewStatus=e.homework.is_review_homework, J(), ee().then((()=>{
              "processing"===e.paperZip.status&&(O=setInterval(ee, 5e3))
            }))
          };
          e.submissionHasClosed=w.submissionHasClosed(e.homework);
          var re=t.$on("refreshHomeworkScoreFromHomeworkMark", (()=>{
            te()
          }));
          return e.$on("$destroy", (()=>{
            re(), O&&(clearInterval(O), O=null)
          })), te()
        }
      ]
    }, 111490:(e, t, r)=>{
      ...
      e.exports=[
        "$rootScope", "$scope", "rubricRepository", "Rubric", "modelHelper", "homeworkApi", "homeworkRepository", "$routeParams", "GroupInterScoreHelper", "$http", "activityApi", "$location", "toastr", function(e, t, r, u, d, p, g, _, y, w, k, S, I){
          ...
          var x=()=>{
            g.loadSubmissionForStudent(t.homework).then((function(e){
              ...
              })), r=t.homework.submission_list, (o=null===(i=t.homework.submission)||void 0===i?void 0:i.id)&&g.loadDuplicateRateWithSubmissionId(o).then((e=>{
          ...
          t.viewSubmissionForStudent=function(){
            ...
            var i=function(i){
              return i!==e&&a.copy(i, e), t.currentItem.submission=A(i), t.isInstructorView||T(e.inter_scores), t.currentItem.submission.slide_references&&(t.slides=n.map(t.currentItem.submission.slide_references, "slide")), t.currentItem.student=i.created_by, t.currentItem.group=i.group, t.currentItem.isRecommendSubmission=r, i.created_at!==e.created_at&&(e.created_at=i.created_at), s("#show-score").foundation("reveal", "open"), !0
            ...
            i&&(t.currentItem.submission=A(i), t.isInstructorView||i.inter_scores&&T(i.inter_scores), t.currentItem.submission.slide_references&&(t.slides=n.map(t.currentItem.submission.slide_references, "slide")), t.currentItem.student=i.created_by, t.currentItem.group=i.group)
          ...
          var T=e=>{
            t.homework.submit_by_group&&(t.interScoreHelper=new y(e))
          };
          ...
          var R=e=>e&&e.submission_correct&&e.submission_correct.instructor_score;
          t.hasInstructorScore=function(e){
            var t=R(e);
            return!isNaN(t)&&null!==t&&""!==t
          }, t.getInstructorScore=function(e, r){
            return t.hasInstructorScore(e)?parseFloat(R(e)):r
          };
      ...
      e.exports={
        course:{
        }, courseId:null, roomisHost:"", orgCode:"", orgId:null, orgSettings:{
        }, lrpVideoHost:"", screenShot:!1, userId:null, allStudents:[
        ], presentStudents:[
        ], selectableStudents:[
        ], allGroupSets:[
        ], selectedGroupSet:{
        ...
        ], connected:!0, launcher:{
        }, modal:null, tool:null, deliveryOrg:null, featureToggles:{
        }, globalCanvas:{
        }, loading:!1, showBlackBoard:!0, existedRollcall:null, danmuConfig:{
        }
      }
    }, 189456:(e, t, r)=>{
      ...
      r.d(t, {
        Bk:()=>n, JA:()=>u, Mv:()=>v, P0:()=>b, Tf:()=>h, Tw:()=>m, _O:()=>f
      });
      r(335231), r(658379);
      var i, n, o=r(738645), s=r(152229), a=(i=function(e, t){
        ...
        function e(){
          this.name="", this.id="", this.key="", this.content="", this.length=0, this.meta={
            type:"", source:[
            ], time:""
          }
        }
        return c([
          ...
          (0, o.v)()
        ], e.prototype, "key", void 0), c([
          (0, o.v)()
        ], e.prototype, "content", void 0), c([
          (0, o.v)()
        ], e.prototype, "length", void 0), e
      }
      (), l=function(e, t){
        return e.indexA[
          0
        ...
        return e.prototype.intersectWith=function(e){
          return l(t=this, r=e)||l(r, t);
          var t, r
        }, e
      }
      (), m=function(e){
        function t(t){
          ...
          return r.id=0, r.keyB="", r.docB=new u, r.indexA=t, r
        }
        return a(t, e), t
      }
      (d), p=function(e){
        ...
        return a(t, e), t.prototype.add=function(e){
          this.indexA=[
            Math.min(this.indexA[
              0
            ], e.indexA[
              0
            ]), Math.max(this.indexA[
              1
            ], e.indexA[
              1
            ])
      ...
      (d), v=function(){
        ...
        return e.prototype.add=function(e){
          var t;
          return(t=this.items).push.apply(t, e), this
        }, e.prototype.doGroup=function(){
          var e=this;
          ...
          t++){
            ...
            if(r.intersectWith(e))return void r.add(e)
          }
          this.groups.push(p.from(e))
        }, e
      }
      (), f=function(){
        function e(){
          this.name="", this.key="", this.source=""
        }
        return c([
          (0, o.v)()
        ], e.prototype, "name", void 0), c([
          ...
          (0, o.v)()
        ], e.prototype, "source", void 0), e
      }
      (), h=function(){
        function e(){
          this.activityId=0, this.id=0, this.uploads=[
          ]
        }
        return c([
          (0, o.v)({
        ...
        ], e.prototype, "uploads", void 0), e
      }
      ();
      !function(e){
        e.CurrentHomework="current_homework", e.DuplicateLib="duplicate_lib", e.HistoryCourse="history_course"
      }
      (n||(n={
      }));
      var b=function(){
        ...
        return c([
          (0, o.v)()
        ], e.prototype, "status", void 0), c([
          (0, o.v)({
            name:"download_url"
          })
        ], e.prototype, "downloadUrl", void 0), e
      }
      ()
    }, 269237:e=>{
      e.exports=[
      ...
      r.r(t), r.d(t, {
        addUploadsToLib:()=>d, deleteUploadsInLib:()=>m, getDoc:()=>f, getGroupSubmission:()=>g, getLastDuplicateDetectTask:()=>v, getReportDownloadInfo:()=>_, getResult:()=>h, getStudentSubmission:()=>b, getUploadsInLib:()=>p
      });
      r(540590), r(418665), r(269193), r(14602);
      var i=r(272505), n=r.n(i), o=r(920453), s=r(218831), a=r(112060), c=r(257432), u=function(e, t, r, i){
        return new(r||(r=Promise))((function(n, o){
          function s(e){
            try{
              c(i.next(e))
        ...
        return n().post("/api/course/".concat(e, "/homework/duplicate-lib"), {
          upload_ids:t
        })
      }, m=function(e, t){
        return n().delete("/api/course/".concat(e, "/homework/duplicate-lib"), {
          params:{
            upload_ids:t.join(",")
          }
        })
      }, p=function(e, t, r, i){
        return void 0===t&&(t=1), void 0===r&&(r=10), void 0===i&&(i={
        }), u(void 0, void 0, void 0, (function(){
          var c, u, d;
          return l(this, (function(l){
            switch(l.label){
              case 0:return c=(0, s.decamelizeKeys)({
                page:t, pageSize:r, conditions:JSON.stringify((0, s.decamelizeKeys)(i))
              }), [
                4, n().get("/api/course/".concat(e, "/homework/duplicate-lib"), {
                  params:c
                })
              ];
              case 1:return u=l.sent(), d=(0, o.plainToClass)(a._O, u.data.uploads, {
        ...
        return u(void 0, void 0, void 0, (function(){
          ...
          return l(this, (function(i){
            switch(i.label){
              case 0:return r=void 0===t?{
              }
              :{
                status:t
              }, [
                4, n().get("/api/homework/".concat(e, "/duplicate-detect/task"), {
                  params:r
                })
              ];
              case 1:return[
        ...
        return u(void 0, void 0, void 0, (function(){
          return l(this, (function(t){
            switch(t.label){
              case 0:return[
                4, n().get("/api/duplicate-detect/file/".concat(e, "/raw"))
              ];
              case 1:return[
                2, t.sent().data
              ]
        ...
        return u(void 0, void 0, void 0, (function(){
          return l(this, (function(r){
            switch(r.label){
              case 0:return[
                4, n().get("/api/homework/".concat(e, "/duplicate-detect-result/file/").concat(t))
              ];
              case 1:return[
                2, r.sent().data
              ]
        ...
        return u(void 0, void 0, void 0, (function(){
          ...
          return l(this, (function(i){
            switch(i.label){
              ...
              case 1:return r=i.sent(), [
                2, (0, o.plainToClass)(c.Tf, r.data, {
                  excludeExtraneousValues:!0
                })
              ]
            }
        ...
        return void 0===r&&(r="cnki"), u(void 0, void 0, void 0, (function(){
          var i, a;
          return l(this, (function(u){
            switch(u.label){
              case 0:return i=(0, s.decamelizeKeys)({
                reportType:e, detectKey:t, provider:r
              }), [
                4, n().post("/api/duplicate-detect/report/download", i)
              ];
              case 1:return a=u.sent(), [
                2, (0, o.plainToClass)(c.P0, a.data, {
                  excludeExtraneousValues:!0
                })
              ]
            }
        ...
        "$rootScope", "$scope", "$routeParams", "$http", "toastr", "ExamHelper", "ExamSubject", "classroomRepository", "$q", function(e, t, r, c, u, m, p, v){
          ...
          var f=d(t), h=function(){
            t.classroomId&&v.getClassroomExamSubmissions(t.classroomId, t.submissionId).then((function(e){
              ...
              return m.updateSubjectsDetailData(t.subjects, r, i, o, s), g(), _()
            }))
          }, b=function(){
          ...
          return t.autoSaveScore=function(e, r){
            return function(){
              ...
              &&arguments[
                ...
                if(o.score=r.submission_score, o.marked=r.marked, i.waitingForScore=!1, y(o.id), h(), S(t.classroomId, t.currentExaminee.id, "personal"), t.$emit("saveScoreSuccess"), e)return e()
              }, a=()=>({
      ...
      r(207452);
      var l=r(791936), d=r(441179), m=r(966491), p=r(571478), v=r(901499), f=r(731904)._, h=r(181769), b=h.canEditActivity, g=h.hasEditPermissionForBlueprint, _=r(951708), y=_.getActivityAiQuizzes, w=_.getSelfSubmissions, k=_.getAirActivityEnableMap, S={
      ...
      e.exports=[
        "$rootScope", "$scope", "$routeParams", "$sce", "$location", "activityRepository", "modelHelper", "statHelper", "faceCheckHelper", "Course", "$q", "$http", "$timeout", "$window", "activityApi", "toastr", "publishHelper", function(e, t, r, a, c, h, _, S, I, x, A, T, R, E, j, P, O){
          var $, M, D=p(t);
          D.show();
          var L=i("#courseId").val();
          t.rubricScoreData=[
          ], t.ui={
            showFullScreenLink:!0
          };
          var U=_.addLearningActivityRead, N=_.isActivityRead, H=k();
          ...
          var B=t.isInSyllabusPage?"syllabus":"detail";
          window.sessionStorage.setItem("activityReferrer", B), t.completedInfo={
            ...
            return _.editActivity(e, t, t.course, i, n, R, r)
          }, t.openReallocatePopup=e=>{
            t.editActivity(e), t.$broadcast("openReallocatePopup")
          }, t.editClassroom=r=>_.editActivity(e, t, t.course, r.module_id, r.syllabus_id, R, r), t.$on("activityLoaded", ((e, t)=>G(t)));
          var F=function(e){
            if(t.uploads=[
            ...
            var r=u(o.mark((function r(i){
              ...
              return o.wrap((function(r){
                ...
                ;
                  ...
                  case 0:if(t.aiQuizCount=0, j){
                    r.next=3;
                    break
                  }
                  return r.abrupt("return");
                  case 3:return t.loadingAiQuizzes=!0, r.next=6, y(i.id);
                  ...
                  case 20:t.loadingAiQuizzes=!1, F(i), t.$apply();
            ...
            var r=u(o.mark((function r(n, s){
              ...
              return o.wrap((function(r){
                ...
                ;
                  ...
                  return r.abrupt("return");
                  case 3:return r.next=5, z(t.activity);
          ...
          var G=function(e){
            ...
            (e), t.activity=t.currentActivity=e, F(e), t.activity_id=e.id, t.pageContent=m.replaceActivityTypeKey(e.type), "online_video"===e.type&&!t.isInstructorView&&"none"!==e.completion_criterion_key&&e.uploads&&e.uploads.length>0&&"audio"!==e.uploads[
              0
            ].type&&"link"!==e.uploads[
              0
          ...
          }, W=()=>f.map(t.course.modules, (function(e){
            return f.map(e.activities, (e=>V(e))), f.map(e.syllabuses, (e=>f.map(e.activities, (e=>V(e)))))
          })), Y=function(e){
            var r, i={
            ...
            if(K(t.activity, e)){
              var r=function(e){
                if(t.activity){
                  N(t.activitiesRead, t.activity)||U(t.activitiesRead, t.activity.id);
          ...
          t.logJoinActivityRead=function(){
            ...
            var i=h.loadActivity(r), n=h.initActivitiesReadForUser(L);
            return A.all([
              i, n
            ]).then((function(){
              ...
              if(D.hide(), a)return null!==(i=window.featureToggles)&&void 0!==i&&i.lazyLoadCourseSection||(G(a), te(t.activity), Y(r), t.activitiesRead=c, W(), X(), "scorm"===t.activity.type&&t.activity.uploads[
                0
              ]
          ...
          }, Q), t.logVideoPlayed=function(e, r, i){
            var n=!(arguments.length>3&&void 0!==arguments[
              3
            ])||arguments[
              3
            ];
            return E.st&&!E.st.accessible?P.warning(t.offlineWarning):h.logActivityRead(e, {
              start:r, end:i
            }, Q, (function(){
            }), n)
          ...
          var Z=function(e, t){
            var r=f.find(((e, t)=>{
              ...
              return"exam"===r?i="/course/".concat(L, "/exam"):"syllabus"===r&&(i="/course/".concat(L, "/content")), [
                {
                  activityTypes:[
                    "forum"
                  ], defaultBackUrl:"/course/".concat(L, "/").concat(e)
                }, {
                  activityTypes:[
                    "classroom", "feedback", "danmu"
                  ], defaultBackUrl:"/course/".concat(L, "/classroom")
                }, {
                  activityTypes:[
                    "web_link", "material", "online_video", "slide", "page", "interaction", "scorm", "lesson"
                  ], defaultBackUrl:"/course/".concat(L, "/courseware")
                }, {
                  activityTypes:[
                    "exam"
                  ], defaultBackUrl:i||"/course/".concat(L, "/exam"), extraConditions:[
                    {
                  ...
                  ], defaultBackUrl:"/course/".concat(L, "/content")
                }, {
                  activityTypes:[
                    "homework"
                  ], defaultBackUrl:"/course/".concat(L, "/homework"), extraConditions:[
                    {
            ...
            if("lesson"===e)return"/course/".concat(L, "/lesson");
          ...
          t.goBack=function(){
            var r=null;
            r=t.currentActivity&&"SHTVU"!==t.deliveryOrg?Z(t.currentActivity.type, t.currentActivity.id):"/course/".concat(L, "/content");
            ...
            if(t.activity&&"online_video"!==t.activity.type&&(n=de(t.activity, "exit", (function(){
              return r?E.location.href=r:E.history.back(), i?i():void 0
            }))), !n)return r?E.location.href=r:E.history.back(), i?i():void 0
            ...
            t.activity&&"online_video"!==t.activity.type&&(r=de(t.activity, "exit", (function(){
              E.location.href="/course/".concat(e, "/content")
            }))), r||(E.location.href="/course/".concat(e, "/content"))
          };
          var J=()=>{
          ...
          t.isSyllabusLocked=e=>e.activities.length>0&&f.every(e.activities, (e=>e.is_locked||t.activityHasNotFinishedPrerequisite(e))), t.changeActivity=function(e){
            var r, n;
            if(!O.canViewActivityPermission(t.isInstructorView||(null===(r=window.globalData)||void 0===r||null===(n=r.courseRoles)||void 0===n?void 0:n.includes("student_assistant")), e)&&!O.allowViewUnpublishedActivityDetail(e))return i("#access-forbidden-popup").foundation("reveal", "open"), void(t.__accessForbidden=e);
            var o=!1;
            "online_video"!==e.type?de(e, "enter", void 0):t.activity&&"online_video"!==t.activity.type&&(o=de(t.activity, "exit", (function(){
              E.location.href="/course/".concat(L, "/learning-activity/full-screen#/").concat(e.id)
            }))), o||re(e)
          };
          var re=r=>{
          ...
          t.downloadBlob=function(e, t){
            ...
            :"download";
            t.deleted||ne(e, t, r)
          }, t.canShowOperations=e=>b(e), t.canEditActivitySelf=e=>g(e), t.downloadWeDrive=e=>{
            "WEDRIVE"===e.source&&T.get("/api/wedrive/file/".concat(e.fileid), {
          ...
          e.$on("$refreshPrerequisitesStatus", (function(e){
            ...
            var e=t.activity_id;
            return j.createLiveRecordAsrTask(e, (function(e){
            ...
            return j.getLiveRecordCaptions(t.activity_id, (function(e){
              var r=[
              ];
          ...
          var ae=function(){
            return j.getLiveRecordAsrTaskStatus(t.activity_id, (function(e){
              ...
              return clearInterval(t.intervalLiveRecordAnalyzedStatus), P.warning(e.message)
            }))
          };
          ...
          var ce=function(e){
            ...
            new d(navigator.userAgent).mobile()&&(E.location.href=(e=>{
              var r=e.type;
              switch(r){
                case"online_video":return"/course/".concat(L, "/online-video/").concat(e.id, "/info");
                case"exam":return t.isInstructorView?"/course/".concat(L, "/").concat(r, "/").concat(e.id, "/submissions"):"/course/".concat(L, "/").concat(r, "/").concat(e.id, "/info");
                case"homework":return t.isInstructorView?"/course/".concat(L, "/").concat(r, "/").concat(e.id, "/submission"):"/course/".concat(L, "/").concat(r, "/").concat(e.id);
                case"chinamcloud_live":return"/course/".concat(L, "/live/").concat(e.id, "/info?courseLiveId=").concat(e.id, ",type=ExtensionLive,source=ChinamcloudLive");
                case"feedback":return"/course/".concat(L, "/feedback-activity/").concat(e.id);
                case"forum":return"/course/".concat(L, "/forum/topic-categories");
                case"web_link":return"/course/".concat(L, "/web-link/").concat(e.id, "/info");
                case"tencent_meeting":return"/course/".concat(L, "/tencentMeeting/").concat(e.id, "/info");
                case"virtual_classroom":return"/course/".concat(L, "/virtual-classroom/").concat(e.id, "/info");
                case"interaction":return"/course/".concat(L, "/interactive-material/").concat(e.id, "/info");
                case"classroom":return"/course/".concat(L, "/quiz/").concat(e.id, "/info");
                default:return"/course/".concat(L, "/").concat(r, "/").concat(e.id, "/info")
              }
            })(e))
          }, le=function(){
            ...
            var e=u(o.mark((function e(r){
              ...
              return o.wrap((function(e){
                ...
                ;
                  ...
                  case 4:return t._course&&t._course.loadingModule(r, !0), e.next=7, h.getActivitiesByModuleIds(L, i, (o=void 0, o=[
            ...
            var e=u(o.mark((function e(r, i){
              ...
              return o.wrap((function(e){
                ...
                ;
                  ...
                  case 7:l=e.sent, G(n), te(t.activity), Y(t.activity.id), t.activitiesRead=s, W(), X(), t.uploadsStatus=m.setUploadsFeature(t.uploads), ce(l||[
                  ]), t.$apply();
          ...
          ();
          null!==(M=window.featureToggles)&&void 0!==M&&M.lazyLoadCourseSection?fe():function(){
            D.show();
            var e=h.initCourseAndModules();
            L=i("#courseId").val();
            var n=[
              e, h.initActivities(L), h.initExamsForActivityListOnlyRequest(L), h.initClassroomsForActivityListOnlyRequest(L)
            ];
            t.enableLiveStreaming?n.push(h.initLiveRecordsForActivityListOnlyRequest(L)):n.push(Promise.resolve([
            ])), t.allowInteractionInActivity?n.push(h.initInClassInteractionsForActivityList(L)):n.push(Promise.resolve([
            ])), t.allowRollcallView?n.push(h.initRollCallsForActivityList(L)):n.push(Promise.resolve([
              ...
              var d=r.activityId||t.onlineVideoId, p=r.examId, v=r.classroomId, b=r.questionnaireId, g=r.liveRecordId, _=r.rollcallId, y=r.classModeInteractionId, w=r.danmuActivityId;
              if(t.activity_id=t.activity_id||p||v||b||d||g||y||_||w, "SHTVU"===t.deliveryOrg&&h.initCourseTimeTable(t.course.id).then((function(e){
                ...
                if(W(), p?I=f.find(o, {
                  ...
                  id:parseInt(g)
                })).task&&"processing"===I.task.task_status&&(t.progress=0, t.processTime=0, t.intervalLiveRecordAnalyzedStatus=setInterval(ae, 2e3)):y?I=f.find(u, {
                  id:parseInt(y)
                }):_?I=f.find(l, {
                  id:parseInt(_)
                }):w&&(I=f.find(u, {
                  id:parseInt(w)
                })), O.canViewActivityPermission(t.isInstructorView||(null===(k=window.globalData)||void 0===k||null===(S=k.courseRoles)||void 0===S?void 0:S.includes("student_assistant")), I)||O.allowViewUnpublishedActivityDetail(I)||(window.location.href="/errors/no_permission"), !t.isInSyllabusPage&&!t.isCourseInCheckpointMode&&!t.onlineVideoFullScreen)return;
