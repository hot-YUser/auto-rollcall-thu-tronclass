(self.webpackChunklms=self.webpackChunklms||[
  ...
  [
    ...
    31571:(e, t, s)=>{
      var a=s(302543);
      e.exports={
        getContents:e=>e?(contents=a.map(e.alternates, "content"), a.isEmpty(contents)?e.content:[
          e.content
      ...
      s(207452);
      var l=s(793110).default, d=s(181769), m=d.canEditActivity, p=d.hasEditPermissionForBlueprint, b=s(966491), f=s(181769).scoreRules, j=s(5782).default, v=s(790679).A;
      e.exports=[
        "$scope", "$rootScope", "$window", "$location", "$routeParams", "$timeout", "modelHelper", "$http", "toastr", "ExamHelper", "examRepository", "activityRepository", "$filter", "$compile", "publishHelper", "fileSelectModel", function(e, t, u, d, S, _, x, y, h, g, M, w, E, I, C, P){
          Promise.all([
            s.e(28492), s.e(3564), s.e(821), s.e(64288)
            ...
            Promise.all([
              s.e(74722), s.e(15471), s.e(10035), s.e(26541)
          ...
          if(e.openBatchOperation=()=>{
            ...
            var $=localStorage.getItem("otherDevicesAnsweringTime");
            t.otherDevicesAnsweringTime=b.formatDatetime($), a("#active-on-other-devices-popup").foundation("reveal", "open"), localStorage.removeItem("otherDevicesAnsweringTime")
          }
      ...
      e.exports=[
        "$rootScope", "$scope", "$http", "$routeParams", "ExamHelper", "$filter", "toastr", "examRepository", "ExamSubject", "modelHelper", "$timeout", "statRepository", "filter", function(e, t, s, l, d, f, j, v, S, _, x, y, h){
          ...
          t.save=function(t){
            return e.currentGroup?V(t):R(t)
          };
          var L=(e, t, s)=>statistics.track({
            ...
            :void 0, o=O(e), i=function(e){
              if(P.hide(), e.message&&j.warning(e.message), n&&n(), e.errors)return $(e.errors.graded_subjects, o)
            }, u=function(e){
              P.hide(), j.success();
              ...
              if(n.score=e.submission_score, s.waitingForScore=!1, T(n.id), D(), t.refreshSubmissionCount(), L(t.examId, t.currentExaminee.id, "personal"), a)return a()
            }, c=()=>({
            ...
            :void 0, i=O(a), u=function(e){
              if(P.hide(), e.message&&j.error(e.message), o&&o(), e.errors)return $(e.errors.graded_subjects, i)
            }, l=function(s){
              P.hide(), j.success();
              ...
              if(t.submissionData.score=a.score, e.submissionData=t.submissionData, F(), t.refreshSubmissionCount(), L(t.examId, e.currentGroup.id, "group"), n)return n()
            }, d=()=>({
          ...
          t.search=function(){
            ...
            return e.currentGroup?V(t, s):R(t, s)
          ...
          t.$on("afterSaveMakeUpExam", (function(){
            ...
            return t.previewScore=!t.previewScore, t.calculateScore(), q()
          ...
          var W=function(){
            ...
            return W(), a(".sync-scroll").scroll((()=>x((function(){
      ...
      e.exports=[
        "$rootScope", "$scope", "$routeParams", "$http", "ExamHelper", "toastr", "statHelper", "$q", "$window", "$interval", "examRepository", "ExamSubject", "$filter", "$timeout", "fileSelectModel", "$location", "socket", "storageUploader", "$sce", function(){
          var e=p(o.mark((function e(t, i, c, d, m, f, y, h, g, M, w, E, I, C, P, k, T, D, F){
            var N, A, O, $, U, L, R, V, B, G, W, q, H, z, Q, J, Z, Y, K, X, ee, te, se, ae, re, ne, oe, ie, ue, ce, le, de, me, pe, be, fe, je, ve, Se, _e, xe, ye, he, ge, Me, we, Ee, Ie, Ce, Pe, ke, Te, De, Fe, Ne, Ae, Oe, $e, Ue, Le, Re, Ve, Be, Ge, We, qe, He, ze, Qe, Je, Ze, Ye, Ke, Xe, et, tt, st, at, rt, nt, ot, it, ut, ct, lt;
            return o.wrap((function(e){
              ...
              ;
                ...
                case 5:O=e.sent, $=O.buildSubjectGroup, U=O.getSubjectIndexInGroup, L=O.subjectGroupState, R=O.flatGroupSubjects, V="/preview"===k.path(), t.progressUi||(t.progressUi={
                  ...
                  if(z){
                    ...
                    })), z.attachments=s, qe(z), i.calProgress(), _e(), G=null, z=null
                  }
                  ...
                  })), t.attachments=s, qe(t), i.calProgress(), _e(), G=null
                ...
                (), be=function(){
                  ...
                  var r=!(arguments.length>2&&void 0!==arguments[
                    ...
                    t.ipErrorMessage=e.message, t.clearCkeckStatus(), t.ipCkeckStatus.inTest=!0, r&&!a("#invalid-ip-confirmation-popup").hasClass("open")&&a("#invalid-ip-confirmation-popup").foundation("reveal", "open")
                  };
                  ...
                  return w.checkExamQualification(i.examId, "submit", (()=>ge()), (function(e){
                    t.ipErrorMessage=e.message, t.clearCkeckStatus(), t.ipCkeckStatus.submit=!0, a("#invalid-ip-confirmation-popup").foundation("reveal", "open")
                  }))
                }, ge=function(){
                  ...
                  i.ui.examSubmitted||Y.foundation("reveal", "open")
                })), Me.on("terminated", (()=>{
                ...
                (), i.submitAnswer=function(e, s, a, r, n){
                  ...
                  :0;
                  Z.stopTrackingFocusEventWithReason(n), i.enableInvigilation&&Me.emit("leave_exam", {
                    examId:i.examId
                ...
                (), Te=(e, t)=>{
                  ...
                  if(null!==H.left_time){
                    if(H.left_time<=0)return M.cancel(W), W=null, i.hideCancel=!0, void i.submitAnswer(B, i.exam.id, "course", !0, "time is up");
                    t.progressUi.leftTimeSeconds=H.left_time, t.progressUi.leftTime=$e(H.left_time), H.left_time-=1
                  }
                }, Le=e=>b.compressToUTF16(e), Re=e=>b.decompressFromUTF16(e), Ve=()=>{
                  var e=JSON.stringify(i.examSubjects);
                  return localStorage.setItem("exam_subjects_".concat(i.examPaperInstanceId), Le(e))
                }, Be=()=>{
                  var e="exam_subjects_".concat(i.examPaperInstanceId), t=localStorage.getItem(e);
                  if(!t)return null;
                  var s=JSON.parse(Re(t));
                  return j.map(s, (e=>e.subject=E.createSubjectBySavedSubject(e.subject, !1))), s
                }, Ge=()=>localStorage.removeItem("exam_subjects_".concat(i.examPaperInstanceId)), J.push(Ge), We=e=>{
                  ...
                  t&&t.subject&&(t.synced=!1, t.subject&&e.answeredOption&&(t.subject.answeredOption=e.answeredOption), t.subject.parent_id&&We(t.subject), Ve())
                }, He=()=>{
                  q&&(window.clearInterval(q), q=null), q=window.setInterval(Oe, 1e4), J.push((()=>{
                    window.clearInterval(q), q=null
                  }))
                }, ze=()=>{
                  W&&(M.cancel(W), W=null), void 0!==H.left_time&&(Ue(), W=M(Ue, 1e3)), J.push((()=>{
                    M.cancel(W), W=null
                  }))
                }, Qe=e=>{
                ...
                (), Ke=function(){
                  var e=function(e){
                    ...
                    t.progressUi.subjects=s, i.subjects=s, i.examPaperInstanceId=e.exam_paper_instance_id, i.groupedSubjects=m.groupSubjects(i.subjects), t.progressUi.subjectsNum=m.getSubjectsNum(i.subjects), i.ui.pending=!1, i.ui.loadFinished=!0, ct(), $(i.subjects);
                    var a=R();
                    L.useGroup&&(i.subjects=a.map((e=>E.createSubjectBySavedSubject(e, !1)))), ct()
                  };
                  ...
                  if(i.enableAntiCheat){
                    ...
                    e.is_leaving_window_timeout&&Ne(e.leaving_window_timeout), e.is_leaving_window_constrained&&e.is_leaving_window_timeout&&Ae(e.leaving_window_limit, e.leaving_window_timeout), e.disable_right_click&&Qe("contextmenu"), e.disable_copy_paste&&(Qe("copy paste"), a("body").addClass("no-select")), e.is_fullscreen_mode&&Ye(e)
                  }
                }, tt=()=>{
                  Z.startTrackingAllEvents(), J.push(Z.stopTrackingAllEvents)
                  ...
                  if(i.exam.is_fullscreen_mode&&Ze(), i.exam.is_leaving_window_constrained&&Pe(i.exam.leaving_window_limit, s), i.exam.is_leaving_window_timeout)if(a&&n.utc(a).add(i.exam.leaving_window_timeout, "seconds")<n.utc())i.autoClosePopup=!0, Fe();
                  else{
                  ...
                  (Me=T.getExamSocket(i.examId)).on("update_left_time", (e=>{
                    ...
                    return s.showUpdateLeftTimeWarning=!0, H.left_time=e.submission_left_time[
                      H.id
                    ], Ue(), C((()=>s.showUpdateLeftTimeWarning=!1), 5e3)
                  }))
                }, it=()=>{
                  d.get("/api/exams/".concat(i.examId, "/distribute")).success((function(e){
                    ...
                    }))&&!window.localStorage.getItem("e_s_d_c_".concat(i.examId, "_").concat(i.examPaperInstanceId))&&a("#exam-redistribute-popup").foundation("reveal", "open"), $(i.subjects);
                    var r=R();
                    L.useGroup&&(i.subjects=r.map((e=>E.createSubjectBySavedSubject(e, !1)))), ct()
                  })).error((function(e){
                    i.ui.examSubmitted=!0, f.warning(e.message), g.location.href="/course/".concat(B, "/learning-activity#/exam/").concat(i.examId)
                  }))
                  ...
                  window.localStorage.setItem("e_s_d_c_".concat(i.examId, "_").concat(i.examPaperInstanceId), Le("disabled"))
                }, ut=function(){
                  ...
                  e&&(m.parseAnswerWithElement(e), V||qe(e), _e(), i.$apply())
                }, ct=()=>{
                  var e=0, t=[
                  ];
                  !function s(a){
                    ...
                    a.forEach(((a, u)=>{
                      ...
                      L.useGroup&&"subject"!==(null===(c=i.exam.data)||void 0===c?void 0:c.subject_index_type)&&((null===(l=a.group)||void 0===l?void 0:l.id)!==(null===(d=r)||void 0===d?void 0:d.id)?(r=a.group, o=1):o++, m=n?"".concat(n, ".").concat(u+1):o.toString());
                      if([
                        "analysis", "media"
                      ].includes(a.type)){
                        ...
                        if(null!=p&&p.length){
                          var b, f=n||u+1;
                          L.useGroup&&"subject"!==(null===(b=i.exam.data)||void 0===b?void 0:b.subject_index_type)&&(f=n||o), s(p, f)
                        }
                      }
                ...
                case 141:case"end":return e.stop()
              }
            }), e)
          })));
      ...
      e.exports=[
        "$rootScope", "$scope", "$http", "$routeParams", "ExamHelper", "$filter", "EnrollmentFilter", "toastr", "examRepository", "classroomRepository", "$q", "ExamSubject", "modelHelper", "$location", "$timeout", "commonApi", "treeViewSearch", "statHelper", function(e, t, c, l, b, f, j, v, S, _, x, y, h, g, M, w, E, I){
          var C, P, k, T, D, F, N=f("orderBy"), A=null===(C=window.globalData)||void 0===C||null===(P=C.course)||void 0===P?void 0:P.orgId, O=a("#courseId").val();
          null===(k=window.globalData)||void 0===k||k.courseRoles.includes("assistant_instructor"), null===(T=window.globalData)||void 0===T||T.courseRoles.includes("student_manager"), null===(D=window.globalData)||void 0===D||null===(F=D.course)||void 0===F||F.isSimulatingInstructor;
          if(t.changeSort=function(e){
            return e!==t.predicate?(t.predicate=e, t.reverse=!1):t.reverse=!t.reverse, K()
          }, t.condition={
            department_ids:[
            ], grade_ids:[
            ], class_ids:[
            ...
            course_id:O, activity_id:t.examId
          }), t.switchMarkTabView=e=>{
            t.markTabView!==e&&(t.markTabView=e, "student"===e&&(t.reloadExam=!0, oe()), t.recordBehavior("".concat(e, "_marking_view")))
          }, t.loadComponents=()=>{
            Promise.resolve().then(s.bind(s, 678264))
          }, ![
            ...
            t.changePage=function(e){
              if(t.pagination.changePageAtFrontEnd(e, t.filteredExaminees, $), t.examId)return ne()
            ...
            t.$watch("submissionData.id", (function(e, t){
              ...
              if(a&&(t.originalExaminees=n.copy(t.examinees)), e.currentExaminee=t.currentExaminee=r.find(t.examinees, s), t.currentExaminee.submitted)return L(t.currentExaminee), R(t.currentExaminee.submissions[
                0
              ].id, !0), V()
            };
            var R=function(s){
            ...
            var V=function(){
              var e=function(e){
                ...
                var s=e.submission_data.subjects, a=e.correct_answers_data.correct_answers, n=e.submission_score_data, o=e.submission_comment_data;
                return b.updateSubjectsDetailData(t.subjects, s, a, n, o), G(), B()
              };
            ...
            t.onUpdateObjectiveScore=function(e){
              return c.post("/api/exams/".concat(t.exam.id, "/manualscoring/").concat(e)).success(v.decorateSuccess((function(e){
                t.manualEditMark=!0, r.find(t.currentExaminee.submissions, {
                  id:parseInt(t.submissionData.id)
                }).score=e.score, R(e.id), B(), t.refreshSubmissionCount()
            ...
            var G=function(){
              ...
              :t.subjects, r.each(s, (function(e){
                if("short_answer"!==e.type&&"fill_in_blank"!==e.type||a.push(W(e)), "analysis"===e.type)return a=a.concat((e=>r.map(r.filter(e, {
                  type:"short_answer"
                }), W))(e.sub_subjects))
              })), a
            }, H=(e, s)=>(()=>{
            ...
            t.save=function(t){
              return e.currentGroup?Z(t):J(t)
            };
            var Q=(e, t, s)=>statistics.track({
              activity_id:e, activity_type:"exam", action:statistics.enums.Action.give_score, mode:statistics.enums.Mode.normal, channel:statistics.enums.Channel.web, target_info:{
                id:t, type:s, is_student:!0
              }
            }), J=function(){
              ...
              :void 0, n=q(e), o=function(e){
                if(U.hide(), e.message&&v.warning(e.message), a&&a(), e.errors)return H(e.errors.graded_subjects, n)
              }, i=function(e){
                U.hide(), v.success();
                ...
                if(n.score=e.submission_score, a.waitingForScore=!1, R(n.id), B(), t.refreshSubmissionCount(), Q(t.examId, t.currentExaminee.id, "personal"), s)return s()
              }, u=()=>({
                examinee_id:t.currentExaminee.id, graded_subjects:n, submission_id:t.submissionData.id
              });
              return U.show(), c.post("/api/exams/".concat(t.examId, "/give-score"), u()).success(i).error(o)
            }, Z=function(){
              ...
              :void 0, o=q(s), i=function(e){
                if(U.hide(), e.message&&v.error(e.message), n&&n(), e.errors)return H(e.errors.graded_subjects, o)
              }, l=function(s){
                U.hide(), v.success();
                ...
                if(t.submissionData.score=n.score, e.submissionData=t.submissionData, B(), t.refreshSubmissionCount(), Q(t.examId, e.currentGroup.id, "group"), a)return a()
              }, d=()=>({
              ...
              return U.show(), c.post("/api/exams/".concat(t.examId, "/give-scores"), d()).success(l).error(i)
            }, Y=function(){
            ...
            t.search=function(){
              ...
              return e.currentGroup?Z(t, s):J(t, s)
            }, t.autoSaveSubmissionComment=function(e){
              var s={
                subject_id:e.id, comment:e.comment
              };
            ...
            var K=function(){
              ...
              :[
                "-!".concat(t.predicate), s
              ]), t.filteredExaminees=N(t.filteredExaminees, a), t.changePage(1)
            }, X=e=>(()=>{
              var t, s=[
              ], a=u(e);
              try{
              ...
              t.examinees=r.map(s, (function(e){
                ...
                return e.studentInfo=h.getBelongTo(e, " ", "NFA"===t.deliveryOrg), e.waitingForScore=e.submitted&&null===e.score, e.score=m.formatFloat(e.score), null!==e.final_score&&""!==e.final_score||!e.score||(e.final_score=e.score), e.final_score=m.formatFloat(e.final_score), e.status=e.status_code, e.submissionTime=(s=e.submissions, a="", (n=r.find(s, {
                  is_latest_version:!0
                }))&&n.submitted_at&&(a=n.submitted_at), a), e.lastSubmitMethodText=ee(e.submissions), e.status_comment=e.status_comment||"", e
              })), e.examinees=t.examinees, j.initDepartmentsInfoForEnrollments(t, t.examinees, void 0, A), j.initOrgDepartments(t, A).then((()=>{
                t.vueParam.departments=r.cloneDeep(t.departments), t.vueParam.disabled=!1
              })), t.reloadExam=!1, t.previewScore&&t.calculateScore(), X(t.examinees), Y()
            }, se=e=>S.initExaminees(t.examId, !0).then((function(t){
              return e.submit_by_group?ae(t):te(t)
            }));
            e.$on("refreshExamData", (function(e, s){
              t.exam=s.new;
              var a=s.old;
              if(a.score_rule!==t.exam.score_rule||((e, t)=>e.submit_by_group!==t.submit_by_group||e.group_set_id!==t.group_set_id)(t.exam, a))return se(t.exam)
            })), t.$on("afterSaveMakeUpExam", (function(){
              return t.reloadExam=!0, oe()
            })), t.showPreviewScore=function(){
              return t.previewScore=!t.previewScore, t.calculateScore(), ne()
            }, t.calculateScore=function(){
              if(t.previewScore){
              ...
              S.loadGroups(t.exam.group_set_id).then((function(a){
                a=r.filter(a, (e=>!t.exam.has_assign_group||t.exam.assign_group_ids.includes(e.id))), t.examinees=s, r.each(a, (function(e){
                  ...
                  ?e.submissions[
                    ...
                    0
                  ].submitted_at:"", e.lastSubmitMethodText=ee(e.submissions), r.each(e.examinees, (e=>{
                  ...
                  0
                ]), V(), e.submissionData=t.submissionData), t.reloadExam=!1, t.previewScore&&t.calculateScore(), X(t.groups)
              }))
            };
            a(window).resize((()=>re()));
            var re=function(){
              ...
              return re(), a(".sync-scroll").scroll((()=>M((function(){
                return a(".sync-scroll-top").scrollLeft(a(".sync-scroll").scrollLeft()), a(".sync-scroll-header").scrollLeft(a(".sync-scroll").scrollLeft())
              ...
              return x.all([
                ...
                return t.exam=a, a.submit_by_group?ae(n):(te(n), ce(!1)), ne()
              }))
            };
              ...
              if(t.exam.is_eztest){
                ...
                var s=setInterval((()=>{
                  S.getExamSubmissionSyncProgress(t.exam.id, (a=>{
                    a.tasks?t.hasProgressSyncTask=!0:(clearInterval(s), t.hasProgressSyncTask=!1, e&&se(t.exam))
                  }))
                }), 5e3);
            ...
            t.$on("$destory", (()=>clearInterval(t.syncSubmissionIntervalId))), t.syncEztestSubmissions=()=>{
            ...
            }, t.examId&&oe(), t.classroomId&&(ie=_.initClassroom(t.classroomId), ue=_.initSubjectsRule(t.classroomId), x.all([
              ie, ue
            ]).then((function(){
              ...
              })), j.initDepartmentsInfoForEnrollments(t, t.examinees), Y(), X(t.examinees)
            })))
          }
        }
      ]
        ...
        "$rootScope", "$scope", "$http", "$timeout", "toastr", "subjectPointRuleHelper", function(e, t, s, n, i, l){
          ...
          var j={
            ...
            if("media"===e){
              ...
              W(s, "sumPointsEquality"), W(s, "difficultySumPointsEquality");
            ...
            r.each(p, (e=>{
              W(e, "sumPointsEquality"), W(e, "difficultySumPointsEquality")
            })), r.each(p, (e=>{
              q("media", e)
            }))
          }, Q=(e, s, a, r)=>{
            ...
            r.each(t.subjectTypes, (e=>{
              r.each(f, (s=>{
                ...
                &&($(e, s), V(e, s), t.subjectsMap.rootSubjects[
                  e
                ].enableDifficulty?B(e, s):U(e, s))
              }))
            })), r.each(m, (e=>{
          ...
          t.toggleSpecificAnalysisDifficulty=(e, s)=>{
            ...
            t.subjectsMap.rootSubjects[
              ...
              e
            ].selectedCount), x(), h(e), y(), U(e, "selectedCount"), U(e, "points"), U(e, "sumPoints"), ee()
            ...
            [
              s
            ].selectedCount), g(e), x(), w(e, s), M(e), y(), "analysis"===e&&H(), "media"===e&&z(), R(e, s, "selectedCount"), R(e, s, "points"), R(e, s, "sumPoints"), ee()
            ...
            [
              a
            ].selectedCount), I(e, s), T(e, s, a), C(e, s), J(e, s, a, "selectedCount"), J(e, s, a, "points"), J(e, s, a, "sumPoints"), q(e, s)
            ...
            [
              r
            ].selectedCount), D(e, s, a), P(e, s), N(e, s, a, r), O(e, s, a), k(e, s), Y(e, s, a, r, "selectedCount"), Y(e, s, a, r, "points"), Y(e, s, a, r, "sumPoints"), q(e, s)
      ...
      e.exports=[
        "$rootScope", "$scope", "$routeParams", "$http", "$location", "toastr", "ExamHelper", "statHelper", "examRepository", "ExamSubject", "classroomRepository", "$q", function(){
          var e, t=(e=n.mark((function e(t, i, u, l, d, f, j, v, S, _, x, y){
            var h, g, M, w, E, I, C, P, k, T, D, F, N, A, O, $, U, L, R;
              ...
              ;
                ...
                case 11:M=e.sent, w=M.buildSubjectGroup, E=M.getSubjectIndexInGroup, I=M.subjectGroupState, C=M.flatGroupSubjects, P=M.clearSubjectGroups, i.loadComponents=()=>{
                  ...
                  S.initExam(i.examId).then((function(e){
                    return v.inExamPage(e), i.exam=e, U(e), $()
                  }))
                }, R=function(){
                ...
                }, i.jumpToSubject=p.jumpToSubject, i.examId&&L(), i.classroomId&&R(), u.retakeRecordId&&O(u.retakeRecordId), u.submissionId&&(t.submissionData={
                  id:u.submissionId
      ...
      s(207452);
      var d=s(571478), m=s(966491), p=s(552979).default, b=s(580630).useImage2Pdf, f=s(363838), j=s(181769), v=j.canEditActivity, S=j.hasEditPermissionForBlueprint, _=s(218831).camelizeKeys, x=s(5782).default, y=s(703564).A;
      e.exports=[
        "$rootScope", "$scope", "$http", "$routeParams", "ExamHelper", "$filter", "toastr", "examRepository", "ExamSubject", "storageUploader", "$translate", "$timeout", function(e, t, s, u, c, j, h, g, M, w, E, I){
          ...
          t.submissionData={
            ...
            var s, a=null===(s=window.featureToggles)||void 0===s?void 0:s.airGrading, r="short_answer"===e.type&&null===e.parent_id, n=v(t.exam);
          ...
          var N=t=>{
            e.$broadcast("pdfEditor", t, $(t.subject, t.uploadId, t.fileName)), a("#pdf-editor").foundation("reveal", "open")
          };
          t.$on("changePdfEditor", (function(e, s){
            for(var a=0, r=t.pdfEditorUploadIds.length, n=0;
            n<r;
          ...
          t.deleteFile=(e, a)=>{
            ...
            Object.values(t.subjectAttachmentMap[
              ...
              L(), Object.keys(t.subjectAttachmentMap[
                a.id
              ]).forEach((s=>{
                t.subjectAttachmentMap[
                  a.id
          ...
          var U=function(s){
            ...
            t.examId&&s.get("/api/exams/".concat(t.examId, "/submissions/").concat(t.submissionData.id)).success((function(e){
              ...
              }, c.updateSubjectsDetailData(t.subjects, s, a, t.submissionScoreData, n, o), V(), R()
            })).error((function(){
            }))
          }, R=function(){
          ...
          t.onUpdateObjectiveScore=function(e){
            return s.post("/api/exams/".concat(t.exam.id, "/manualscoring/").concat(e)).success(h.decorateSuccess((function(e){
              ...
              s.score=e.score, s.marked=!0, U(e.id), R(), t.refreshSubmissionCount()
            }))).error(h.decorateError((function(){
            })))
          };
          var V=function(){
          ...
          var H=(e, t, s)=>statistics.track({
            ...
            :void 0, o=G(e), i=function(e){
              if(P.hide(), e.message&&h.warning(e.message), n&&n(), e.errors)return W(e.errors.graded_subjects, o)
            }, u=function(e){
              P.hide(), h.success();
              ...
              if(n.score=e.submission_score, n.marked=e.marked, s.waitingForScore=!1, U(n.id), L(), t.refreshSubmissionCount(), H(t.examId, t.currentExaminee.id, "personal"), a)return a()
            }, c=()=>({
              examinee_id:t.currentExaminee.id, graded_subjects:o, submission_id:t.submissionData.id
            });
            return P.show(), s.post("/api/exams/".concat(t.examId, "/give-score"), c()).success(u).error(i)
            ...
            :void 0, u=G(a), c=function(e){
              if(P.hide(), e.message&&h.error(e.message), o&&o(), e.errors)return W(e.errors.graded_subjects, u)
            }, l=function(s){
              P.hide(), h.success();
              var a=r.find(e.currentGroup.submissions, {
                id:parseInt(t.submissionData.id)
              ...
              if(t.submissionData.score=a.score, e.submissionData=t.submissionData, a.marked=s.marked, R(), t.refreshSubmissionCount(), H(t.examId, e.currentGroup.id, "group"), n)return n()
            }, d=()=>({
      ...
      e.exports=[
        "$rootScope", "$scope", "$routeParams", "$window", "$q", "modelHelper", "statHelper", "ExamHelper", "examRepository", "activityRepository", "toastr", "$http", function(e, t, s, c, d, m, p, b, f, j, v, S){
          var _, x="True"===a("#enrollment-is-student").val();
          ...
          t.openStartAudioExamConfirmationPopup=function(){
            ...
            return f.checkExamQualification(s, "start", (function(e){
              ...
              e.ipErrorMessage=t.message, e.clearCkeckStatus(), e.ipCkeckStatus.start=!0, a("#invalid-ip-confirmation-popup").foundation("reveal", "open")
            }))
          }, t.showSubjectsSummary=(e, t, s)=>b.getSubjectsSummary(e, t, s), t.showSubjectsScore=function(e, t){
            return e<100?"，".concat(t.suffix.replace("{}", e), " ( ").concat(t.tip, " )"):"，".concat(t.suffix.replace("{}", e))
          ...
          var y=()=>{
            f.initExamMakeUpRecord(t.examId).then((e=>{
              t.makeUpRecord=e.make_up_record, x&&t.$emit("onActivityLoaded", t.makeUpRecord)
            }))
          }, h=function(e){
            ...
            if(x){
              ...
              return d.all([
                ...
                if(h(a), t.$emit("onActivityLoaded", a), r&&0===r.left_time)return t.examIsSaving=!0
              }))
            }
            return f.initExam(t.examId).then((e=>h(e)))
          };
          ...
          var M=()=>f.initExamSubjectsSummary(t.examId).then(function(){
          ...
          ());
          e.$on("refreshExamData", ((e, s)=>t.exam=t.currentActivity=s.new)), null!==(_=window.featureToggles)&&void 0!==_&&_.lazyLoadCourseSection?Promise.all([
            g(), y()
          ]).then((()=>{
            e.$broadcast("loadingActivityFinished", {
              activityResponse:t.exam, activitiesRead:{
              }
            }), M(), j.initPublishInfo(t, t.exam)
          })):(g().then((()=>{
            M(), j.initPublishInfo(t, t.exam)
          })), y()), t.get_examination_url=()=>"".concat(t.exam.examination_url).concat(t.userNo), t.canViewKnowledgeNodeReference=()=>!!t.isInstructorView||"published"===t.course.knowledge_graph_publish_type, t.statusTips=e=>({
          ...
          :[
            ...
            e.deleted?v.warning(t.statusTips("missed")):S.get("/api/uploads/".concat(e.id)).success((e=>{
        ...
        "classroomApi", "$q", "toastr", function(e, t, s){
          ...
          return{
            initClassroom(s){
              ...
              =t.defer();
              return e.getClassroomExam(s, (e=>r[
                s
              ].resolve(e)), (()=>r[
                s
              ].resolve(null))), r[
            ...
            }, startClassroom:(t, s, a)=>e.startClassroom(t, (function(e){
              return r[
                t
              ]
              &&delete r[
            ...
            })), finishClassroom:(t, s, a)=>e.finishClassroom(t, (function(e){
              return r[
                t
              ]
              &&delete r[
              ...
              =t.defer();
              return e.getFeedbackActivity(s, (e=>n[
                s
              ].resolve(e)), (()=>n[
                s
              ].resolve(null))), n[
              ...
              =t.defer();
              return s?e.getSubjectsRule(s, (e=>o[
                s
              ].resolve(e)), (()=>o[
                s
              ].resolve(null))):o[
              ...
              =t.defer();
              return e.getSubjectsWithStatInfo(s, (e=>u[
                s
              ].resolve(e.subjects)), (()=>u[
                s
              ].resolve([
              ]))), u[
                s
              ...
              =t.defer();
              return e.getMySubmissions(s, (e=>l[
                s
              ].resolve(e)), (()=>l[
                s
              ].resolve({
            ...
            }, syncClassroomSubject(t, r, n){
              e.syncClassroomSubject(t, r, (e=>{
                s.success(a.t("blueprint.syncSuccess")), n()
              }), (function(e){
                s.warning(a.t("blueprint.syncFailed")), n()
              }))
            }, getExamineesList(s){
              var a=t.defer();
