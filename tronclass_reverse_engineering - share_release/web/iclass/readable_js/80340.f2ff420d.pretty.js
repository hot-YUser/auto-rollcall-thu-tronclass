(self.webpackChunklms=self.webpackChunklms||[
  ...
  [
    1104, 7145, 11580, 17621, 18406, 33961, 40002, 42041, 44437, 56342, 62383, 64422, 66818, 67888, 68610, 77444, 80340, 84764, 89199
  ], {
    258:(t, e, r)=>{
      r(951605)({
        global:!0
      ...
      t.exports=function(){
        ...
        function L(t){
          ...
          t.addEventListener("keydown", (function(e){
            ...
            if(r===s||u(e, r)||c(e, r))return F(t, e)
          }), !0), e=t, h.disableMenu&&e.addEventListener("contextmenu", (function(t){
            if("touch"!==t.pointerType)return F(e, t)
        ...
        var B=function(){
          function t(r){
            var n=r.type;
            r=void 0===(r=r.enabled)||r, e(this, t), this.type=I.Unknown, this.enabled=!0, this.type=n, this.enabled=r, this.enabled&&(n=this, W.push(n), this.init())
          }
          return n(t, [
            {
              key:"onDevToolOpen", value:function(){
                var t;
                console.warn("You don't have permission to use DEVTOOL!【type = ".concat(this.type, "】")), h.clearIntervalWhenDevOpenTrigger&&V(), window.clearTimeout(H), h.ondevtoolopen(this.type, p), t=this.type, D[
                  t
                ]
                =!0
              }
        ...
        function q(t){
          ...
          g(e, r), n=r, o=e, void 0!==(u=document).hidden?(i="hidden", s="visibilitychange", a="visibilityState"):void 0!==u.mozHidden?(i="mozHidden", s="mozvisibilitychange", a="mozVisibilityState"):void 0!==u.msHidden?(i="msHidden", s="msvisibilitychange", a="msVisibilityState"):void 0!==u.webkitHidden&&(i="webkitHidden", s="webkitvisibilitychange", a="webkitVisibilityState"), u.removeEventListener(s, f, !1), u.addEventListener(s, f, !1), $=window.setInterval((function(){
            if(!(t.isSuspend||c||M())){
              ...
              k(), "function"==typeof h.ondevtoolclose&&(r=j, !R()&&r&&h.ondevtoolclose())
            }
