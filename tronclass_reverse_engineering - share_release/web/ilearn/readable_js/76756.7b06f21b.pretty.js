(self.webpackChunklms=self.webpackChunklms||[
  ...
  [
    ...
    5782:(e, t, r)=>{
      ...
      e.exports=[
        "$rootScope", "$scope", "$q", "activityRepository", "$http", "$location", "toastr", "revealModalParams", "modelHelper", "commonApi", "$timeout", "activityApi", function(e, t, r, i, a, c, d, p, l, m, v, f){
          o("#courseId").val();
          t.remindHomework=function(e){
          ...
          }, t.makeUpHomework=e=>t.$emit("makeUpHomework", e, !0), t.editHomework=r=>l.editActivity(e, t, t.course, r.module_id, r.syllabus_id, v, r), t.deleteHomework=function(e){
            ...
            ={
              ...
              if(o(r).foundation("reveal", "close"), s.remove(t.homework_activities, {
                id:e.id
              }), t.isCourseInCheckpointMode)return l.deleteActivityFromCourse(t.course, e), l.refreshPrerequisitesForAllDependantActivities(t.course, e), l.updateCriterionInfoForActivities(t.course, t.homeworkList)
          ...
          e.$on("homeworkSubmitted", (function(e, r){
            return(r=s.find(t.homework_activities, {
              ...
              f.getActivity(e.id, (function(t){
                if(t)return e.non_submit_times=t.non_submit_times, e.submit_times=parseInt(t.submit_times, 10)
              }), (function(){
              }))
            }
            (r), t.isCourseInCheckpointMode&&t.isTogglePrerequisiteOpened&&r.completion_criterion&&(r.completion_criterion===t.homeworkSubmittedInfo?l.refreshPrerequisitesStatus(r, t, !0, t.homeworkCompletedInfo):l.refreshPrerequisitesStatus(r, t, !1, t.notScored), l.updateCriterionInfoForActivities(t.course, t.homework_activities)), a.get("/api/submissions/".concat(r.id, "/count")).success((function(e){
              return r.user_submit_count=e.submission_count, t.isHomeworkOverSubmit(r)
            }))
          })), e.$on("prerequisitesUpdated", ((e, r)=>l.refreshPrerequisitesForCurrentActivity(r, t.homeworkList, t.course)));
          var h=function(e){
            if(t.isCourseInCheckpointMode&&(t._course=i._course, i.initActivitiesForActivityList(t._course), i.initExamsForActivityList(t._course), e))return u(t, i, e, l, t.homework_activities).refreshPrerequisitesAfterActivityEdit()
          }, g=e=>s.filter(e, (e=>e.is_assigned_to_all||s.includes(e.assign_group_ids, t.group.id))), y=function(){
            ...
            return r.all([
              ...
              return t.course=i, t.homework_activities=g(u), h(e)
            }))
          };
          return y()
        }
      ...
      r(714913), r(158649);
      var o=r(184743), n="YYYY.MM.DD HH:mm:ss", i="Asia/ShangHai", u=function(){
        function e(){
        }
      ...
      r.d(t, {
        $u:()=>i.$u, EW:()=>i.EW, IG:()=>i.IG, IJ:()=>i.IJ, KR:()=>i.KR, Kh:()=>i.Kh, LE:()=>u, R1:()=>i.R1, Sg:()=>s, dY:()=>i.dY, hZ:()=>i.hZ, hi:()=>i.hi, i9:()=>i.i9, jr:()=>i.jr, nI:()=>i.nI, nT:()=>i.nT, o5:()=>i.o5, pM:()=>i.pM, rY:()=>i.rY, sV:()=>i.sV, tB:()=>i.tB, uY:()=>i.uY, ux:()=>i.ux, wB:()=>i.wB, xo:()=>i.xo
      });
      var o, n=r(962893), i=r(595738);
      (o=(o=n.default)||n.default)&&!o.__composition_api_installed__&&o.use(i.Ay);
      var u=!0, s=!1;
      n.default.version
    }, 121087:(e, t, r)=>{
      r.d(t, {
      ...
      var o=r(552979), n=r(962893), i=r(595738), u=function(){
      ...
      var o=r(512897), n=r.n(o), i=r(55042), u=r.n(i), s=new(n())({
      ...
      r.d(t, {
        $A:()=>_, Il:()=>l, sB:()=>S, uJ:()=>n, ul:()=>b, xY:()=>v, z$:()=>f
      });
      r(540590);
        ...
        "groupApi", "$q", function(e, t){
          var r={
            ...
            courseId:o("#courseId").val(), groupSetData:[
              ...
              =t.defer();
              var a=t.defer(), c=t.defer(), d=t.defer(), p=[
              ...
              })):d.resolve(), t.all(p).then((()=>(u.initStudentsMap(this.students), u.initGroupSets(this.groupSetData, s), r[
                this.courseId
              ].resolve()))), r[
                this.courseId
              ].promise
      ...
      r.r(t), r.d(t, {
        addActivityComment:()=>z, applyCommentLikeOperation:()=>K, checkTencentMeetingUserAuth:()=>se, checkUserLarkAuth:()=>U, createActivitiesInCourses:()=>T, createActivity:()=>l, createCalendarMeeting:()=>P, deleteActivity:()=>m, deleteActivityResource:()=>k, deleteSubmissionAttachMarkUpload:()=>E, getActivityCommentReplies:()=>L, getActivityComments:()=>F, getActivityCommentsReplies:()=>N, getActivityDetail:()=>y, getActivityHaveDependents:()=>w, getActivityReferences:()=>W, getActivityResource:()=>C, getClasinJoinUrl:()=>h, getClassinWebcastUrl:()=>g, getCommentCountWithType:()=>J, getCompletionCriteria:()=>f, getCourseActivities:()=>_, getDingtalkWatchStats:()=>ae, getGroupSubmission:()=>oe, getGroupSubmissions:()=>M, getH5CoursewareViewUrl:()=>ce, getHomeworkDuplicateRate:()=>ie, getHomeworkInterScores:()=>X, getInterGroupScores:()=>ee, getIntraGroupScores:()=>te, getMeetingStatistics:()=>G, getPageCommentStat:()=>Z, getScoreItems:()=>A, getScoreRecords:()=>b, getStudentSubmission:()=>re, getStudentSubmissions:()=>R, getSubmissionAttachements:()=>j, logActivityRead:()=>O, logMgs:()=>x, refreshMarkedAttachment:()=>$, removeActivityComment:()=>H, removeActivityCommentReply:()=>q, replaceSubmissionCorrectUploadReference:()=>D, replyActivityComment:()=>Y, reprocessLectureLiveReplay:()=>S, trackSchedulePlay:()=>I, updateActivity:()=>v, updateActivityComment:()=>B, updateActivityCommentReply:()=>V, updateActivityResource:()=>de, updateCorrectUploads:()=>ue, updateHomeworkAnnounceMarkStatus:()=>ne, updateHomeworkScoreAndComment:()=>Q, upsertH5CoursewareCmi:()=>pe
      });
        ...
        return d(void 0, void 0, void 0, (function(){
          ...
          return p(this, (function(p){
            switch(p.label){
              ...
              case 1:return c=p.sent(), d=(0, i.camelizeKeys)(c.data), l=(0, u.plainToClass)(s.sB, d.records, {
                excludeExtraneousValues:!0
              }), [
                2, {
                  page:e, pageSize:t, pages:d.pages, total:d.total, start:d.start, end:d.end, items:l
                }
              ]
            }
          }))
      ...
      r.r(t), r.d(t, {
        AvaLiveInfo:()=>v, BaseCourse:()=>d, ChinamCloudLive:()=>l, CourseAuditReference:()=>y, CourseDetail:()=>f, CourseForm:()=>_, CourseType:()=>o, CourseWithResourceNum:()=>h, Module:()=>p, OnoCourseStatUser:()=>b, SelectedCourse:()=>c, TopCourse:()=>a, Upload:()=>g, liveStatus:()=>m
      });
      var o, n=r(738645), i=r(510543), u=r(88595), s=function(e, t, r, o){
        var n, i=arguments.length, u=i<3?t:null===o?o=Object.getOwnPropertyDescriptor(t, r):o;
        if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)u=Reflect.decorate(e, t, r, o);
        else for(var s=e.length-1;
        s>=0;
      ...
      r.d(t, {
        BM:()=>h, CR:()=>T, IT:()=>A, KJ:()=>b, Lp:()=>l, Mh:()=>g, VA:()=>P, Zd:()=>f, aN:()=>C, ae:()=>w, i3:()=>G, k6:()=>y, mU:()=>v
      });
      var o, n=r(738645), i=r(510543), u=r(152229), s=r(958793), a=r(177673), c=r(731904), d=(o=function(e, t){
        return(o=Object.setPrototypeOf||{
          __proto__:[
          ]
        }
        ...
        return Object.defineProperty(e.prototype, "creditRemaining", {
          ...
          if(e.isAllocationMode){
            var t=this.calcCreditPercentage(this.userCreditAssigned, this.creditAssigned, 100), r=t-(n=this.calcCreditPercentage(this.userCreditUsed, this.userCreditAssigned, t)), o=this.calcCreditPercentage(this.courseCreditAssigned, this.creditAssigned, 100);
            return{
              creditUserUsedPercent:n, creditUserUnusedPercent:r, creditCourseUsedPercent:i=this.calcCreditPercentage(this.courseCreditUsed, this.courseCreditAssigned, o), creditCourseUnusedPercent:o-i, creditRemainingPercent:100-t-o
            }
          }
          var n, i;
        ...
        ], e.prototype, "orgId", void 0), p([
          (0, n.v)({
            name:"credit_assigned"
          })
        ], e.prototype, "creditAssigned", void 0), p([
          (0, n.v)({
            name:"credit_used"
          })
        ], e.prototype, "creditUsed", void 0), p([
          (0, n.v)({
            name:"user_credit_used"
          })
        ], e.prototype, "userCreditUsed", void 0), p([
          (0, n.v)({
            name:"user_credit_assigned"
          })
        ], e.prototype, "userCreditAssigned", void 0), p([
          (0, n.v)({
            name:"course_credit_used"
          })
        ], e.prototype, "courseCreditUsed", void 0), p([
          (0, n.v)({
      ...
      (), m=function(){
        ...
        return p([
          (0, n.v)({
            ...
            var t, r=e.obj, o=e.value;
            return o||(null===(t=null==r?void 0:r.credit_state)||void 0===t?void 0:t.credit_assigned)||0
          }))
        ], e.prototype, "creditAssigned", void 0), p([
          (0, n.v)({
            name:"credit_used"
            ...
            var t, r=e.obj, o=e.value;
            return o||(null===(t=null==r?void 0:r.credit_state)||void 0===t?void 0:t.credit_used)||0
          }))
        ], e.prototype, "creditUsed", void 0), p([
          (0, n.v)({
            ...
            var t, r=e.obj, o=e.value;
            return o||(null===(t=null==r?void 0:r.credit_state)||void 0===t?void 0:t.credit_remaining)||0
          }))
        ], e.prototype, "creditRemaining", void 0), p([
          (0, n.v)({
            name:"credit_limit"
          }), (0, i.d)((function(e){
            var t, r=e.obj, o=e.value;
            return o||(null===(t=null==r?void 0:r.credit_state)||void 0===t?void 0:t.credit_limit)||null
          }))
        ], e.prototype, "creditLimit", void 0), p([
          (0, n.v)(), (0, i.d)((function(e){
            var t, r=e.obj, o=e.value;
            return o||(null===(t=null==r?void 0:r.credit_state)||void 0===t?void 0:t.status)||""
          }))
        ], e.prototype, "status", void 0), p([
          (0, n.v)({
            name:"has_credit_limit"
          }), (0, i.d)((function(e){
            var t, r=e.obj, o=e.value;
            return o||(null===(t=null==r?void 0:r.credit_state)||void 0===t?void 0:t.has_credit_limit)||""
          }))
      ...
      (), v=function(e){
        ...
        ], t.prototype, "userId", void 0), p([
          (0, n.v)({
            name:"user_no"
          })
        ], t.prototype, "userNo", void 0), p([
          (0, n.v)({
            name:"user_name"
          })
        ], t.prototype, "userName", void 0), p([
          (0, n.v)()
        ], t.prototype, "department", void 0), p([
          (0, n.v)()
        ], t.prototype, "role", void 0), p([
          (0, n.v)({
            name:"credit_used_percent"
          })
        ], t.prototype, "creditUsedPercent", void 0), p([
          (0, n.v)({
            name:"is_low_air_credit"
          })
        ], t.prototype, "isLowAirCredit", void 0), p([
          (0, n.v)({
            name:"credit_state"
          }), (0, u.Z)((function(){
            return m
          }))
        ], t.prototype, "creditState", void 0), p([
          (0, n.v)()
      ...
      (m), f=function(){
        ...
        ], e.prototype, "user", void 0), p([
          (0, n.v)({
            name:"user_role"
          })
        ], e.prototype, "userRole", void 0), p([
          (0, n.v)({
            name:"credit_assigned"
          })
        ], e.prototype, "creditAssigned", void 0), p([
        ...
        ], e.prototype, "moduleCreditUsed", void 0), p([
          (0, n.v)({
            name:"material"
          }), (0, i.d)((function(e){
            var t, r;
        ...
        ], e.prototype, "onlineVideo", void 0), p([
          (0, n.v)({
            name:"lesson"
          }), (0, i.d)((function(e){
            var t, r;
        ...
        ], e.prototype, "classroom", void 0), p([
          (0, n.v)({
            name:"Chat"
          }), (0, i.d)((function(e){
            var t, r;
      ...
      (), h=function(){
        ...
        ], e.prototype, "course", void 0), p([
          (0, n.v)({
            name:"instructors"
          })
        ], e.prototype, "instructors", void 0), p([
          (0, n.v)({
            name:"credit_used"
          })
        ], e.prototype, "creditUsed", void 0), p([
        ...
        ], e.prototype, "usageCount", void 0), p([
          (0, n.v)({
            name:"students_count"
          })
        ], e.prototype, "studentsCount", void 0), p([
          (0, n.v)({
            name:"use_air_chat_students_count"
          })
        ], e.prototype, "useAirChatStudentsCount", void 0), p([
          (0, n.v)(), (0, i.d)((function(e){
            var t=e.obj;
      ...
      (), g=function(){
        ...
        return e.prototype.avgUserCredit=function(e){
          return e.isAllocationMode?(0, a.eQ)(this.totalCreditUsed, this.assignedUserCounts):e.isCreditPoolMode?(0, a.eQ)(this.totalCreditUsed, this.usedUserCounts):0
        }, p([
          (0, n.v)({
            name:"user_counts"
          })
        ], e.prototype, "userCounts", void 0), p([
          (0, n.v)({
            name:"assigned_user_counts"
          })
        ], e.prototype, "assignedUserCounts", void 0), p([
          (0, n.v)({
            name:"used_user_counts"
          })
        ], e.prototype, "usedUserCounts", void 0), p([
          (0, n.v)({
            name:"credit_assigned"
          })
        ], e.prototype, "creditAssigned", void 0), p([
        ...
        ], e.prototype, "maxCreditUsed", void 0), p([
          (0, n.v)({
            name:"total_credit_used"
          })
        ], e.prototype, "totalCreditUsed", void 0), p([
          (0, n.v)(), (0, i.d)((function(e){
            var t=e.obj;
            return(0, a.nJ)(t.total_credit_used, t.credit_assigned)
          }))
      ...
      (), y=function(){
        ...
        return e.prototype.avgCourseCreditUsed=function(e){
          return e.isAllocationMode?(0, a.eQ)(this.totalCreditUsed, this.assignedCourseCounts):e.isCreditPoolMode?(0, a.eQ)(this.totalCreditUsed, this.usedCourseCounts):0
        }, p([
          (0, n.v)({
            name:"course_counts"
          })
        ], e.prototype, "courseCounts", void 0), p([
          (0, n.v)({
            name:"assigned_course_counts"
          })
        ], e.prototype, "assignedCourseCounts", void 0), p([
          (0, n.v)({
            name:"used_course_counts"
          })
        ], e.prototype, "usedCourseCounts", void 0), p([
          (0, n.v)({
            name:"credit_assigned"
          })
        ], e.prototype, "creditAssigned", void 0), p([
        ...
        ], e.prototype, "usedCounts", void 0), p([
          (0, n.v)({
            name:"course_student_counts"
          })
        ], e.prototype, "courseStudentCounts", void 0), p([
          (0, n.v)(), (0, i.d)((function(e){
            var t=e.obj;
            return Math.round(t.used_counts/t.course_student_counts)
          }))
        ], e.prototype, "avgUserTimes", void 0), p([
          (0, n.v)(), (0, i.d)((function(e){
            var t=e.obj;
            return(0, a.nJ)(t.total_credit_used, t.credit_assigned)
          }))
      ...
      (), b=function(){
        ...
        ], e.prototype, "userNo", void 0), p([
          (0, n.v)({
            name:"department"
          })
        ], e.prototype, "department", void 0), p([
          (0, n.v)({
            name:"credit_state"
          }), (0, u.Z)((function(){
            return v
          }))
        ], e.prototype, "creditState", void 0), p([
          (0, n.v)({
            name:"ai_activation"
          })
        ], e.prototype, "aiActivation", void 0), p([
          (0, n.v)()
        ], e.prototype, "_checked", void 0), p([
          (0, n.v)()
        ], e.prototype, "creditStateStatus", null), p([
          (0, n.v)()
      ...
      (), S=function(){
        ...
        ], e.prototype, "realName", void 0), p([
          (0, n.v)()
        ], e.prototype, "sort", void 0), p([
          (0, n.v)({
            name:"academic_year_id"
          })
        ], e.prototype, "academicYearId", void 0), p([
          (0, n.v)({
            name:"is_active"
          })
        ], e.prototype, "isActive", void 0), p([
          (0, n.v)(), (0, u.Z)((function(){
            return _
          }))
      ...
      (), w=function(){
        ...
        ], e.prototype, "courseCode", void 0), p([
          (0, n.v)({
            name:"course_type"
          })
        ], e.prototype, "courseType", void 0), p([
          (0, n.v)({
            name:"academic_year"
          }), (0, u.Z)((function(){
            return _
          }))
        ], e.prototype, "academicYear", void 0), p([
          (0, n.v)({
            name:"semester"
          }), (0, u.Z)((function(){
            return S
          }))
        ], e.prototype, "semester", void 0), p([
          (0, n.v)(), (0, u.Z)((function(){
            return b
          }))
        ], e.prototype, "teachers", void 0), p([
          (0, n.v)({
            name:"instructors"
          }), (0, i.d)((function(e){
            var t=e.value;
        ...
        ], e.prototype, "importedFrom", void 0), p([
          (0, n.v)()
        ], e.prototype, "_checked", void 0), p([
          (0, n.v)()
        ], e.prototype, "creditStateStatus", null), p([
          (0, n.v)()
        ], e.prototype, "academicYearName", null), p([
          (0, n.v)()
      ...
      (), C=function(e){
        ...
        return d(t, e), p([
          ...
          (0, n.v)()
        ], t.prototype, "instructors", void 0), p([
          (0, n.v)()
        ], t.prototype, "name", void 0), p([
          (0, n.v)()
        ], t.prototype, "semester", void 0), p([
          (0, n.v)({
            name:"academic_year"
          })
        ], t.prototype, "academicYear", void 0), p([
          (0, n.v)({
            name:"course_code"
          })
        ], t.prototype, "courseCode", void 0), p([
          (0, n.v)({
            name:"course_type"
          })
        ], t.prototype, "courseType", void 0), p([
          (0, n.v)({
            name:"credit_used_percent"
          })
        ], t.prototype, "creditUsedPercent", void 0), p([
        ...
        ], t.prototype, "courseId", void 0), p([
          (0, n.v)()
        ], t.prototype, "_checked", void 0), p([
          (0, n.v)({
            name:"credit_state"
          }), (0, u.Z)((function(){
            return m
      ...
      (m), k=function(){
        ...
        ], e.prototype, "appliedCredits", void 0), p([
          (0, n.v)({
            name:"approved_credits"
          })
        ], e.prototype, "approvedCredits", void 0), p([
          (0, n.v)()
        ], e.prototype, "reason", void 0), p([
          (0, n.v)()
        ], e.prototype, "status", void 0), p([
          (0, n.v)()
        ], e.prototype, "remark", void 0), p([
          (0, n.v)({
            name:"created_at"
          }), (0, i.d)((function(e){
            var t=e.value;
        ...
        ], e.prototype, "createdAt", void 0), p([
          (0, n.v)({
            name:"updated_at"
          }), (0, i.d)((function(e){
            var t=e.value;
        ...
        ], e.prototype, "updatedAt", void 0), p([
          (0, n.v)(), (0, u.Z)((function(){
            return b
          }))
        ], e.prototype, "auditor", void 0), p([
          (0, n.v)()
        ], e.prototype, "read", void 0), p([
          (0, n.v)({
            name:"target_type"
          })
      ...
      (k), T=function(){
        ...
        ], e.prototype, "creditMode", void 0), p([
          (0, n.v)({
            name:"air_course_guides_enable"
          })
        ], e.prototype, "courseGuidesEnable", void 0), p([
          (0, n.v)({
            name:"air_kb_allowed_video_type"
          })
        ], e.prototype, "kbAllowedVideoType", void 0), p([
          (0, n.v)({
            name:"air_kb_max_size_of_upload_file"
          })
        ], e.prototype, "kbMaxSizeOfUploadFile", void 0), p([
          (0, n.v)({
            name:"air_max_length_of_text"
          })
        ], e.prototype, "maxLengthOfText", void 0), p([
          (0, n.v)({
      ...
      (), P=function(){
        ...
        return p([
          (0, s.n)()
        ], e.prototype, "type", void 0), p([
          (0, u.Z)((function(e){
            return e.newObject.type
          })), (0, n.v)()
        ], e.prototype, "items", void 0), p([
          (0, n.v)()
        ], e.prototype, "page", void 0), p([
          (0, n.v)({
            name:"page_size"
          })
        ], e.prototype, "pageSize", void 0), p([
          (0, n.v)()
        ], e.prototype, "pages", void 0), p([
          (0, n.v)()
        ], e.prototype, "total", void 0), p([
          (0, n.v)()
        ], e.prototype, "start", void 0), p([
          (0, n.v)()
      ...
      var d=r(966491);
      e.exports=[
        "$rootScope", "$scope", "$http", "statHelper", "modelHelper", "fileSelectModel", "toastr", "homeworkRepository", function(e, t, r, s, p, l, m, v){
          var f, h, g, y, b=c(t);
          t.courseId=o("#courseId").val(), t.ui={
            hasUnsavedChanges:!1
          }, t.trackActivityVisit=!1, t.multipleChoice={
            title:""
          }, t.canShowDocumentPreviewTip=(null===(f=window.featureToggles)||void 0===f?void 0:f.documentPreviewNotice)&&!(null!==(h=window.featureToggles)&&void 0!==h&&h.privateWpsOffice)&&!(null!==(g=window.featureToggles)&&void 0!==g&&g.wps_preview)&&!(null!==(y=window.featureToggles)&&void 0!==y&&y.aliyun_office), o(document).on("open.fndtn.reveal", "#submit-popup", (()=>{
            l.context.includeSlides=!0
            ...
            return l.limitTypes=[
            ], l.checkIsSelectable=e=>!e.is_folder
            ...
            var s=a(u.mark((function s(c){
              ...
              return u.wrap((function(s){
                ...
                ;
                  ...
                  case 0:if(l=f.length>1&&void 0!==f[
                    1
                  ]
                  &&f[
                    1
                  ...
                  case 4:return b.show(), v=function(){
                    var s=a(u.mark((function s(){
                      var v, f, h, g, y, w, C, G, A, T;
                      return u.wrap((function(s){
                        for(;
                        ;
                        )switch(s.prev=s.next){
                          case 0:f=n.copy(t.uploads), h=e=>"LARK"===e.source, g=i.uniq(i.map(t.uploads.filter((e=>!h(e))), "id")), y=i.filter(t.uploads, h), w=i.map(t.slides, "id"), C=(null!==(v=t.submission.comment)&&void 0!==v?v:"").trim(), G=d.parseUploadsFromRichText(C, "img", "image"), "multiple"===(A={
                            comment:C, uploads:g, slides:w, is_draft:l, mode:t.homework.data.mode||"normal", other_resources:y, uploads_in_rich_text:G
                            ...
                            var r=a(u.mark((function r(i){
                              return u.wrap((function(r){
                                ...
                                ;
                                  ...
                                  case 0:return o("#no-upload-popup").foundation("reveal", "close"), l?(_(), Array.isArray(t.homework.draft_submission_list)&&t.homework.draft_submission_list.unshift({
                                    id:i.submission.id, comment:C, uploads:f
                                  }), k()):(_(), t.homework.submission?n.copy(i.submission, t.homework.submission):t.homework.submission=i.submission, e.$emit("$refreshPrerequisitesStatus"), e.$emit("homeworkSubmitted", t.homework), t.homework.is_announce_score_time_passed=i.is_announce_score_time_passed, t.homework.student=i.student, t.homework.student.belongTo=p.getBelongTo(i.student), t.homework.make_up_record&&(t.homework.make_up_record.has_submitted=!0), (null!=t.submission?t.submission.draft_id:void 0)&&delete t.submission.draft_id, window.statistics.track({
                                    ...
                                    id:t.homework.id, has_draft:l
                                  }), i.message&&m.success(i.message), r.abrupt("return", S());
                          ...
                          ()).error((function(e){
                            if(b.hide(), t.errors=e.errors, !e.errors||!e.errors.multiple_choice_title)return o("#submit-popup").foundation("reveal", "close"), e.message?m.error(e.message):void 0;
          ...
          (), t.isUploads=function(){
            ...
            t.ui.hasUnsavedChanges&&!window.confirm(t.unsavedMsg||"You haven't submitted the assignment. Are you sure you want to leave?")||(t.reset(), o("#submit-popup").foundation("reveal", "close"), S())
          };
          var S=function(){
          ...
          t.$watch((()=>{
            ...
            var r;
            null!==(r=t.submission)&&void 0!==r&&r.comment||!e||C()
          })), t.showHomeworkContent=!1, t.toggleHomeworkContent=function(){
            t.showHomeworkContent=!t.showHomeworkContent
          };
          var k=function(){
            return t.submission={
            }, t.uploads=[
            ], t.slides=[
            ], t.is_draft=!1, e.activityType="homework", t.homework.draft_submission_list?C():t.initDraftSubmissionList().then(C), t.ui.hasUnsavedChanges=!1
          };
      ...
      r.r(t), r.d(t, {
        useAngularScope:()=>i, useAngularService:()=>n
      });
      ...
      e.exports=[
        "$rootScope", "$scope", "$q", "activityRepository", "revealModalParams", "modelHelper", "$timeout", "examListRepository", function(e, t, r, i, u, p, l, m){
          t.canShowOperations=e=>s(e), t.canEditActivitySelf=e=>a(e), t.editExam=function(r){
            var o, n;
            return"module"===r.referrer_type&&(o=r.referrer_id), "syllabus"===r.referrer_type&&(n=r.referrer_id), p.editActivity(e, t, t.course, o, n, l, r)
            ...
            }, t.confirm=()=>m.deleteExam(e.id).then((function(){
              if(o(r).foundation("reveal", "close"), d.remove(t.exams, {
                id:examId
              }), t.isCourseInCheckpointMode)return p.deleteActivityFromCourse(t.course, e), p.refreshPrerequisitesForAllDependantActivities(t.course, e), p.updateCriterionInfoForActivities(scope.course, t.exams)
            })), o(r).foundation("reveal", "open"), null
          }, t.$on("examUpdated", ((e, t)=>g(t))), e.$on("prerequisitesUpdated", ((e, r)=>p.refreshPrerequisitesForCurrentActivity(r, t.exams, t.course)));
          var v=function(e){
            if(t.isCourseInCheckpointMode&&(t._course=i._course, i.initActivitiesForActivityList(t._course), i.initExamsForActivityList(t._course), e))return d.each(t.course.modules, (function(t){
              return p.removeOldActivity(t, e), p.addNewActivity(e, t)
            })), c(t, i, e, p, t.exams).refreshPrerequisitesAfterActivityEdit()
          }, f=e=>d.map(e, (function(e){
          ...
          })), h=e=>d.filter(e, (e=>e.is_assigned_to_all||d.includes(e.assign_group_ids, t.group.id))), g=function(){
            var e=arguments.length>0&&void 0!==arguments[
              0
            ]
            ?arguments[
            ...
            return r.all([
              ...
              return f(u), t.course=i, t.exams=h(u), v(e)
            }))
          };
          return g()
        }
      ...
      e.exports=[
        "$rootScope", "$scope", "$route", "$routeParams", "$location", "groupRepository", "toastr", "filter", function(e, t, r, u, s, a, c, d){
          ...
          var p=u.groupId, l=function(){
            t.groups=o.copy(a.groups);
            var e=n.find(t.groups, {
              id:parseInt(p)
            });
            return p&&o.isUndefined(e)?s.path("/"):(m(e), v())
          }, m=function(e){
            return p?(t.currentGroup=o.copy(e), e.active=!0, t.ui.addGroup=!1):(t.currentGroup={
              id:0, name:"", members:[
              ], leaders:[
              ], active:!0
          ...
          t.changePage=e=>t.pagination.changePageAtFrontEnd(e, t.filteredStudents, f);
          ...
          return t.search=()=>g(), t.addToCurrentGroup=function(e){
            return e.group_id=t.currentGroup.id, t.ungroupedStudents.splice(n.findIndex(t.ungroupedStudents, {
              id:e.id
            }), 1), t.groupedStudents.push(e), t.currentGroup.members.push(e.id), g()
          }, t.removeFromCurrentGroup=function(e){
            return e.isLeader&&h(e), e.group_id=null, t.groupedStudents.splice(n.findIndex(t.groupedStudents, {
              id:e.id
            }), 1), t.currentGroup.members.splice(n.indexOf(t.currentGroup.members, e.id), 1), t.ungroupedStudents.push(e), g()
          }, t.save=function(){
            t.loading=!0;
            ...
            return e.id?a.updateGroup(e, (function(e){
              ...
              })), s.path("/".concat(o.id, "/edit"), !1), p=o.id, r(), l()
            }), i)
          }, a.init().then(l)
        }
      ]
      ...
      e.exports=[
        "$scope", "$rootScope", "api", "Upload", "DataImportHelper", "toastr", "$timeout", "$http", function(e, t, r, u, s, a, c, d){
          ...
          e.humanizeBytes=n.humanizeBytes, e.init=function(){
            var r=t.importType;
            return l.importType=r, l.data.record_type={
            ...
            }, "courseGroup"===r&&(l.data.group_set_id=t.groupSetId), m=new s(l.errorPriority), e.ui=m.ui
          };
          var v={
          };
          e.goStepFirst=function(){
            if(2===e.ui.wizardStep)return delete v.access_key, delete e.failedRecords, m.goStepFirst(), e.deleteUploaded(e.ui)
          }, e.doStepSecond=function(){
            [
              "rollcall"
            ].includes(l.importType)&&(l.data.course_id=t.courseId, l.data.lesson_timetable_id=t.lessonTimetableId);
            return p.show(), u.upload({
              url:"/api/data-import/validation", file:e.getUploaded()[
                0
              ], method:"POST", data:l.data
            }).then((function(t){
              var r=o.filter(t.data.records, "errors");
              e.failedRecords=r, e.passedRecords=t.data.passed_records;
              var n=t.data.record_number;
              return m.updateRecordsPickedError(e.failedRecords), v.access_key=t.data.access_key, p.hide(), m.updateSecondStepData(e.failedRecords), e.correctRecordNumber=n-r.length, e.ui.stepThirdEnable=e.ui.importConfirmed&&e.correctRecordNumber>0
            }), (function(e){
              return a.error(e.data.message), p.hide()
            }))
          };
          return e.doStepThird=function(){
            ...
            [
              "enrollment", "rollcall"
            ].includes(l.importType)&&(o.courseId=t.courseId, "rollcall"==l.importType&&(o.lesson_timetable_id=t.lessonTimetableId)), "courseGroup"===l.importType&&(o.groupSetId=t.groupSetId);
            var n, i;
            return r[
              (n=l.importType, i=n.split(""), i[
                0
              ]
              =i[
                0
            ...
            (o, (t=>{
              var r=t.job_id, o=()=>((e, t, r)=>d.get("/api/jobs/".concat(e, "/status")).success(t).error(a.decorateError(r)))(r, n), n=t=>{
                if("finished"===t.status){
                  ...
                  return function(t){
                    var r="".concat(l.importType, "s"), o="".concat(l.importType, "s_failed");
                    return e.importedRecords=t[
                      r
                    ], e.failedRecords=t[
                      o
                    ], m.updateRecordsPickedError(e.failedRecords), p.hide(), e.ui.wizardStep=3
                  }
                  (t.result)
                }
                return"failed"===t.status?(p.hide(), e.importFailed=!0, a.error(e.errorText.importFailed)):c(o, 5e3)
              };
              return c(o, 5e3)
            }))
            ...
            var o="";
            if("school"===r){
              if("rollcall"===l.importType)return e.enableMentalHealthLeave?"/static/data_import_templates/school-rollcall-mental-health-".concat(t, ".xls"):"/static/data_import_templates/".concat(r, "-rollcall-").concat(t, ".xls");
              if("curriculumEnrollment"===l.importType)return"/static/data_import_templates/changeScheduledTraining-".concat(t, ".xls");
              if("editOnlineStudent"===l.importType)return"/static/data_import_templates/".concat(r, "-online-student-").concat(t, ".xls");
              "user"===l.importType&&e.isAllowEmptyEmail&&"zh-cn"===t&&(o+="-allow-empty-email"), [
                "course", "editCourse"
              ].includes(l.importType)&&(e.allowCourseCurriculum&&(o+="-program"), e.isCourseNeedPublish&&(o+="-with-publish"), e.isTrialCourseOpen&&(o+="-trial"), e.isDistanceCourseOpen&&(o+="-distance")), [
                "user", "course"
              ].includes(l.importType)&&(e.isDepartmentRequired||e.enableCreateCourseWithDepartmentRequired)&&(o+="-department-required"), [
                "course"
              ].includes(l.importType)&&e.isAcademicAndSemesterRequired&&(o+="-academic_year-semester-required"), "coursesEnrollment"===l.importType&&e.isSeatNumberRequired&&(o="-seat-number-required"), [
                "editUser", "user"
              ].includes(l.importType)&&e.isStudentEducationRequired&&(o+="-allow-student-education")
            }
            return"/static/data_import_templates/".concat(r, "-").concat(l.importType, "s").concat(o, "-").concat(t, ".xls")
          }
        }
      ]
    }, 667164:(e, t, r)=>{
      ...
      r(43148), r(640173), r(850785), r(868329), r(658379);
      var i=r(374302).checkUserLarkAuth, u=r(302543), s=r(966491);
      e.exports=[
        "commonApi", "resourceGroupApi", "config", "toastr", "$http", (e, t, r, n, a)=>{
          var c=e=>{
          ...
          }, d=e=>(e.isThirdPartResource="third_part_resource"===l.tab, e.isChinamcloudResource="chinamcloud_resource"===l.tab, e.selectable=!u.isFunction(l.checkIsSelectable)||l.checkIsSelectable(e), "lark"===l.tab?(e.allow_download=!1, e.allow_forward_seeking=!1, e.origin_allow_download=!1, e.source="LARK", e.status="ready", e.selected=!!u.find(l.selectedUploads, {
            token:e.token, source:"LARK"
          }), void(e.deleted=!1)):"wedrive"===l.tab?(e.allow_download=!0, e.allow_forward_seeking=!1, e.origin_allow_download=!0, e.source="WEDRIVE", e.status="ready", e.selected=!!u.find(l.selectedUploads, {
            fileid:e.fileid, source:"WEDRIVE"
          }), e.selectable=1!==e.file_type, void(e.deleted=!1)):"chinamcloud_resource"===l.tab?(e.allow_download=!1, e.allow_forward_seeking=!1, e.origin_allow_download=!0, e.source="CHINAMCLOUD", e.deleted=!1, e.is_folder="folder"===e.type, e.status="processing", e.selectable="folder"!==e.type, e.selected=!!u.find(l.selectedUploads, {
            id:e.id, isChinamcloudResource:e.isChinamcloudResource
          }), void(l.mode="list")):"academic_learning_platform"===l.tab?(e.allow_download=!1, e.allow_forward_seeking=!1, e.origin_allow_download=!0, e.source="SHTVU", e.status="ready", void(e.deleted=!1)):("public_resource"!==l.tab&&(e.type=c(e), e.selected=!!u.find(l.selectedUploads, {
            id:e.id, isThirdPartResource:e.isThirdPartResource
          })), void(u.includes([
            "repository", "public_resource", "group_resource", "vtrs_resource"
          ], l.tab)&&(l.selectedIds&&(e.selected=l.selectedIds.includes(e.id)&&!e.is_folder, e.selected&&l.selectedUploads.push(e)), l.disabledIds&&(e.selectable=!l.disabledIds.includes(e.id)), e.is_folder&&!l.allowSelectFolder&&(e.selectable=!1), "vtrs_resource"===l.tab&&(e.id=e.upload_id), e.origin_allow_download=e.allow_download)))), p=()=>"knowledge_graph"===l.usePublicResourceScope?"/api/knowledge-nodes/".concat(l.nodeId, "/reference-resource"):"/api/public-resources", l={
            onlyReady:!1, showPublicResource:!0, showLarkSpace:!0, showAcademicLearningPlatformTab:!1, showVirtualClassroomTab:!1, showMaterialTab:!1, activity:null, allowSelectFolder:!1, tab:"repository", fileType:"all", mode:"thumbnail", keyword:"", nodeId:0, selectedIds:[
              ...
              l.usePublicResourceScope=e
            }, resetPagination(){
              l.pagination={
                currentList:[
                ], currentPage:1, totalPage:1, inputPage:1
              }
            }, changeFileType:(e, t)=>(l.resetPagination(), l.fileType=e, l.path=[
            ], l.changePage(1, t)), changeVtrs:(e, t)=>(l.resetPagination(), l.vtrsId=void 0!==e?e:null, l.path=[
            ], l.changePage(1, t)), getDefaultFileType:()=>1===l.limitTypes.length?l.limitTypes[
              0
            ]
            :"all", changePath:(e, t)=>(l.path.push(e), l.changePage(1, t)), addUploads:e=>r.load().then((()=>{
              return t=[
              ], e.forEach((e=>{
                "academic_learning_platform"!==l.tab&&(e.type=c(e)), t.push(l.pagination.currentList.unshift(e))
              })), t;
              var t
            })), removeUpload:e=>u.remove(l.pagination.currentList, {
              id:e.id
            }), cleanCreateFailed:()=>u.remove(l.pagination.currentList, {
              createFailed:!0
            }), search:e=>(l.searching=l.keyword.trim().length>0, l.changePage(1, e)), changePage:(o, s, c, m)=>function(o, s){
              ...
              :10, m=arguments.length>3&&void 0!==arguments[
                3
              ]
              ?arguments[
                3
              ]
              :"created_at", v=!(arguments.length>4&&void 0!==arguments[
                4
              ])||arguments[
                4
              ], f=e=>{
              ...
              }, y=l.searching?l.keyword:"", b={
                keyword:y, includeSlides:l.context.includeSlides, includeSubjectLibs:l.context.includeSubjectLibs, includeVideoQuizzes:l.context.includeVideoQuizzes, includeLessonResources:l.context.includeLessonResources, limitTypes:l.limitTypes, fileType:l.fileType, fileExts:l.fileExts, parentId:l.path.length>0?l.path[
                  l.path.length-1
                ].id:0, folderToken:l.path.length>0?l.path.at(-1).token:"", resourceType:l.path.length>0?l.path[
                  l.path.length-1
                ].resource_type:null, filters:l.filters, linkTypes:l.linkTypes, only_ready:l.onlyReady, sortPredicate:m, reverse:v
              };
              if(l.limitTypes.includes("courseware")&&(b.fileExts=[
                "zip"
              ]), [
                "repository", "material"
              ].includes(l.tab))return e.getUserResources(s, c, b, f, h);
              if("vtrs_resource"===l.tab)return""!==l.vtrsId&&(b.vtrs_id=l.vtrsId), e.getVtrsesShareResources(s, c, b, f, h);
              if("third_part_resource"===l.tab)return e.getThirdPartUserResources(s, c, b, f, h);
              if("lark"===l.tab)return g(), e.getResourceFromLark(s, c, b.folderToken, f, h);
              if("wedrive"===l.tab){
                var _="/api/wedrive/files?page=".concat(s, "&page_size=").concat(c);
                l.path.length>0&&(_="/api/wedrive/files?page=".concat(s, "&page_size=").concat(c, "&file_id=").concat(l.path.at(-1).fileid)), a.get(_).success(f).error(h)
              }
              if("other_video_resources"===l.tab)return e.getOtherVideoResources(s, c, f, h);
              if("academic_learning_platform"===l.tab)return e.getAcademicLearningPlatformResources(s, c, y, l.courseCode, l.filterFileTypes, f, h);
              if("group_resource"===l.tab){
                var S, w, C=[
                ], k=[
                ], G={
                  keyword:y, parent_id:l.path.length>0?l.path[
                    l.path.length-1
                  ].resource_id:0, group_folder_id:l.path.length>0?l.path[
                    l.path.length-1
                  ].group_folder_id:0, file_type:l.fileType, limit_types:l.limitTypes, sort_predicate:"created_at", reverse:!0
                };
                l.path.length>0&&!l.path[
                  l.path.length-1
                ].parent_id&&(G.parent_folder_id=l.path.length>1?l.path[
                  l.path.length-2
                ].id:0, G.is_group_folder=l.path.length>0&&l.path[
                  l.path.length-1
                ].is_folder);
                var A=e=>(e.resources.map((e=>{
                  var t=e.upload;
                ...
                })), w=C.length>0&&S===s?C.length>=c?C:C.concat(k):k, l.pagination={
                  currentList:w, currentPage:e.page, totalPage:e.pages, inputPage:e.page
                }, o()), T=e=>{
                  S=e.page, C=e.folders, u.each(C, (e=>{
                    e.is_folder=!0, e.selectable=!1, e.group_name=e.resource_group.name, e.group_folder_id=e.id
                  })), t.getAllPagedResourceGroupResources(s, c, G, A)
                };
                "all"===l.fileType?t.getAllPagedResourceGroupFolders(s, c, G, T):t.getAllPagedResourceGroupResources(s, c, G, A)
              }
              if("public_resource"===l.tab){
                var P, O=p();
                a.get(O, {
                  params:{
                    page:s, page_size:c, keyword:y, limit_types:l.limitTypes, parent_id:null===(P=l.path.at(-1))||void 0===P?void 0:P.resource_reference_id, file_type:l.fileType
                  }
                }).success(f).error(h)
              }
              if("chinamcloud_resource"===l.tab&&!l.context.lesson_resource_only&&![
                "courseware", "scorm"
              ].includes(l.fileType)){
                var x, I=l.limitTypes.filter((e=>![
                  "folder", "video-quiz"
                ].includes(e)));
                l.fileType=0===I.length||I.includes(l.fileType)?l.fileType:I[
                  0
                ];
                var U="/api/chinamcloud/resources";
                a.get(U, {
                  params:{
                    page:s, page_size:c, keyword:y, parent_id:null===(x=l.path.at(-1))||void 0===x?void 0:x.resource_id, file_type:l.fileType
                  }
                }).success(f).error(h)
              }
              return"virtual_classroom"===l.tab?e.getVirtualClassroomResources(s, c, y, l.fileType, f, h):void 0
            }
            (s, o, void 0, c, m), getSelectedUploads:()=>l.singleSelect?l.singleSelectedUpload?[
              l.singleSelectedUpload
            ]
            :[
            ]
            :u.filter(l.selectedUploads, {
              selectable:!0
            }), copySelectedThirdPartResources(t, r){
              if(0!==r.length)return((t, r)=>e.copyThirdPartResources(u.filter(t, {
              ...
              if(0!==r.length)return((t, r)=>e.updateChinamcloudResources(u.filter(t, {
              ...
              var e, t=o(l.pagination.currentList);
              try{
                for(t.s();
                !(e=t.n()).done;
                ){
              ...
              return l.selectedUploads=[
              ], l.singleSelectedUpload=void 0
            }, getSupportFormatString(e){
              if(l.fileExts&&l.fileExts.length)return".".concat(l.fileExts.join(",."));
              var t, r=[
              ], n=o(e);
              try{
                for(n.s();
            ...
            }, getSupportFormatMsg:e=>l.getSupportFormatString(e).replace(/\./g, ""), getSupportFormatMsgWithSpaces:e=>l.getSupportFormatString(e).replace(/\./g, " ").replace(/^[
              \s
            ]
            +/, ""), verifyPageIndexInput(){
              if(l.pagination.inputPage){
                var e=String(l.pagination.inputPage).replace(/\./, "");
                return l.pagination.inputPage=isNaN(e)||e<1||e>l.pagination.totalPage?l.pagination.currentPage:parseInt(e, 10)
              }
            }
          };
          return r.load().then((()=>{
            l.supportFormat.video=r.SUPPORTED_VIDEO_FORMATS, l.supportFormat.audio=r.SUPPORTED_AUDIO_FORMATS, l.supportFormat.document=r.SUPPORTED_DOCUMENT_FORMATS, l.supportFormat.image=r.SUPPORTED_IMAGE_FORMATS, l.supportFormat.scorm="zip", l.supportFormat.evercam="zip", l.supportFormat.courseware="zip", l.supportFormat.swf=r.SUPPORTED_FLASH_FORMATS, l.supportFormat[
              "open-office"
            ]
      ...
      r.d(t, {
        $3:()=>h, BA:()=>a, C8:()=>d, D_:()=>P, F:()=>u, Gv:()=>m, Hr:()=>j, Jt:()=>s, Jv:()=>O, OC:()=>i, Q0:()=>I, R3:()=>z, TG:()=>F, TO:()=>N, Uo:()=>n, ZC:()=>B, d6:()=>p, hZ:()=>M, he:()=>T, k3:()=>U, lQ:()=>f, oc:()=>c, rN:()=>L, rd:()=>$, uO:()=>E, un:()=>g, vE:()=>v, wZ:()=>C
      });
      var o=r(112189);
      function n(e){
        return!!(0, o.o5)()&&((0, o.jr)(e), !0)
      }
      function i(){
        const e=new Set, t=t=>{
          e.delete(t)
      ...
      function u(e){
        let t, r, i=0;
        const u=()=>{
          i-=1, r&&i<=0&&(r.stop(), t=void 0, r=void 0)
        };
        return(...s)=>(i+=1, r||(r=(0, o.uY)(!0), t=r.run((()=>e(...s)))), n(u), t)
      }
      function s(e, t){
        return null==t?(0, o.R1)(e):(0, o.R1)(e)[
          t
        ]
      }
      function a(e){
        return"function"==typeof e?e():(0, o.R1)(e)
      }
      o.Sg, o.Sg, o.Sg;
      const c="undefined"!=typeof window&&"undefined"!=typeof document, d=("undefined"!=typeof WorkerGlobalScope&&(globalThis, WorkerGlobalScope), e=>void 0!==e), p=e=>null!=e, l=Object.prototype.toString, m=e=>"[object Object]"===l.call(e), v=()=>+Date.now(), f=()=>{
      }, h=(e, t)=>Object.prototype.hasOwnProperty.call(e, t), g=y();
      function y(){
        var e, t;
      ...
      function S(e, t={
        ...
        let r, o, n=f;
        const i=e=>{
          clearTimeout(e), n(), n=f
        };
        return u=>{
          const s=a(e), c=a(t.maxWait);
          return r&&i(r), s<=0||void 0!==c&&c<=0?(o&&(i(o), o=null), Promise.resolve(u())):new Promise(((e, a)=>{
            n=t.rejectOnCancel?a:e, c&&!o&&(o=setTimeout((()=>{
              r&&i(r), o=null, e(u())
            }), c)), r=setTimeout((()=>{
              o&&i(o), o=null, e(u())
            }), s)
      ...
      function w(...e){
        ...
        =e:({
          delay:n, trailing:i=!0, leading:u=!0, rejectOnCancel:s=!1
        }
        =e[
          0
        ]);
        const l=()=>{
          t&&(clearTimeout(t), t=void 0, p(), p=f)
        };
        return e=>{
          const o=a(n), m=Date.now()-c, v=()=>r=e();
          return l(), o<=0?(c=Date.now(), v()):(m>o&&(u||!d)?(c=Date.now(), v()):i&&(r=new Promise(((e, r)=>{
            p=s?r:e, t=setTimeout((()=>{
              c=Date.now(), d=!0, e(v()), l()
            }), Math.max(0, o-m))
          }))), u||t||(t=setTimeout((()=>d=!0), o)), d=!1, r)
        }
      }
      function C(e=_){
        const t=(0, o.KR)(!0);
        return{
          isActive:(0, o.tB)(t), pause:function(){
            t.value=!1
          }, resume:function(){
            t.value=!0
          }, eventFilter:(...r)=>{
      ...
      const G=/\B([
        A-Z
      ])/g, A=(k((e=>e.replace(G, "-$1").toLowerCase())), /-(\w)/g);
      k((e=>e.replace(A, ((e, t)=>t?t.toUpperCase():""))));
      function T(e, t=!1, r="Timeout"){
        return new Promise(((o, n)=>{
          t?setTimeout((()=>n(r)), e):setTimeout(o, e)
        }))
      }
      function P(e){
        return e
      ...
      function I(e, t=200, r={
      }){
        return b(S(t, r), e)
      }
      function U(e, t=200, r=!1, o=!0, n=!1){
        return b(w(t, r, o, n), e)
      }
      function M(...e){
        if(2===e.length){
          const[
        ...
        if(3===e.length)if(o.LE)(0, o.hZ)(...e);
        else{
          const[
            t, r, o
          ]
      ...
      function j(e, t, r={
        ...
        =r, {
          eventFilter:i, pause:u, resume:s, isActive:a
        }
        =C(o);
        return{
          stop:R(e, t, {
            ...n, eventFilter:i
          }), pause:u, resume:s, isActive:a
        }
      }
      function $(e, t=!0, r){
        x()?(0, o.sV)(e, r):t?e():(0, o.dY)(e)
      }
      function E(e, t){
        x(t)&&(0, o.hi)(e, t)
      }
      function D(e, t=!1){
        function r(r, {
          flush:n="sync", deep:i=!1, timeout:u, throwOnTimeout:s
        }
        ={
        }){
          let c=null;
          const d=[
            new Promise((u=>{
              c=(0, o.wB)(e, (e=>{
                r(e)!==t&&(c?c():(0, o.dY)((()=>null==c?void 0:c())), u(e))
              }), {
                flush:n, deep:i, immediate:!0
              })
            }))
          ];
          return null!=u&&d.push(T(u, s).then((()=>a(e))).finally((()=>null==c?void 0:c()))), Promise.race(d)
        }
        function n(n, i){
          if(!(0, o.i9)(n))return r((e=>e===n), i);
          const{
            flush:u="sync", deep:s=!1, timeout:c, throwOnTimeout:d
          }
          =null!=i?i:{
          };
          let p=null;
          const l=[
            new Promise((r=>{
              p=(0, o.wB)([
                ...
                t!==(e===n)&&(p?p():(0, o.dY)((()=>null==p?void 0:p())), r(e))
              }), {
                flush:u, deep:s, immediate:!0
              })
            }))
          ];
          return null!=c&&l.push(T(c, d).then((()=>a(e))).finally((()=>(null==p||p(), a(e))))), Promise.race(l)
        }
        function i(e){
          return u(1, e)
        }
        ...
        if(Array.isArray(a(e))){
          return{
            toMatch:r, toContains:function(e, t){
              return r((t=>{
                const r=Array.from(t);
                return r.includes(e)||r.includes(a(e))
              }), t)
            }, changed:i, changedTimes:u, get not(){
              return D(e, !t)
            }
          }
        }
        return{
          toMatch:r, toBe:n, toBeTruthy:function(e){
            return r((e=>Boolean(e)), e)
          }, toBeNull:function(e){
            return n(null, e)
          }, toBeNaN:function(e){
      ...
      function N(e, t, r={
        ...
        function l(...r){
          d(), u.value=!0, s=setTimeout((()=>{
            u.value=!1, s=null, e(...r)
          }), a(t))
        }
        return i&&(u.value=!0, c&&l()), n(p), {
          isPending:(0, o.tB)(u), start:l, stop:p
        }
      }
      function L(e, t, r={
      }){
        const{
          debounce:o=0, maxWait:n, ...i
        }
        =r;
        return R(e, t, {
          ...i, eventFilter:S(o, {
      ...
      function z(e, t, r={
        ...
        if("sync"===i.flush){
          ...
          a=()=>{
            ...
            const t=r.value>0&&r.value===n.value;
            r.value=0, n.value=0, t||u(...e)
          }), i)), c=()=>{
            t.forEach((e=>e()))
          }
        }
        return{
          stop:c, ignoreUpdates:s, ignorePrevAsyncUpdates:a
        }
      }
      function B(e, t, r){
        const n=(0, o.wB)(e, ((...e)=>((0, o.dY)((()=>n())), t(...e))), r);
        return n
      }
    }, 726330:(e, t, r)=>{
      var o=r(302543);
      ...
      e.exports={
        GroupSet:d, Group:c, GroupUser:a, groupFactory:p, groupSetFactory:function(e, t){
          var r=arguments.length>2&&void 0!==arguments[
            2
          ]
          &&arguments[
          ...
          if(e.name=t.name, t.groups){
            ...
            try{
              for(a.s();
              !(s=a.n()).done;
              )u=s.value, (i=e.getGroup(u))?l(i, u):e.addGroup(p(u, r), !1)
            }
            catch(e){
              a.e(e)
            }
      ...
      r(169218), r(302543), r(638147);
      var o=r(595738), n=function(){
      ...
      var i=function(){
        var e, t=null===(e=(0, o.nI)())||void 0===e?void 0:e.proxy, r=(0, o.Kh)({
      ...
      var o=r(738645), n=r(510543), i=r(152229), u=r(731904), s=function(e, t, r, o){
        var n, i=arguments.length, u=i<3?t:null===o?o=Object.getOwnPropertyDescriptor(t, r):o;
        if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)u=Reflect.decorate(e, t, r, o);
        else for(var s=e.length-1;
        s>=0;
        ...
        return s([
          ...
          (0, o.v)(), (0, n.d)((function(e){
            var t=e.value;
            return u.TimeUtils.millisecondToHms(t)
          }), {
            toClassOnly:!0
          })
      ...
      const n=function(){
        ...
        return e.success=function(e, t, r){
          void 0===t&&(t=3), void 0===r&&(r=24), this.resetMessage({
            type:"success", content:e, duration:t, top:r
          })
        }, e.warning=function(e, t, r){
          void 0===t&&(t=3), void 0===r&&(r=24), this.resetMessage({
            type:"warning", content:e, duration:t, top:r
          })
        }, e.error=function(e, t, r){
          void 0===t&&(t=3), void 0===r&&(r=24), this.resetMessage({
            type:"error", content:e, duration:t, top:r
          })
        }, e.resetMessage=function(e){
          var t=this, r=e.content, n=e.duration, i=e.top, u=e.type, s=this.messageList.findIndex((function(t){
            return t.type===u&&t.content===e.content
          }));
      ...
      r.d(t, {
        H7:()=>v, M8:()=>m, V:()=>b, Zf:()=>c, eb:()=>l, u1:()=>p, wp:()=>d
      });
      r(169218), r(43148), r(658379);
      var o=r(966491), n=r(302543), i=r.n(n), u=function(){
        ...
        return function e(r){
          i().forEach(r, (function(r){
            "string"!=typeof r?(i().isObject(r)||i().isArray(r))&&e(r):t=r
          }))
        }
        (e), t
      }, l=function(e){
        ...
        t.innerHTML=e;
        var r=t.querySelectorAll(".__blank__"), o=[
        ];
      ...
      function b(e, t){
        ...
        switch(e){
          case"document":return r(f);
          case"image":return r(h);
          case"audio":return r(g);
          case"video":return r(y);
          case"custom":default:return t?r(t):""
        }
      }
    }, 896663:(e, t, r)=>{
