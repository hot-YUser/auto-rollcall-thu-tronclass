  ...
  [
    ...
    1135:(e, t, r)=>{
        ...
        "$http", "toastr", "commonApi", function(e, t, r){
          return{
            course:r.course, createSyllabus(r, n){
              ...
              :o.noop, a="/api/syllabus/".concat(r.id);
              return r.deleteRelatedActivity&&(a+="?delete_related_activity=true"), e.delete(a).success(n).error(t.decorateError(i))
              ...
              :o.noop;
              return e.post("/api/rollcall/".concat(r, "/start-rollcall"), n).success(i).error(t.decorateError(a))
            }, getRollcalls(r, n){
              var i=arguments.length>2&&void 0!==arguments[
                2
              ]
      ...
      r(418665), r(43148), r(658379), r(14602), e.exports=[
        "$scope", "$q", "modelHelper", "publishHelper", "$window", function(e, t, r, i, a){
      ...
      var o=r(302543), n=r(756029), i=r(287092), a=r(248124);
      function s(e, t){
        var r=Object.keys(e);
        if(Object.getOwnPropertySymbols){
          var o=Object.getOwnPropertySymbols(e);
        ...
        "$rootScope", "api", "activityRepository", function(e, t, r){
          var u={
            course:{
              ...
              var i=o.maxBy(this.course.modules, "sort"), a=0;
              i&&(a=i.sort+1);
              var s=l(e);
              return s.sort=a, t.addModule(this.course.id, s, (t=>{
              ...
              if(void 0===r||e!==r){
                ...
                return t.updateModuleSort(this.course.id, f, (()=>(this.course.modules=v.modules, a())), (()=>(this.course.modules=u, s())))
              }
            }, exchangeSyllabus(e, r, o){
              t.updateSyllabusSort(e, r, o)
            }, changeSortableState(e, t){
              var r, o="";
              if("module"===e&&(r=a(".module-sort")), "syllabus"===e&&(r=a(".course-syllabus-wrapper")), r)for(var n=0;
              n<r.length;
              n++){
                var i=r[
                  n
      ...
      e.exports=[
        "$rootScope", "$scope", "$http", "toastr", "pkgAPI", function(e, t, r, i, a){
          var s=n(t), c="before", u="processing", l="finished", d="failed", p=function(){
            t.coursePkg={
              status:c, name:""
          ...
          t.$on("coursePkg.create", (function(e, r){
            ...
            s.show(), t.coursePkg.status=u, a.createPackage(t.currentCourse.id, e, (function(e){
              s.hide(), t.coursePkg.status=l, o.merge(t.coursePkg, e.course_pkg)
            }), (function(e){
        ...
        "$http", "toastr", "commonApi", function(e, t, r){
          return{
            course:r.course, addModule:(r, o, n, i)=>e.post("/api/course/".concat(r, "/module"), o).success(n).error(t.decorateError(i)), deleteModule(r, o, n){
              ...
              return e.put("/api/course/".concat(r), a).success(n).error(t.decorateError(i))
      ...
      e.exports=[
        "$rootScope", "$scope", "activityRepository", "moduleRepository", "modelHelper", "$timeout", "toastr", "$window", "$http", "onlineVideoCompletenessRepository", function(e, t, r, a, u, l, h, g, b, _){
          t.userId=o("#userId").data("id"), t.completedInfo={
            ...
            a.disableContentSortable("syllabus"), a.disableContentSortable("module")
          }, t.afterSort=()=>{
            a.enableContentSortable("syllabus"), a.enableContentSortable("module")
          }, t.resortForModuleOrSyllabus=(e, o, n)=>{
            var i, a, s=(null===(i=t.module)||void 0===i?void 0:i.id)!==n.oldModule, c=(null===(a=t.syllabus)||void 0===a?void 0:a.id)!==n.oldSyllabus;
            return s?r.exchangeModuleOrSyllabus(e, o, n, t.module, t.syllabus):c?r.justExchangeInsiderModule(e, o, n, t.module, t.syllabus):void 0
            ...
            if(!n.deleted){
              ...
              return r.logActivityRead(e.id, {
                ...
                course_id:a, syllabus_id:e.syllabus_id
              }), st.track(e.type, i, {
          ...
          t.filterLearningActivity=e=>{
            ...
            try{
              ...
              !(o=i.n()).done;
                ...
                var a=o.value, s=n.find(a.directActivities, {
                  unique_key:r.unique_key
                });
                if(s)return void(s.prerequisites=r.prerequisites);
                var u, l=c(a.syllabuses);
                try{
                  for(l.s();
                  !(u=l.n()).done;
                  ){
                    var d=u.value;
                    if(s=n.find(d.activities, {
                      unique_key:r.unique_key
                    }))return void(s.prerequisites=r.prerequisites)
                  }
                }
                catch(e){
                  l.e(e)
          ...
          e.$on("refreshActivity", ((e, o)=>{
            ...
            if(o.isEditing&&r.removeActivityFromCourse(i.id, t.course), !n.find(t.course.activities, {
              ...
              var a=n.find(t.course.modules, {
                id:i.module_id
              });
              if(t.course.activities=t.course.activities||[
              ], t.course.activities.push(i), a){
                if(a.activities=a.activities||[
                ], a.activities.push(i), i.syllabus_id){
                  var s=n.find(a.syllabuses, {
                    id:i.syllabus_id
                  });
                  return s.activities=s.activities||[
                  ], s.activities.push(i), (e=>{
                    e.activities=n.sortBy(e.activities, [
                      "sort", "id"
                    ])
                  })(s)
                }
                return a.directActivities=a.directActivities||[
                ], a.directActivities.push(i), (e=>{
          ...
          (), x=function(){
            var e=s(i.mark((function e(t, r, o){
          ...
          e.$on("coursewareUpdated", (function(e, o){
            ...
            var r=s(i.mark((function r(n, a){
              var s, c, u, l;
              return i.wrap((function(r){
                for(;
                ;
                )switch(r.prev=r.next){
                  case 0:s=a.previewFile, c=a.openQuizPanel, u=a.uploadId, l=a.activityId, x(t, l, (t=>{
                    s&&(o("#file-previewer").foundation("reveal", "open"), e.$emit("previewFile", t.uploads.find((e=>e.id===u)), t)), c&&e.$emit("openAiQuizPanel")
                  }));
            ...
            if("exam_activity"===e.readType&&r){
              ...
              if(o&&"part"===r.completeness){
                ...
                if("score"!==e.completion_criterion_key){
                  var a=(null==o?void 0:o.completeness)||r.completeness;
                  return C(a, e), a
                }
      ...
      r(714913), r(158649);
      var o=r(184743), n="YYYY.MM.DD HH:mm:ss", i="Asia/ShangHai", a=function(){
        function e(){
        }
        return e.toLocalDateTime=function(e){
          ...
          var i=n.diff(r, "days"), a=n.diff(r, "hours")-24*i, s=n.diff(r, "minutes")-60*n.diff(r, "hours"), c="";
          return c+=i<=0?"":"".concat(i, "days"), c+=a<=0?"":"".concat(a, "hours"), i>0?c:c+="".concat(s<=0?1:s, "minutes")
          ...
          var r=e.split(":").map(Number), o=r[
            ...
            1
          ], i=t.split(":").map(Number), a=60*o+n, s=60*i[
            0
          ]
          +i[
            1
        ...
        var s={
          changePage(n, i, a, s){
            ...
            return i(n, e.pageSize||e.pageSizeOptions[
              ...
              (o.parseInt(n.page)), a(n), function(n){
                if(0!==n.length){
                  var i=t.path();
                  if(e.result[
                    r
                    ...
                    o.each(n, (function(e){
                      if(i.indexOf(e)>0)return t.path("/".concat(a).concat(e))
                    }))
                  }
            ...
            e.ui.searching=!0;
            return a.show(), s.changePage(t, r, (function(e){
              return o(e), a.hide()
            }), (function(){
              return n(), a.hide()
            }), i)
            ...
            =e;
              ...
              var a=Math.ceil(i/n);
              t>a&&(t=a);
              var s=n*(t-1), c=Math.min(n*t, i), u=e.slice(s, c);
              (o={
                start:s+1, end:c, total:i, pages:a, page:t, page_size:n
              })[
                r
              ]
              =u
            ...
            :"data";
            t||(t=1);
            var a=e.pageSize||e.pageSizeOptions[
              0
            ], c=s.buildPaginationResult(r, t, i, a);
      ...
      r.r(t), r.d(t, {
        LessonTime:()=>v, LessonTimeWeek:()=>f, getLessonTimes:()=>m
      });
      r(540590), r(195755), r(418665), r(379432), r(269193), r(14602);
      var o=r(272505), n=r.n(o), i=r(738645), a=r(152229), s=r(920453), c=r(552979), u=r(795093), l=function(e, t, r, o){
            ...
            return function(s){
              ...
              &&(a=0)), a;
                ...
                switch(o=0, n&&(s=[
                  ...
                  continue;
                  default:if(!(n=a.trys, (n=n.length>0&&n[
                    n.length-1
                  ])||6!==s[
                    0
                  ]
        ...
        return e.prototype.shortTitle=function(e){
          void 0===e&&(e="MM.DD");
          var t=this.data.day_of_week;
          t=0===t?7:t;
          var r=c.default.t("weekly.".concat(t)), o=u(this.startTime).format(e);
          return"".concat(r, " (").concat(o, ") ").concat(c.default.t("XSection", [
            this.slotSequences
          ]))
        }, Object.defineProperty(e.prototype, "modules", {
          get:function(){
            return window._lessonTimeModules[
              this.id
            ]
            ||[
            ]
          }, enumerable:!1, configurable:!0
        }), Object.defineProperty(e.prototype, "activities", {
          get:function(){
            return this.modules.flatMap((function(e){
              return e.activities
            }))
          }, enumerable:!1, configurable:!0
        }), l([
        ...
        ], e.prototype, "slotSequences", void 0), l([
          (0, i.v)({
            name:"end_time"
          })
      ...
      (), f=function(){
        ...
        return Object.defineProperty(e.prototype, "activities", {
          get:function(){
            return this.lessonTimes.flatMap((function(e){
              return e.activities
            }))
          }, enumerable:!1, configurable:!0
        }), l([
        ...
        ], e.prototype, "lessonTimes", void 0), e
      }
      (), m=function(e, t){
        return d(void 0, void 0, void 0, (function(){
          ...
          return p(this, (function(o){
            switch(o.label){
              case 0:return window._lessonTimeModules=t, [
                4, n().get("/api/course/".concat(e, "/lesson-times"))
              ];
              case 1:return r=o.sent().data, [
                2, (0, s.plainToClass)(f, r)
              ]
            }
          }))
        }))
      ...
      r(207452);
      var l=r(793110).default, d=r(181769), p=d.canEditActivity, v=d.hasEditPermissionForBlueprint, f=r(966491), m=r(181769).scoreRules, y=r(5782).default, h=r(674814).A;
      e.exports=[
        "$scope", "$rootScope", "$window", "$location", "$routeParams", "$timeout", "modelHelper", "$http", "toastr", "ExamHelper", "examRepository", "activityRepository", "$filter", "$compile", "publishHelper", "fileSelectModel", function(e, t, c, d, g, b, _, w, S, x, C, A, k, I, T, M){
          Promise.all([
            r.e(28492), r.e(24059), r.e(96674), r.e(64288)
            ...
            Promise.all([
              r.e(7612), r.e(15471), r.e(10035), r.e(26541)
            ...
            var r=u(i.mark((function r(o){
              ...
              return i.wrap((function(r){
                ...
                ;
                  ...
                  ], r.next=3, T.publishActivies(e.course.id, n, {
                    type:!o.published
                  }, !1);
                  case 3:o.published=!o.published, O(e.currentActivity, o), O(e.activity, o), O(e.exam, o), t.$emit("activity-publish-changed", {
                    type:o.published
                  });
          ...
          var P=function(){
            ...
            if(r)return e.examId=parseInt(r), t.limitedModify=!0, C.initExam(e.examId).then((function(o){
              if(e.exam=o, A.initPublishInfo(e, e.exam), E(o, Number(r))){
              ...
              var u;
              e.showExamEditNotice=!(null===(u=e.examUI)||void 0===u||!u.editSubjects||t.progressUi&&(!t.progressUi||t.progressUi.inPreview))&&(e.exam.isMakeupExam?e.exam.makeup_exam_start_notice:e.exam.is_started), D(), R(), e.selectRandomlyExam=!!e.examId&&e.exam.subjects_rule.select_subjects_randomly, e.$emit("activityLoaded", o), e.inMakeUpExam=E(e.exam, e.examId), t.limitedModify=e.exam.limited_modify
            }))
          }, $=(e, t)=>{
            ...
            var i=null===(r=e.exam.makeup_exam_paper)||void 0===r?void 0:r.id, a=null!==(o=null===(n=e.exam.make_up_record)||void 0===n?void 0:n.makeup_exam)&&void 0!==o?o:{
            };
            return!!i&&$(t, a)
          };
            ...
            var t=u(i.mark((function t(){
              ...
              return i.wrap((function(t){
                ...
                ;
                  ...
                  case 0:if(r=g.examId||o("#examId").val(), !E(e.exam, r)){
                    t.next=3;
                    break
                  }
                  return t.abrupt("return");
                  case 3:return t.next=5, C.initExamAllSubjects(r);
                  case 5:n=t.sent, e.showExamTips=$(n, e.exam), e.examSubjects=n, e.totalScore=n.reduce(((e, t)=>e.plus(new l(t.point))), new l(0));
          ...
          if(e.openBatchOperation=()=>{
            ...
            containerCssClass:"select2-user_no", dropdownCssClass:"select2-user_no-drop", formatResult(t){
              ...
              return I("<div class='result-wrapper'>".concat(n).concat("<span class='gap'></span>").concat(i, "</div>"))(e)
            }, formatSelection(e){
            ...
            var z=localStorage.getItem("otherDevicesAnsweringTime");
            t.otherDevicesAnsweringTime=f.formatDatetime(z), o("#active-on-other-devices-popup").foundation("reveal", "open"), localStorage.removeItem("otherDevicesAnsweringTime")
          }
      ...
      e.exports=[
        "$rootScope", "$scope", "$q", "activityRepository", "$timeout", "modelHelper", "revealModalParams", "$window", function(e, t, r, c, u, v, f, m){
            ...
            var e=l(a.mark((function e(){
              ...
              return a.wrap((function(e){
                ...
                ;
                  ...
                  case 5:return o.forEach((e=>t._course.loadingModule(e, !0))), e.next=8, c.getActivitiesByModuleIds(t.courseId, r, (a=void 0, a=[
                    "learning_activities", "exams", "classrooms"
                  ], t.enableLiveStreaming&&a.push("live_records"), t.allowInteractionInActivity&&a.push("interactions"), t.allowRollcallView&&a.push("rollcalls"), a.join(",")), !1);
          ...
          return t.activityOBERelated=v.activityOBERelated, m.addEventListener("refresh-all-items-sub-count", (e=>{
            ...
            var o, n, a, l, d, p;
            if(t.course=c.course, null!==(o=t.course.course_attributes)&&void 0!==o&&null!==(n=o.data)&&void 0!==n&&n.is_combining&&10!==t.course.course_type&&null!==(a=window.globalData)&&void 0!==a&&null!==(l=a.course)&&void 0!==l&&l.isInstructorView&&i.prototype.$Modal.info({
              ...
              t.enableLiveStreaming?v.push(c.initLiveRecordsForActivityList(t._course)):v.push(Promise.resolve([
                ...
                })), c.fillInClassInteractionsInModule(t._course, i), c.fillRollCallInModule(t._course, a), u((()=>e.ui.courseInitiated=!0))
              }))
            }
          }))
        }
      ...
      var o=r(302543), n=r(795093), i=r(248124), a=r(756029);
          ...
          var g=function(){
            return v.show(), d.createSyllabus(e.syllabus, (function(t){
              return e._course.addSyllabus(t), v.hide(), c((function(){
                ...
                var e=a.element(document.getElementById("syllabus-".concat(t.id)));
      ...
      var o=r(248124), n=r(756029), i=r(302543), a=r(962893).default;
      ...
      r(207452);
      var p=r(269634).createActivity, v=r(622571), f=v.syncItem, m=v.syncedInfo, y=r(272505).default, h=r(640241).filterFactory, g=r(111339).getLessonTimes;
      e.exports=[
        "$rootScope", "$scope", "$q", "syllabusApi", "modelHelper", "publishHelper", "$timeout", "$http", "moduleRepository", "toastr", "activityRepository", "activityService", function(e, t, c, d, v, b, _, w, S, x, C, A){
          var k=o("#courseId").val();
          ...
          }))), T=I.filterModule, M=I.filterSyllabus, O=I.filterActivity;
          t.viewMode=localStorage.getItem("course-view-mode:".concat(k))||"module", t.setViewMode=e=>{
            document.querySelector("html").scrollTop=0, t.viewMode=e, localStorage.setItem("course-view-mode:".concat(k), e)
          }, t.filterModule=T, t.filterSyllabus=M, t.filterActivity=O, t.publishActivitiesUnderModule=(e, r)=>{
            if(!e.__publishing){
              var o=[
                ...e.directActivities||[
                ], ...e.activities||[
              ...
              var n=o.filter(O).map((e=>"".concat(e.type, "-").concat(e.id)));
              n.length&&b.publishActivies(t.course.id, Array.from(new Set(n)), {
                type:!!r
              }).finally((()=>{
                e.__publishing=!1
              }))
            ...
            return t.hasDependents=!1, t.deleteType="syllabus", t.deleteModel=e, t.isCourseInCheckpointMode?d.getSyllabusHasDependents(e.id, $, j):j()
            ...
            if("module"===t.deleteType){
              return S.deleteModule(t.deleteModel, (()=>{
                t.confirmedOption.deleteRelatedActivity=!1
              }), (function(){
              }))
            }
            if("lesson-time"===t.deleteType){
              y.delete("/api/course/".concat(t.courseId, "/lesson-times"), {
                data:t.deleteModel
              }).then((()=>{
                t.confirmedOption.deleteRelatedActivity=!1, window.location.reload()
              }))
            }
          };
          var E=()=>{
          ...
          t.resortSyllabus=(e, r, o)=>{
            ...
            document.getElementsByClassName("module-container")[
              0
            ].style.height="".concat(t, "px"), "syllabus"===e&&S.disableContentSortable("module")
          }, t.collapseAll=()=>{
            ...
            document.getElementsByClassName("module-container")[
              0
            ].style.height="", S.enableContentSortable("module"), o(".learning-activity, .module-activities").each(((e, t)=>{
              t.classList.remove("hidden-when-drag")
            }))
          }, t.hasFilteredResult=function(){
            return i.some(t.course.modules, T)
          ...
          }, z=()=>x.error(t.createFailed);
          t.createModule=function(){
            o.trim(t.ui.newModuleName)||(t.hasError=!0);
            var e={
              name:t.ui.newModuleName
            };
            return S.addModule(e, R, z)
          }, t.createModuleWithData=function(e){
            return S.addModule(e, R, z)
          }, t.updateModuleWithData=function(e){
            return S.updateModule(e, R, z)
          }, e.$on("$addNewModule", (()=>t.addModule())), t.currentEditModule=null, t.openCreateModulePopup=()=>{
            if(!t.enableLessonTime)return t.currentEditModule=null, o("#create-or-edit-module").foundation("reveal", "open");
            a.prototype.$Modal.show(r(810098).A, {
              courseId:parseInt(k), lessonTimes:t.lessonTimes, idLessonTimeMap:t.idLessonTimeMap
            })
          }, t.openCreateModuleByTeachingWeekPopup=()=>{
            a.prototype.$Modal.show(r(391259).A, {
              courseId:parseInt(k)
            })
          }, t.createModuleByTeachingWeekSuccessCallback=e=>{
            S.addModulesCallback(e, (()=>{
              R(), t.$apply()
            }))
          }, t.addModule=function(){
            return t.enableCoTeaching||t.enableLessonTime?t.openCreateModulePopup():(t.newModule={
              name:"", syllabuses:[
              ], activities:[
              ], directActivities:[
            ...
            if(!t.enableLessonTime)return t.enableCoTeaching?(t.currentEditModule=e, o("#create-or-edit-module").foundation("reveal", "open")):D(e, S, t, _);
            a.prototype.$Modal.show(r(810098).A, {
              module:e, courseId:parseInt(k, 10), lessonTimes:t.lessonTimes, idLessonTimeMap:t.idLessonTimeMap
            })
          }, t.deleteModule=function(e){
            return t.hasDependents=!1, t.deleteType="module", t.deleteModel=e, t.isCourseInCheckpointMode?S.getModuleHasDependents(e.id, $, j):j()
          }, t.deleteLessonTime=function(e){
            return t.hasDependents=!1, t.deleteType="lesson-time", t.deleteModel=e, t.isCourseInCheckpointMode, j()
            ...
            return t.confirm=function(){
              return A.saveActivityResource(e, r, r)
            }, o("#save-confirmation-popup").foundation("reveal", "open"), null
          }, t.toggleSetting=function(e){
            e&&(b.initPublisher(t), this.expandModulesAndContents()), t.activityBatchSelectMode=e?"publish":"", b.toggleSetting(t, t.activityBatchSelectMode);
            var r={
            ...
            t.activityBatchSelectMode=e?"sync":"", b.toggleSetting(t, t.activityBatchSelectMode);
            var r={
              mode:t.activityBatchSelectMode
            }, o=new CustomEvent("activity-batch-select-mode", {
              detail:r
            ...
            a.prototype.$Modal.show(r(860868).default, {
            ...
            t.checkedActivities=b.checkAllOption(t.filterCategory)
          }, t.checkOption=function(e, r, o){
            t.checkedActivities=b.checkOption(e, r, o)
          }, t.cancelPublish=r(370102).M, t.checkActivity=function(){
            var e=u(s.mark((function e(r){
              return s.wrap((function(e){
                for(;
                ;
                )switch(e.prev=e.next){
                  case 0:return r.__publishing=!0, e.next=3, b.checkActivity(t, r);
          ...
          (), t.publish=function(){
            t.loading=!0, b.publishActivies(k, t.checkedActivities, t.publishSetting).finally((()=>{
              t.loading=!1
            }))
          }, e.$on("activity-publish-changed", ((e, r)=>{
            i(t.course.modules).forEach((function(e){
              b.updateActivitiesPublishType(e.directActivities, r), i(e.syllabuses).forEach((function(e){
                b.updateActivitiesPublishType(e.activities, r)
              }))
            })), t.toggleSetting(!1), b.closePublishPopup()
          }));
          var L=window.globalData.user.id;
          t.vueCreateActivity=p, t.vueSyncItem=f, t.vueSyncedInfo=m, e.$on("changeFile", ((e, t, r)=>{
            U(r, t)
          }));
          var U=(e, r)=>{
            C.logActivityRead(e.id, {
              upload_id:r.id
            }, (function(r){
            ...
            var e=u(s.mark((function e(){
              ...
              return s.wrap((function(e){
                ...
                ;
                  ...
                  case 0:return e.next=2, g(k, t.lessonTimeModules);
                  case 2:r=e.sent, t.lessonTimes=r;
                  case 4:case"end":return e.stop()
                }
              }), e)
            })));
          ...
          t.editLessonTime=e=>{
            var t={
              courseId:parseInt(k, 10)
            };
            e&&(t.lessonTimeId=e.id, t.date=new Date(e.startTime), t.slots=e.data.slots||[
            ]), a.prototype.$Modal.show(r(628661).A, t)
          };
          return t.enableCoTeaching&&Promise.all([
            r.e(79055), r.e(83696)
          ]).then(r.bind(r, 291512)), t.$watch("course.modules", (()=>{
            var e, r, n, i;
            b.initPublisher(t), t.enableCoTeaching&&(t.isInstructorView||t.isAssistantView)&&t.course.modules&&(e="".concat(L, ":").concat(k, ":syllabus:toggle_ops"), r=t.course.modules.reduce(((e, t)=>(e[
              t.id
            ]
            =null===t.lecturer_id||0===t.lecturer_id||t.lecturer_id===L, e)), {
            }), o.cookie(e, JSON.stringify(r), {
              expires:365
            })), null!==(n=window.orgSettings.courseLessonTimeView)&&void 0!==n&&n.enable&&null!==(i=t.course)&&void 0!==i&&i.modules&&(t.enableLessonTime=!0, t.lessonTimes=[
            ], t.lessonTimeModules={
            }, t.idLessonTimeMap={
            }, t.course.modules.forEach((e=>{
              t.lessonTimeModules[
                e.lesson_time_id
              ]
              =t.lessonTimeModules[
              ...
              t.lessonTimes.forEach((e=>{
                e.lessonTimes.forEach((r=>{
                  t.idLessonTimeMap[
                    r.id
                  ]
                  =[
      ...
      r(540590);
      var o, n, i=r(738645), a=r(510543), s=r(152229), c=r(731904), u=(o=function(e, t){
      ...
      r.r(t), r.d(t, {
        addActivityComment:()=>N, applyCommentLikeOperation:()=>V, checkTencentMeetingUserAuth:()=>se, checkUserLarkAuth:()=>P, createActivitiesInCourses:()=>I, createActivity:()=>p, createCalendarMeeting:()=>T, deleteActivity:()=>v, deleteActivityResource:()=>C, deleteSubmissionAttachMarkUpload:()=>z, getActivityCommentReplies:()=>B, getActivityComments:()=>U, getActivityCommentsReplies:()=>F, getActivityDetail:()=>g, getActivityHaveDependents:()=>S, getActivityReferences:()=>Q, getActivityResource:()=>x, getClasinJoinUrl:()=>y, getClassinWebcastUrl:()=>h, getCommentCountWithType:()=>J, getCompletionCriteria:()=>m, getCourseActivities:()=>_, getDingtalkWatchStats:()=>ce, getGroupSubmission:()=>oe, getGroupSubmissions:()=>$, getH5CoursewareViewUrl:()=>ue, getHomeworkDuplicateRate:()=>ie, getHomeworkInterScores:()=>X, getInterGroupScores:()=>ee, getIntraGroupScores:()=>te, getMeetingStatistics:()=>A, getPageCommentStat:()=>Y, getScoreItems:()=>k, getScoreRecords:()=>b, getStudentSubmission:()=>re, getStudentSubmissions:()=>j, getSubmissionAttachements:()=>D, logActivityRead:()=>M, logMgs:()=>O, refreshMarkedAttachment:()=>R, removeActivityComment:()=>W, removeActivityCommentReply:()=>K, replaceSubmissionCorrectUploadReference:()=>L, replyActivityComment:()=>q, reprocessLectureLiveReplay:()=>w, trackSchedulePlay:()=>E, updateActivity:()=>f, updateActivityComment:()=>H, updateActivityCommentReply:()=>G, updateActivityResource:()=>le, updateCorrectUploads:()=>ae, updateHomeworkAnnounceMarkStatus:()=>ne, updateHomeworkScoreAndComment:()=>Z, upsertH5CoursewareCmi:()=>de
      });
      r(540590), r(418665), r(169218), r(269193), r(14602);
      var o=r(272505), n=r.n(o), i=r(218831), a=r(920453), s=r(344651), c=r(854184), u=function(){
        ...
        return l(void 0, void 0, void 0, (function(){
          ...
          return d(this, (function(d){
            switch(d.label){
              ...
              case 1:return u=d.sent(), l=(0, i.camelizeKeys)(u.data), p=(0, a.plainToClass)(s.sB, l.records, {
          ...
          return d(this, (function(r){
            switch(r.label){
              ...
              case 1:return t=r.sent().data, [
                2, (0, a.plainToClass)(s.Il, (0, i.camelizeKeys)(t.activities))
              ]
            }
          }))
        }))
      ...
      function U(e, t, r, o, i, a){
        return n().get("/api/activities/".concat(e, "/comments?page=").concat(t, "&page_size=").concat(r, "&order_key=").concat(o, "&order=").concat(i, "&conditions=").concat(JSON.stringify(a)))
      }
      function F(e, t){
      ...
      function Z(e, t, r, o){
        var a=(0, i.decamelizeKeys)(t);
        n()({
          method:"PUT", url:"/api/course/activities/".concat(e, "/submission/score?fields=id,score,instructor_comment,rubric_score,final_score&need_submission_correct=true"), data:a, transformResponse:function(e){
            var t=JSON.parse(e);
            if(t.id)return t;
      ...
      function ne(e, t, r, o){
        return l(this, void 0, void 0, (function(){
          ...
          return d(this, (function(s){
            switch(s.label){
              case 0:return a=(0, i.decamelizeKeys)(t), [
                4, n().put("/api/homework/".concat(e, "/announce-mark-status"), a).then((function(e){
                  return r(e)
                })).catch((function(e){
                  return o(e)
                }))
          ...
          return d(this, (function(c){
            switch(c.label){
              case 0:return o=(0, i.decamelizeKeys)({
                base64State:r
              }), a="/api/h5-courseware/".concat(e, "/upload/").concat(t, "/cmi"), [
                4, n().post(a, o)
              ];
      ...
      var o=r(595738), n=r(552979), i=r(516844), a=r(272505), s=r.n(a), c=r(731904), u=r(738645), l=r(920453), d=function(e, t, r, o){
        var n, i=arguments.length, a=i<3?t:null===o?o=Object.getOwnPropertyDescriptor(t, r):o;
        if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e, t, r, o);
        else for(var s=e.length-1;
        s>=0;
      ...
      const m=(0, o.pM)({
        name:"create-module-by-teaching-week-modal", i18n:n.default, props:{
          ...
          var t=this, r=(0, o.KR)(!1), a=(0, i.useAngularScope)(document.querySelector("[ng-controller=SyllabusCtrl]")), u=(0, o.KR)(!1), d=(0, o.KR)([
          ]), m=(0, o.KR)([
          ]), y=[
            {
                  ...
                  case 0:return r=d, [
                    4, (n=e.courseId, p(t, void 0, void 0, (function(){
                      ...
                      return v(this, (function(t){
                        switch(t.label){
                          case 0:return[
                            4, s().get("/api/courses/".concat(n, "/teaching-weeks"))
                          ];
              ...
              return p(t, void 0, void 0, (function(){
                ...
                return v(this, (function(i){
                  switch(i.label){
                    case 0:return u.value=!0, r=c._.map(m.value, (function(e){
                      ...
                      4, (l=e.courseId, d={
                        ...
                        return v(this, (function(e){
                          switch(e.label){
                            case 0:return[
                              4, s().post("/api/course/".concat(l, "/modules"), d)
                            ];
                            case 1:return[
                              2, e.sent().data
                            ]
                    ...
                    case 1:return o=i.sent(), a.createModuleByTeachingWeekSuccessCallback(o), g(), c.Toast.success(n.default.t("save_success")), [
                      2
                    ]
                  }
                  var l, d
        ...
        "$http", "toastr", function(e, t){
          return{
            getMyGroup(t, r){
              ...
              :o.noop;
              return e.post("/api/courses/".concat(r, "/group-sets"), n).success(i).error(t.decorateError(a))
              ...
              :o.noop;
              return e.put("/api/group-sets/".concat(r), n).success(i).error(t.decorateError(a))
            }, deleteGroupSet:(r, o)=>e.delete("/api/group-sets/".concat(r)).success(o).error(t.decorateError()), copyGroupSet(r, n, i, a){
              ...
              return e.post("/api/courses/".concat(r, "/group-sets/").concat(n, "/copy"), {
                name:i
              }).success(a).error(t.decorateError(s))
            }, getStudents(r, o){
              ...
              return i&&(a.fields=i), e.get("/api/group-sets/".concat(t, "/groups"), {
                params:a
              }).success(r).error(n)
            }, updateGroup(r, n, i){
              var a=arguments.length>3&&void 0!==arguments[
              ...
              :o.noop;
              return e.put("/api/groups/".concat(r.id), n).success(t.decorateSuccess(i)).error(t.decorateError(a))
              ...
              :o.noop;
              return e.put("/api/groups/".concat(r.id, "/members"), n).success(t.decorateSuccess(i)).error(t.decorateError(a))
              ...
              :o.noop;
              return e.delete("/api/groups/".concat(r.id, "/members/").concat(n.id)).success(t.decorateSuccess(i)).error(t.decorateError(a))
            }, updateGroupMember(r, n, i, a){
              var s=arguments.length>4&&void 0!==arguments[
                4
              ]
              ?arguments[
              ...
              :o.noop;
              return e.put("/api/groups/".concat(r.id, "/members/").concat(n.id), i).success(t.decorateSuccess(a)).error(t.decorateError(s))
              ...
              :o.noop;
              return e.put("/api/groups/".concat(r, "/info"), n).success(t.decorateSuccess(i)).error(t.decorateError(a))
            }, addGroup(r, n, i){
              var a=arguments.length>3&&void 0!==arguments[
                3
              ]
              ...
              :o.noop;
              return e.post("/api/group-sets/".concat(r, "/groups"), n).success(t.decorateSuccess(i)).error(t.decorateError(a))
            }, deleteGroup(r, n){
              var i=arguments.length>2&&void 0!==arguments[
                2
              ]
              ...
              return e.put("/api/group-sets/".concat(r.id, "/sort"), {
                groupsSorting:n
              }).success(t.decorateSuccess(i)).error(t.decorateError(a))
              ...
              :o.noop;
              return e.delete("/api/groups/".concat(r.id, "/upload/").concat(n.reference_id)).success(t.decorateSuccess(i)).error(t.decorateError(a))
            }, batchDownload(r, n){
              var i=arguments.length>2&&void 0!==arguments[
                2
              ]
              ...
              return e.post(r, {
                data:n
              }).success(i).error(t.decorateError(a))
              ...
              :o.noop;
              return e.post("/api/group-sets/".concat(r, "/random-grouping"), n).success(t.decorateSuccess(i)).error(t.decorateError(a))
      ...
      var o=r(962893), n=r(695353), i=r(590815), a=r(82240), s=r(755805);
      function c(e, t){
        var r=Object.keys(e);
        if(Object.getOwnPropertySymbols){
          var o=Object.getOwnPropertySymbols(e);
      ...
      const d=new n.Ay.Store(u(u({
        ...
        modules:{
          homeworkMark:a.A, airCredit:s.A
        }, strict:!1
      }))
    }, 531122:e=>{
      e.exports=[
      ...
      r.r(t), r.d(t, {
        deleteInteraction:()=>c, getCourseUsers:()=>s, getDanmuActivity:()=>i, getDanmuConfig:()=>a
      });
        ...
        "$http", "toastr", function(e, t){
          return{
            initClassroomsWithPage(r, n, i){
              ...
              :o.noop, s="/api/courses/".concat(r, "/classroom-list");
              return e.get(s, {
                params:n
              }).success(t.decorateSuccess(i)).error(t.decorateError(a))
            }, deleteClassroom(r, n){
            ...
            }, updateClassroomSubjectStatus(r, n, i, a){
              var s=arguments.length>4&&void 0!==arguments[
                4
              ]
              ?arguments[
              ...
              return e.put("/api/classrooms/".concat(r, "/subjects/").concat(n, "/status"), {
                status:i
              }).success(t.decorateSuccess(a)).error(t.decorateError(s))
              ...
              if(null!==a){
                ...
                return e.get("/api/classroom-exams/".concat(t, "/score-list?ignore_avatar=").concat(i, "&conditions=").concat(JSON.stringify(s))).success(r).error(n)
              }
              ...
              :o.noop;
              return e.put("/api/feedback-activities/".concat(t, "/feedbacks/").concat(r), n).success(i).error(a)
            }, deleteFeedback(t, r){
              var n=arguments.length>2&&void 0!==arguments[
                2
              ]
      ...
      r(269193);
      var o=r(592207), n=r.n(o), i=(r(207452), r(962893)), a=r(552979);
      ...
      var u=()=>Promise.all([
        r.e(56662), r.e(93110), r.e(24072), r.e(79392), r.e(66491), r.e(22541), r.e(95738), r.e(97786), r.e(339), r.e(79278), r.e(38579), r.e(51708), r.e(5636), r.e(48941), r.e(78924), r.e(50574)
      ]).then(r.bind(r, 234582)), l=()=>Promise.all([
        r.e(95738), r.e(60868), r.e(5010)
      ]).then(r.bind(r, 860868)), d=function(){
        ...
        var e=c(n().mark((function e(t){
          ...
          return n().wrap((function(e){
            ...
            ;
              ...
              case 0:return r=t.source, o=t.courseId, a=t.subCourseCount, e.t0=i.default.prototype.$Modal, e.next=4, u();
              case 4:e.t1=e.sent.default, e.t2={
                source:r, courseId:o, subCourseCount:a
              }, e.t0.show.call(e.t0, e.t1, e.t2);
              case 7:case"end":return e.stop()
            }
          }), e)
      ...
      r(184095), r(348825), r(158649);
      var o=r(592207), n=r.n(o), i=(r(207452), r(595738)), a=r(272505), s=r.n(a), c=r(552979);
      const u=(0, i.pM)({
        name:"LessonTimeSlotSelect", props:{
          value:{
            type:Array, default:()=>[
            ]
          }, slots:{
          ...
          ||0), a=(0, i.EW)((()=>{
            var t=e.slots.find((e=>e.id===o.value));
            return t?t.start_time:""
          })), s=(0, i.EW)((()=>{
            var t=e.slots.find((e=>e.id===n.value));
            return t?t.end_time:""
          }));
          (0, i.wB)((()=>[
            o.value, n.value
          ...
          return{
            startId:o, endId:n, startTime:a, endTime:s, startChange:()=>{
              n.value=0
            }
          }
        }
      ...
      var l=r(514486);
      const d=(0, l.A)(u, (function(){
        var e=this, t=e.$createElement, r=e._self._c||t;
        return r("div", {
          staticClass:"slots-wrapper flex"
        }, [
          r("Select", {
            staticClass:"slot", on:{
              "on-change":e.startChange
            }, model:{
              value:e.startId, callback:function(t){
                e.startId=t
              }, expression:"startId"
            }
          }, e._l(e.slots, (function(t){
            return r("Option", {
              key:t.id, attrs:{
                value:t.id
              }
            }, [
              e._v(e._s(t.sequence))
            ])
          })), 1), e._v(" "), r("div", [
            e._v("-")
          ]), e._v(" "), r("Select", {
            staticClass:"slot", model:{
              value:e.endId, callback:function(t){
                e.endId=t
              }, expression:"endId"
            }
          }, e._l(e.slots, (function(t){
            return r("Option", {
              key:t.id, attrs:{
                value:t.id, disabled:t.id<e.startId
              }
            }, [
              e._v("\n      "+e._s(t.sequence)+"\n    ")
            ])
          })), 1), e._v(" "), e.startTime||e.endTime?r("div", [
            e._v("("+e._s(e.startTime)+" - "+e._s(e.endTime)+")")
          ]):e._e()
        ], 1)
      }), [
      ], !1, null, "01243b78", null).exports;
      function p(e, t, r, o, n, i, a){
        try{
          var s=e[
            i
          ]
      ...
      function y(e, t){
        var r=100*(e.getMonth()+1)+e.getDate(), o=v(t, 2), n=o[
          0
        ], i=o[
          1
        ], a=m(n), s=m(i);
        ...
        else if(r>=a||r<=s)return!0;
        return!1
      }
      function h(e){
        var t=e.getFullYear(), r=String(e.getMonth()+1).padStart(2, "0"), o=String(e.getDate()).padStart(2, "0");
        return"".concat(t, "-").concat(r, "-").concat(o)
      }
      const g=(0, i.pM)({
        name:"LessonTimeFormModal", components:{
          SlotSelect:d
        }, props:{
          lessonTimeId:{
          ...
          var t=(0, i.KR)(!0), r=(0, i.Kh)({
            date:e.date, slots:e.slots||[
            ]
          }), o=(0, i.KR)({
          }), a=(0, i.KR)(null), u={
            date:[
              {
                required:!0, trigger:"change", type:"date", message:c.default.t("required_field")
              }
            ], slots:[
              {
                required:!0, trigger:"change", type:"array", message:c.default.t("required_field")
              }
            ]
          }, l=(0, i.EW)((()=>{
            var e, t=null===(e=o.value.config)||void 0===e?void 0:e.slot_groups;
            if(!t||!r.date)return"";
            for(var n=0, i=Object.entries(t);
            n<i.length;
            n++){
              var a=v(i[
                n
              ...
              if(y(new Date(r.date), c))return s
            }
          })), d=(0, i.EW)((()=>{
            var e=o.value.slots;
            return l.value?e[
          ...
          s().get("/api/course/".concat(e.courseId, "/lesson-times/slot-config")).then((e=>{
            o.value=e.data
          }));
          var f=(0, i.EW)((()=>{
            return r.date?(e=r.date, t=o.value.weeks, n=h(e), t.find((e=>n>=e.start_date&&n<=e.end_date))||null):null;
            var e, t, n
          })), m=(0, i.EW)((()=>{
            var e;
            if(!f.value)return"yyyy-MM-dd";
            var t=r.date.getDay();
            t=0===t?7:t;
            var o=c.default.t("weekly.".concat(t));
            return"yyyy-MM-dd ".concat((null===(e=f.value)||void 0===e?void 0:e.name)||"", " ").concat(o)
          })), g=(0, i.EW)((()=>{
            var e;
            return null!==(e=o.value.weeks)&&void 0!==e&&e.length?new Date(o.value.weeks[
              0
            ].start_date):null
          })), b=(0, i.KR)(!1), _=function(){
            var o, i=(o=n().mark((function o(){
              var i, c, u;
              return n().wrap((function(o){
                for(;
                ;
                )switch(o.prev=o.next){
                  case 0:return o.next=2, a.value.validate();
                  case 2:if(o.sent){
                    o.next=5;
                    break
                  }
                  return o.abrupt("return");
                  case 5:c=window.globalData.course.id, u={
                    id:e.lessonTimeId, week_id:null===(i=f.value)||void 0===i?void 0:i.id, date:h(r.date), data:{
                      slots:r.slots, day_of_week:r.date.getDay()
                    }
                  }, e.lessonTimeId?s().put("/api/course/".concat(c, "/lesson-times"), u).then((()=>{
                    t.value=!1, window.location.reload()
                  })):s().post("/api/course/".concat(c, "/lesson-times"), u).then((()=>{
                    t.value=!1, window.location.reload()
                  }));
                  case 8:case"end":return o.stop()
                }
              }), o)
            })), function(){
          ...
          ();
          return{
            formData:r, visible:t, slotItems:d, slotConfig:o, slotGroup:l, dateFormat:m, dateDisable:e=>{
              var t=h(e);
              return!o.value.weeks.some((e=>t>=e.start_date&&t<=e.end_date))
            }, save:_, startDate:g, formRules:u, loading:b, formRef:a
          }
        }
      });
      const b=(0, l.A)(g, (function(){
        var e=this, t=e.$createElement, r=e._self._c||t;
        return r("Modal", {
          ref:"modal", attrs:{
            title:e.lessonTimeId?e.$t("editClass"):e.$t("addClass"), width:600
          }, model:{
            value:e.visible, callback:function(t){
              e.visible=t
            }, expression:"visible"
          ...
          e.slotConfig.config?r("Form", {
            ref:"formRef", attrs:{
              model:e.formData, "label-position":"left", "label-width":100, rules:e.formRules
            }
          }, [
            r("FormItem", {
              attrs:{
                label:e.$t("date"), prop:"date"
              }
            }, [
              r("DatePicker", {
                staticClass:"w-full", attrs:{
                  type:"date", "start-date":e.startDate, placeholder:e.$t("selectDate"), format:e.dateFormat, clearable:!1, options:{
                    disabledDate:e.dateDisable
                  }
                }, model:{
                  value:e.formData.date, callback:function(t){
              ...
              attrs:{
                label:e.$t("classTimetable.session"), prop:"slots"
              }
            }, [
              r("SlotSelect", {
                attrs:{
                  ...
                  value:e.formData.slots, callback:function(t){
                    e.$set(e.formData, "slots", t)
                  }, expression:"formData.slots"
                }
              })
            ], 1)
          ], 1):e._e(), e._v(" "), r("div", {
            ...
            r("div", {
              ...
              r("Button", {
                staticClass:"btn-primary btn-default", attrs:{
                  type:"primary", loading:e.loading
                }, on:{
                  click:e.save
                }
              }, [
      ...
      ], !1, null, "649aa9c6", null).exports
    }, 637077:(e, t, r)=>{
      var o=r(571478);
      e.exports=[
        "$scope", "$rootScope", "moduleRepository", "toastr", function(e, t, r, n){
          var i=o(e), a=e.module;
          return e.module=t.copiedModule, e.cancel=()=>a.inEdit=!1, e.save=function(){
            return i.show(), r.updateModule(e.module, (function(){
              return a.inEdit=!1, i.hide()
            }), (function(t, r){
      ...
      e.exports.filterFactory=e=>{
        var t=()=>{
          ...
          return e=>{
            ...
            ].includes(e.type)||e.type===r)&&(!n||!n.length||(t=n, 0===(c=null!==(a=null===(s=e.data)||void 0===s?void 0:s.sub_course_ids)&&void 0!==a?a:[
      ...
      var o=r(248124);
      r(640173), r(158649);
      var n=r(966491), i=r(571478), a=r(552979).default;
      e.exports=[
        "$rootScope", "$scope", "toastr", "Upload", "uploadService", function(e, t, r, s, c){
          ...
          t.deleteUploaded=function(t){
            ...
            if(!(e.length<=0))if(e.length>1)r.warning(t.errorText.singleFile);
              ...
              if(n.includes(i)){
                ...
                var a=o;
                "object"==typeof o&&void 0!==o.DOCUMENT&&(a=o.DOCUMENT);
                var s=c.humanizeBytes(a);
            ...
            return t.uploadPromise=e, e.then((function(){
              l.hide(), r.success(a.t("moodleCourseImport.importedSuccess")), o("#wisdom-popup").foundation("reveal", "close"), setTimeout((function(){
        ...
        "$http", "toastr", function(e, t){
          return{
            likeTopic(r, n){
              ...
              var o=r.user_ids, n=s(r, [
                "user_ids"
              ]), a="/api/activities/".concat(t, "/topics");
              return(null==o?void 0:o.length)>0&&(a="/api/activities/".concat(t, "/topics?user_ids=[").concat(o.join(","), "]")), e.get(a, {
                params:i({
                }, n)
      ...
      r(215195), r(700533), e.exports=[
        "$q", "commonApi", "activityApi", "forumApi", "groupApi", "toastr", function(e, t, r, a, s, c){
          var u="id,sort,module_id,syllabus_id,start_time,end_time,is_started,is_closed,data,can_show_score,score_percentage,title,prerequisites,submit_by_group,group_set_id,group_set_name,imported_from,completion_criterion_key,published,is_in_progress,completion_criterion,score_item_group_id,score_item_scored", l="id,title,activity(".concat(u, "),referrer_type"), d="id,title,created_by(id,name,nickname,comment),group_id,created_at,updated_at,content,read_replies(reply_id),reply_count,unread_reply_count,like_count,current_user_read,current_user_liked,in_common_category,enrollments(roles,aliases),has_matched_replies,uploads", p="id,learning_mode,modules(id,sort,name,syllabuses(id,summary,date,module_id)),score_published,syllabus_enabled", v=null, f=null, m={
            ...
            return s.getStudents(t, n, r, null), o.promise
          }, g=function(t){
            var r=e.defer();
            return a.getForumScores(t, (e=>r.resolve(e.forum_scores)), c.decorateError()), r.promise
          }, b=function(t){
            var r=e.defer();
            return a.getForumActivityTopics(t, (e=>r.resolve(e.topics))), r.promise
          };
          return{
            toggleTopicLiked:function(e, t){
              var r, o=e=>c.warning(e.message);
              return e.current_user_liked?(r=()=>e.like_count--, a.unlikeTopic(e.id, r, o)):(t&&statistics.track({
              ...
              }), r=()=>e.like_count++, a.likeTopic(e.id, r, o)), e.current_user_liked=!e.current_user_liked
            }, toggleReplyLiked:function(e, t){
              var r, o=e=>c.warning(e.message);
              return e.current_user_liked?(r=()=>e.like_count--, a.unlikeReply(e.id, r, o)):(t&&statistics.track({
              ...
              }), r=()=>e.like_count++, a.likeReply(e.id, r, o)), e.current_user_liked=!e.current_user_liked
            }, loadStudentForumScore:function(t){
              var r=e.defer(), n=o("#userId").data("id");
              return a.getStudentForumScore(t, n, (e=>r.resolve(e.forum_score)), c.decorateError()), r.promise
              ...
              return e.all([
                ...
                return n.each(o, (function(e){
                  var t=n.reduce(s, ((e, t)=>e.concat(t.replies)), [
                  ]), r={
                  };
                  r.final_score=n.find(a, {
                    student_id:e.id
                  })||{
                  }, r.student=e;
                  var o=n.filter(s, (t=>t.created_by.id===e.id));
            ...
            }, saveStudentScore:(e, t, r, o, n)=>a.saveForumScore(e, t, r, o, n), loadGroups:t=>m[
              t
            ]
            ?e.resolve(m[
              t
            ]):s.getGroups(t, n.noop, null, "id,name,sort,members").then((e=>(m[
              t
            ]
            =e.data.groups, m[
              t
              ...
              :d;
              return a.getTopicCategory(e, t, r, o, n).then((e=>e.data))
              ...
              :l;
              return f?e.resolve(f):a.getTopicCategories(t, r).then((e=>f=e.data.topic_categories))
        ...
        "classroomApi", "$q", "toastr", function(e, t, r){
          ...
          return{
            initClassroom(r){
              ...
              =t.defer();
              return e.getClassroomExam(r, (e=>o[
                r
              ].resolve(e)), (()=>o[
                r
              ].resolve(null))), o[
            ...
            }, startClassroom:(t, r, n)=>e.startClassroom(t, (function(e){
              return o[
                t
              ]
              &&delete o[
            ...
            })), finishClassroom:(t, r, n)=>e.finishClassroom(t, (function(e){
              return o[
                t
              ]
              &&delete o[
              ...
              =t.defer();
              return e.getFeedbackActivity(r, (e=>n[
                r
              ].resolve(e)), (()=>n[
                r
              ].resolve(null))), n[
              ...
              =t.defer();
              return r?e.getSubjectsRule(r, (e=>i[
                r
              ].resolve(e)), (()=>i[
                r
              ].resolve(null))):i[
              ...
              =t.defer();
              return e.getSubjectsWithStatInfo(r, (e=>s[
                r
              ].resolve(e.subjects)), (()=>s[
                r
              ].resolve([
              ]))), s[
                r
              ...
              =t.defer();
              return e.getMySubmissions(r, (e=>u[
                r
              ].resolve(e)), (()=>u[
                r
              ].resolve({
              ...
              =t.defer();
              return e.getExaminees(r, (e=>c[
                r
              ].resolve(e.examinees)), (()=>c[
                r
              ].resolve([
              ])), o=o, n), c[
                r
      ...
      var o, n, i, a=r(738645), s=r(152229), c=function(e, t, r, o){
        var n, i=arguments.length, a=i<3?t:null===o?o=Object.getOwnPropertyDescriptor(t, r):o;
        if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e, t, r, o);
        else for(var s=e.length-1;
        s>=0;
      ...
      var o=r(302543), n=r(793110), i=r(248124), a=r(756029);
      ...
      e.exports=[
        "$rootScope", "$scope", "activityRepository", "forumRepository", "modelHelper", "$timeout", "$window", "$compile", "toastr", "activityApi", "commonApi", "$http", function(e, t, r, u, f, m, y, h, g, b, _, w){
          ...
          ();
          t.enableScoreItemGroup&&T(i("#courseId").val()), t.$watch("forum.score_item_scored", (()=>{
            t.forum&&(t.forum.score_item_scored?t.forum.score_item_group_id||(t.forum.score_item_group_id=t.scoreItemGroups[
              0
            ...
            return I(a.copy(e), t.ui.selectedActivityId)
          ...
          return t.save=function(e){
            ...
            var s=a.copy(t.forum);
            s.announce_score_type=t.ui.announceScoreType, "SHTVU"===t.deliveryOrg&&t.groupSets.length>0&&(s.group_set_id=t.groupSets[
              0
            ].id), 3!==t.ui.announceScoreType&&delete s.announce_score_time, s.participation_scope=t.ui.participationScope, "crossCourse"==t.ui.participationScope&&(s.score_percentage=0, s.prerequisites=[
            ]), void 0!==e&&(s.published=e), t.startActivityType=null, s.is_never_expire=t.never_expire, x.saveActivity(s, t).then((()=>{
      ...
      r(540590), r(418665), r(269193), r(868329), r(14602);
      var o=r(595738), n=r(552979), i=r(516844), a=r(218831);
      const s=(0, o.pM)({
        name:"ModuleLessonTimeSelect", props:{
          module:{
            type:Array, default:()=>[
            ]
          }, lessonTimes:{
          ...
          data:(0, o.EW)((()=>e.lessonTimes.map((e=>({
            value:e.id, label:e.title, children:e.lessonTimes.map((e=>({
              value:e.id, label:e.shortTitle()
            })))
          })))))
        })
      });
      var c=r(514486);
      const u=(0, c.A)(s, (function(){
        var e=this, t=e.$createElement;
        return(e._self._c||t)("Cascader", e._g(e._b({
          staticClass:"w-full", attrs:{
            data:e.data
          }
        }, "Cascader", e.$attrs, !1), e.$listeners))
      }), [
      ], !1, null, null, null).exports;
      ...
      const p=(0, o.pM)({
        name:"create-or-edit-module-form", i18n:n.default, props:{
          courseId:{
            type:Number
          }, module:{
            type:Object
          ...
          var t, r=this, s=(0, o.KR)(!1), c=(0, o.KR)({
            id:0, name:"", lessonTimeId:(null===(t=e.module)||void 0===t?void 0:t.lesson_time_id)||0
          }), u=(0, i.useAngularScope)(document.querySelector("[ng-controller=SyllabusCtrl]")), p=(0, o.KR)(null), v=(0, o.KR)(!1), f=(0, o.EW)({
            get:function(){
              if(c.value.lessonTimeId&&e.idLessonTimeMap[
                c.value.lessonTimeId
              ]){
                var t=e.idLessonTimeMap[
                  c.value.lessonTimeId
                ], r=t[
                  0
                ], o=t[
            ...
            name:[
              {
                required:!0, validator:function(e, t, r){
                  return null!=t&&t.trim().length>0?r():r(new Error(n.default.t("required_field")))
                }, trigger:"change"
              }
            ]
          };
          return(0, o.sV)((function(){
            return l(r, void 0, void 0, (function(){
              return d(this, (function(t){
                return e.module&&(c.value.id=e.module.id, c.value.name=e.module.name), [
                  2
                ]
              }))
            }))
          })), {
            moduleData:c, cancel:function(){
              s.value=!1
            }, saveModule:function(){
              return l(r, void 0, void 0, (function(){
                return d(this, (function(t){
                  switch(t.label){
                    case 0:return v.value=!0, [
                      4, p.value.validate()
                    ];
                    case 1:return t.sent()?(e.module?u.updateModuleWithData((0, a.decamelizeKeys)(c.value)):u.createModuleWithData((0, a.decamelizeKeys)(c.value)), window.location.reload(), [
                      2
                    ]):(v.value=!1, [
                      2
                    ])
            ...
            }, formRules:m, formRef:p, loading:v, visible:s, selectedLessonTime:f
          }
        }
      });
      const v=(0, c.A)(p, (function(){
        var e=this, t=e.$createElement, r=e._self._c||t;
        return r("Modal", {
          ref:"modal", attrs:{
            title:e.moduleData.id?e.$t("editModule.name"):e.$t("addModule"), width:600
          }, model:{
            value:e.visible, callback:function(t){
              e.visible=t
            }, expression:"visible"
          ...
          r("div", {
            staticClass:"create-edit-module-form"
          }, [
            r("div", {
              staticClass:"form-main-container"
            }, [
              r("Form", {
                ref:"formRef", staticClass:"form", attrs:{
                  model:e.moduleData, "label-width":104, rules:e.formRules
                }, nativeOn:{
                  submit:function(e){
                    e.preventDefault()
                  }
                ...
                r("FormItem", {
                  attrs:{
                    label:e.$t("createModule.name"), prop:"name", required:""
                  }
                }, [
                  r("Input", {
                    attrs:{
                      placeholder:e.$t("createModule.nameTip"), clearable:""
                    }, model:{
                      value:e.moduleData.name, callback:function(t){
                        e.$set(e.moduleData, "name", t)
                      }, expression:"moduleData.name"
                    }
                  })
                ], 1), e._v(" "), r("FormItem", {
                  attrs:{
                    label:e.$t("lessonTime"), prop:"lessonTime"
                  }
                }, [
                  r("LessonTimeSelect", {
                    attrs:{
                      lessonTimes:e.lessonTimes
                    }, model:{
                      value:e.selectedLessonTime, callback:function(t){
                        e.selectedLessonTime=t
                      }, expression:"selectedLessonTime"
                    }
                  })
                ], 1)
              ], 1)
      ...
      ], !1, null, "4f52e8ee", null).exports
    }, 815134:(e, t, r)=>{
      r.r(t), r.d(t, {
        addCourse:()=>A, assignActivityToModule:()=>P, assignUploadsToCourse:()=>$, combineCourse:()=>M, combineCourseContent:()=>E, getAllMyCoursesByConditions:()=>R, getAvaLives:()=>m, getCanBeCombinedCourses:()=>O, getCourse:()=>y, getCourseEducators:()=>b, getCourseHosts:()=>g, getCourseInstructors:()=>h, getCourseLives:()=>f, getCourseModules:()=>v, getCoursesAuditResource:()=>x, getCoursesToMerged:()=>j, getCoursesWithResourceNum:()=>S, getMyAcademicYears:()=>T, getMyCoursesByPage:()=>k, getMySemesters:()=>I, getOnoCourseVisitStat:()=>C, getSubCourses:()=>D, getUsersByGroupName:()=>_, inspectCourse:()=>w
      });
      r(540590), r(418665), r(169218), r(269193), r(14602);
      var o=r(272505), n=r.n(o), i=r(920453), a=r(218831), s=r(448743), c=r(765321), u=r(731904), l=function(){
        ...
        return d(this, void 0, void 0, (function(){
          ...
          return p(this, (function(c){
            switch(c.label){
              ...
              case 1:return r=c.sent(), o=(0, a.camelizeKeys)(r.data.lives), [
        ...
        return d(this, void 0, void 0, (function(){
          ...
          return p(this, (function(p){
            switch(p.label){
              ...
              case 1:return c=p.sent(), l=(0, a.camelizeKeys)(c.data.items), d=(0, i.plainToClass)(s.AvaLiveInfo, l), [
                2, {
        ...
        return d(this, void 0, void 0, (function(){
          ...
          return p(this, (function(o){
            switch(o.label){
              ...
              case 1:return r=o.sent().data, [
                2, (0, i.plainToClass)(s.BaseCourse, (0, a.camelizeKeys)(r))
              ]
            }
          }))
        }))
        ...
        return d(this, void 0, void 0, (function(){
          ...
          return p(this, (function(o){
            switch(o.label){
              ...
              case 1:return r=o.sent(), [
                2, (0, i.plainToClass)(c.KJ, (0, a.camelizeKeys)(r.data.hosts), {
                  excludeExtraneousValues:!0
                })
              ]
            }
        ...
        return void 0===t&&(t=""), d(this, void 0, void 0, (function(){
          ...
          return p(this, (function(u){
            switch(u.label){
              ...
              case 1:return o=u.sent(), s=(0, a.camelizeKeys)(o.data.enrollments), [
                2, (0, i.plainToClass)(c.Gw, s)
              ]
            }
          }))
        }))
        ...
        return d(void 0, void 0, void 0, (function(){
          ...
          return p(this, (function(d){
            switch(d.label){
              ...
              case 1:return c=d.sent(), u=(0, a.camelizeKeys)(c.data.courses), l=(0, i.plainToClass)(s.CourseWithResourceNum, u, {
                excludeExtraneousValues:!0
              }), [
                2, {
        ...
        return d(void 0, void 0, void 0, (function(){
          ...
          return p(this, (function(p){
            switch(p.label){
              ...
              case 1:return u=p.sent(), l=(0, a.camelizeKeys)(u.data.audit_references), d=(0, i.plainToClass)(s.CourseAuditReference, l, {
                excludeExtraneousValues:!0
              }), [
                2, {
      ...
      function C(e, t, r, o, c){
        return d(this, void 0, void 0, (function(){
          ...
          return p(this, (function(p){
            switch(p.label){
              case 0:return u=(0, a.decamelizeKeys)({
              ...
              case 1:return l=p.sent(), d=(0, a.camelizeKeys)(l.data.result), [
      ...
      function M(e){
        return d(this, void 0, void 0, (function(){
          ...
          return p(this, (function(r){
            switch(r.label){
              case 0:return[
                4, n().post("/api/combine-courses", (0, a.decamelizeKeys)(e))
              ];
              case 1:return t=r.sent(), [
                2, (0, a.camelizeKeys)(t.data)
              ]
      ...
      e.exports=function(e, t, r, n, i){
        ...
        return{
          refreshPrerequisitesAfterActivityEdit:()=>(r.module_id&&0!==r.module_id||a(r), function(t){
            if(e.isCourseInCheckpointMode){
              var r=n.getDependantActivities(t, e.course, e);
              if(r.length>0)return o.isEmpty(t.completion_criterion)?a(t):n.changeInfoOfDependantActivities(r, t)
            }
            else if(o.isEmpty(t.completion_criterion))return a(t)
          }
          (r))
        }
      }
      ...
      e.exports=function(e, t, r, i){
        ...
        e.deleteActivity=o=>function(o){
          var n=s.includes(o.type)?"courseware":o.type;
          ...
          ={
            ...
            deleteOriginal:!0
          }, e.confirm=()=>t.deleteActivityFromCourse(o, e.course, p(), a, a), c.includes(o.type)?t.loadActivityDeleteCheck(o.id, o.type).then((t=>{
        ...
        (o), e.deleteExam=o=>function(o){
          var s;
          null!==(s=i.featureToggles)&&void 0!==s&&s.outcomeBasedEducation&&n(e, e.course.id, o, t).getObeRelation(), r[
            u
          ]
          ={
            ...
            deleteOriginal:!0
          }, e.confirm=()=>t.deleteExam(o, e.course, p(), a, a), c.includes(o.type)?t.loadActivityDeleteCheck(o.id, o.type).then((t=>{
            e.safeDelete=t.safe_delete
          })).finally((()=>{
            d()
          })):d()
        ...
        (o), e.deleteClassroom=o=>function(o){
          ...
          ={
            ...
            deleteOriginal:!0
          }, e.confirm=()=>t.deleteClassroom(o, e.course, p(), a, a), c.includes(o.type)?t.loadActivityDeleteCheck(o.id, o.type).then((t=>{
            e.safeDelete=t.safe_delete
          })).finally((()=>{
            d()
          })):d()
        ...
        (o), e.deleteAskQuestion=o=>function(o){
          ...
          ={
            ...
            deleteOriginal:!0
          }, e.confirm=()=>t.deleteAskQuestion(o, e.course, p(), a, a), d()
        }
        (o);
        var p=function(){
      ...
      r(207452);
      r(181769).canEditActivity, r(5782).default, r(737066).A, r(901499);
      var i=r(951708).getActivityAiQuizzes;
      e.exports=[
        "$rootScope", "$scope", function(e, t){
          t.loadingAiQuizzes=!1;
          var r=function(){
            var r, a=(r=o.mark((function r(n){
              var a;
              return o.wrap((function(r){
                ...
                ;
                  ...
                  case 6:(a=r.sent)&&(e.aiQuizCount=a.length, n.uploads.forEach((e=>{
                    var t=a.find((t=>t.uploadReferenceId===e.reference_id));
                    e.aiQuiz=t||null
                  }))), t.loadingAiQuizzes=!1, t.$apply();
