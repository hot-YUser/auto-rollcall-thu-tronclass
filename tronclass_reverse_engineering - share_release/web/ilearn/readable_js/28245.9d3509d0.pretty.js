(self.webpackChunklms=self.webpackChunklms||[
  ...
  [
    7145, 17621, 28245, 40002, 46169, 62383, 67888, 77444, 84764
  ], {
    258:(t, e, r)=>{
      r(951605)({
        global:!0
      ...
      r.r(e), r.d(e, {
        NIL:()=>C, parse:()=>f, stringify:()=>a.A, v1:()=>c, v3:()=>_, v4:()=>w.A, v5:()=>T, validate:()=>l.A, version:()=>k
      });
      var n, o, i=r(543407), a=r(338823), s=0, u=0;
      const c=function(t, e, r){
        var c=e&&r||0, l=e||new Array(16), f=(t=t||{
      ...
      function p(t, e, r){
        function n(t, n, o, i){
          ...
          (t)), "string"==typeof n&&(n=f(n)), 16!==n.length)throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");
        ...
        (function(t, e){
          ...
          a+=16){
            ...
            r=v(r, n, o, i, t[
              ...
              a+9
            ], 21, -343485551), r=d(r, s), n=d(n, u), o=d(o, c), i=d(i, l)
          }
          return[
            r, n, o, i
          ]
      ...
      const T=p("v5", 80, (function(t){
        ...
        u<a;
        ++u){
          for(var c=new Uint32Array(16), l=0;
          l<16;
          ++l)c[
            l
          ]
        ...
        ++f){
          ...
          _<80;
          ++_){
            var w=Math.floor(_/20), T=A(m, 5)+x(w, v, y, g)+b+e[
              w
            ]
            +p[
              _
      ...
      function s(t){
        ...
        c&&(c.$on("on-cancel", (()=>{
          setTimeout((()=>{
            (u.getComponentName&&"VocabularyForm"===u.getComponentName()||e.destroyComponent)&&(s.$destroy(), s.$el.remove())
          }), 300)
        })), c.$on("on-visible-change", (t=>{
          !t&&e.destroyComponent&&setTimeout((()=>{
            s.$destroy(), s.$el.remove()
          }), 1e3)
        })))
      }
      var u=()=>{
        n.default.prototype.$Modal&&(n.default.prototype.$Modal.show=s)
      };
      const c=s
    }, 7950:function(t, e, r){
      var n;
      ...
      r(418665), r(269193), r(14602), r(630789);
      var n=r(592207), o=r.n(n), i=(r(207452), r(595738)), a=r(302543), s=r.n(a), u=r(580630);
      ...
      const l=(0, i.pM)({
        name:"pdf-preview-shim", props:{
          upload:{
            type:Object
          }
        }, setup(t, e){
          var r=(0, i.KR)(""), n=(0, i.KR)(!1), a=function(){
            var e, n=(e=o().mark((function e(n){
              var i, a, s, u, c, l, f, p, h;
              return o().wrap((function(e){
                for(;
                ;
                )switch(e.prev=e.next){
                  case 0:if(a=t.upload, s=a.id, u=a.name, c=a.type, l=a.marked_attachment, f=null!==(i=l.url)&&void 0!==i?i:"", "image"!==c){
                    e.next=8;
                    break
                  }
                  return e.next=5, fetch(n.detail.data).then((t=>t.blob()));
                  case 5:p=e.sent, h=URL.createObjectURL(p), r.value="/pdf/editor?uploadId=".concat(s, "&file=").concat(encodeURIComponent(h), "&fileType=").concat(c, "&imgURL=").concat(n.detail.imgURL, "&attachmentUrl=").concat(encodeURIComponent(f), "&rotatedAngle=").concat(n.detail.rotatedAngle, "&preview&fileName=").concat(u);
          ...
          ();
          return(0, i.wB)((()=>t.upload), (()=>{
            (e=>{
              var o;
              if(!s().isEmpty(t.upload)){
                var i=t.upload, a=i.id, c=i.url, l=i.name, f=i.type, p=i.imgURL, h=null!==(o=i.marked_attachment.url)&&void 0!==o?o:"", d=(t, n)=>{
                  r.value="/pdf/editor?uploadId=".concat(a, "&file=").concat(encodeURIComponent(t), "&fileType=").concat(f, "&imgURL=").concat(n, "&attachmentUrl=").concat(encodeURIComponent(h), "&rotatedAngle=").concat(e, "&preview&fileName=").concat(l)
                };
                "image"===f?(0, u.useImage2Pdf)(c, d, (()=>{
                })):d(c, p), n.value=!0
              }
            })(0)
          }), {
            ...
            window.addEventListener("refreshPDFURL", a)
          })), (0, i.xo)((()=>{
            window.removeEventListener("refreshPDFURL", a)
          })), {
            pdfPreviewUrl:r, loaded:n
          }
        }
      });
      const f=(0, r(514486).A)(l, (function(){
        var t=this, e=t.$createElement, r=t._self._c||e;
        return t.loaded?r("div", {
          staticClass:"document-previewer"
        }, [
          r("div", {
            staticClass:"can-preview-container"
          }, [
            t.pdfPreviewUrl?r("iframe", {
              attrs:{
                id:"pdfPreviewIframe", width:"100%", height:"100%", frameborder:"0", src:t.pdfPreviewUrl
              }
            }):t._e()
          ])
        ]):t._e()
      }), [
      ], !1, null, "5b870ad4", null).exports
    }, 145019:t=>{
