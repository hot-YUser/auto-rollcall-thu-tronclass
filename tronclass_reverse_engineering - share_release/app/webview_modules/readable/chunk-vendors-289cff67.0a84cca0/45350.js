// Source: decompiled/web-modules-acorn/chunk-vendors-289cff67.0a84cca0/45350.js
// Webpack module id: 45350
const __webpack_module_45350 = function (t, e, n) {
  (!(function (t) {
    "use strict";
    !(function (t) {
      var e = {};
            ...
            return function (p, d, v, g) {
              for (
                var y,
                  ...
                  S = 0,
                  _ = g || u,
                  O = e ? _(p, E) : n ? _(p, 0) : void 0;
                E > S;
                S++
              )
                if ((h || S in x) && ((m = w((y = x[S]), S, b)), t))
                  if (e) O[S] = m;
                  else if (m)
                    switch (t) {
                      case 3:
          ...
          { target: "Array", proto: !0 },
          {
            flat: function () {
              var t = arguments.length ? arguments[0] : void 0,
                ...
                r = c(e, 0);
              return (
                (r.length = o(r, e, e, n, 0, void 0 === t ? 1 : u(t))),
                r
              );
            },
          },
      ...
      function (t, e, n) {
        ...
        t.exports = function (t) {
          ...
          if (
            ...
            for (n = new v((e = u(d.length))); e > x; x++)
              ((p = m ? y(d[x], x) : d[x]), c(n, x, p));
          else
            for (
              ...
              ((p = m ? i(l, y, [f.value, x], !0) : f.value), c(n, x, p));
          return ((n.length = x), n);
        };
      },
      function (t, e, n) {
        ...
        (r(
          {
            target: "Array",
            proto: !0,
            forced: !n(67)("indexOf", { ACCESSORS: !0, 1: 0 }),
          },
          {
            includes: function (t) {
              return o(this, t, arguments.length > 1 ? arguments[1] : void 0);
          ...
          if (
            (j &&
              ...
              d !== Object.prototype &&
                ...
                (l ||
                  i(x) === d ||
                  (a ? a(x, d) : "function" != typeof x[g] && c(x, g, y)),
                u(x, _, !0, !0),
                l && (h[_] = y))),
            "values" == p &&
              C &&
            ...
            if (
              ...
              for (E in w) (v || O || !(E in A)) && s(A, E, w[E]);
          ...
          { target: "Array", proto: !0, forced: !p || !d },
          {
            slice: function (t, e) {
              ...
              if (
                ...
                return g.call(l, p, d);
              for (
                r = new (void 0 === n ? Array : n)(y(d - p, 0)), f = 0;
                p < d;
                p++, f++
              )
                p in l && s(r, f, l[p]);
      ...
      function (t, e, n) {
        var r = n(2),
          ...
          f = function (t, e, n) {
            var r = n.charAt(e - 1),
              o = n.charAt(e + 1);
            return (c.test(t) && !s.test(o)) || (s.test(t) && !c.test(r))
      ...
      function (t, e, n) {
        ...
        (t.exports = function (t, e, n, f, l) {
          ...
          for (y = h.next; !(m = y.call(h)).done; )
            if (
              "object" == typeof (g = c(h, b, m.value, f)) &&
              g &&
              g instanceof s
            )
              return g;
      ...
      function (t, e, n) {
        var r,
          ...
          G = W,
          $ = "process" == b(z),
          V = !!(q && q.createEvent && s.dispatchEvent),
          X = k(L, function () {
            if (x(D) === String(D)) {
              if (66 === N) return !0;
        ...
        (X &&
          ...
          c ||
            ...
            "function" == typeof H &&
              u(
                ...
                {
                  fetch: function (t) {
                    return A(D, H.apply(s, arguments));
                  },
                },
              ))),
          ...
          u(
            { target: L, stat: !0, forced: c || X },
            {
              resolve: function (t) {
                return A(c && this === i ? D : this, t);
              },
            },
          ),
          u(
          ...
          { target: "String", proto: !0, forced: O },
          {
            matchAll: function (t) {
              ...
              if (null != t) {
                ...
                if (O) return _.apply(o, arguments);
                if (
                  (void 0 === (n = t[b]) && m && "RegExp" == s(t) && (n = C),
                  null != n)
                )
                  return u(n).call(t, o);
              } else if (O) return _.apply(o, arguments);
              return (
                (e = String(o)),
                (r = new RegExp(t, "g")),
                m ? C.call(r, e) : r[b](e)
          ...
          return [
            ...
            function (t, r) {
              ...
              for (var w = []; ; ) {
                ...
                if (null === E) break;
                if ((w.push(E), !v)) break;
                "" === String(E[0]) && (c.lastIndex = s(p, a(c.lastIndex), x));
              }
              for (var S, _ = "", O = 0, A = 0; A < w.length; A++) {
                E = w[A];
                for (
                  var C = String(E[0]),
                    R = l(h(u(E.index), p.length), 0),
                    j = [],
                    T = 1;
                  T < E.length;
                  T++
                )
                  j.push(void 0 === (S = E[T]) ? S : String(S));
                var k = E.groups;
                if (d) {
                  var I = [C].concat(j, R, p);
                  void 0 !== k && I.push(k);
                  var N = String(r.apply(void 0, I));
                } else N = b(C, p, R, j, k, r);
                R >= O && ((_ += p.slice(O, R) + N), (O = R + C.length));
              }
              return _ + p.slice(O);
            },
          ];
              ...
              [
                ...
                function (t, o) {
                  ...
                  for (var x = 0, w = 0, E = []; w < h.length; ) {
                    ...
                    if (
                      null === _ ||
                      (S = d(s(m.lastIndex + (v ? 0 : w)), h.length)) === x
                    )
                      w = c(h, w, g);
                    else {
          ...
          F = function (t) {
            ...
            for (n = [], r = 0; r < e; r++) {
              ...
              if (
                ...
                if (!(10 == i ? k : 8 == i ? T : I).test(o)) return t;
                a = parseInt(o, i);
              }
              n.push(a);
            }
          ...
          (i &&
            c(St, {
              ...
              port: Mt(kt, function (t) {
                var e = S(this);
                J(e) ||
                  ("" == (t = String(t)) ? (e.port = null) : wt(e, t, ht));
              }),
            ...
            for (p && r.push("-"); d < o; ) {
              ...
              for (l += (v - f) * g, f = v, e = 0; e < t.length; e++) {
                ...
                if (n == f) {
                  ...
                  (r.push(u(c(y))), (h = s(l, g, d == p)), (l = 0), ++d);
                }
              }
              (++l, ++f);
            }
      ...
      function (t, e, n) {
        ...
        var r = n(2),
          ...
          C = f.getterFor("URLSearchParamsIterator"),
          R = /\+/g,
          j = Array(4),
          T = function (t) {
            return (
          ...
          M = function (t) {
            return encodeURIComponent(t).replace(N, L);
          },
          U = function (t, e) {
            if (e)
