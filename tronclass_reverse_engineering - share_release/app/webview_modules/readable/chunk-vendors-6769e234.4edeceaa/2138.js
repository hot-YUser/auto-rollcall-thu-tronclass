// Source: decompiled/web-modules-acorn/chunk-vendors-6769e234.4edeceaa/2138.js
// Webpack module id: 2138
const __webpack_module_2138 = function (e, t, i) {
  (i.r(t),
    i.d(t, {
      Swiper: function () {
        return ft;
    ...
    (void 0 === e && (e = {}),
      ...
      Object.keys(t).forEach(function (i) {
        "undefined" === typeof e[i]
          ? (e[i] = t[i])
          : a(t[i]) && a(e[i]) && Object.keys(t[i]).length > 0 && s(e[i], t[i]);
      }));
  }
        ...
        if (s.indexOf("<") >= 0 && s.indexOf(">") >= 0) {
          ...
          for (
            0 === s.indexOf("<li") && (l = "ul"),
              ...
              a.innerHTML = s,
              r = 0;
            r < a.childNodes.length;
            r += 1
          )
            i.push(a.childNodes[r]);
        } else
          for (
            n =
              t || "#" !== e[0] || e.match(/[ .<>:~]/)
    ...
    function s(e) {
      ...
      if (t) {
        ...
        if ((i.indexOf(e) < 0 && i.unshift(e), p(t).is(r))) n.apply(t, i);
          ...
          for (var a = p(t).parents(), s = 0; s < a.length; s += 1)
            p(a[s]).is(r) && n.apply(a[s], i);
      }
    }
    function o(e) {
      ...
      if (r)
        for (l = 0; l < d.length; l += 1) {
          ...
          (c.dom7LiveListeners || (c.dom7LiveListeners = {}),
            ...
            c.dom7LiveListeners[h].push({ listener: n, proxyListener: s }),
            c.addEventListener(h, s, a));
        }
      else
        for (l = 0; l < d.length; l += 1) {
          var h = d[l];
    ...
    for (var s = i.split(" "), o = 0; o < s.length; o += 1)
      for (var l = s[o], d = 0; d < this.length; d += 1) {
        ...
        if (
          (!r && u.dom7Listeners
            ? (c = u.dom7Listeners[l])
            : r && u.dom7LiveListeners && (c = u.dom7LiveListeners[l]),
          c && c.length)
        )
          for (var p = c.length - 1; p >= 0; p -= 1) {
            ...
            (n &&
              ...
              h.listener.dom7proxy === n)
              ? (u.removeEventListener(l, h.proxyListener, a), c.splice(p, 1))
              : n ||
                (u.removeEventListener(l, h.proxyListener, a), c.splice(p, 1));
          }
      }
  ...
  function C() {
    ...
    for (var i = e[0].split(" "), r = e[1], n = 0; n < i.length; n += 1)
      for (var a = i[n], s = 0; s < this.length; s += 1) {
        var l = this[s],
          u = void 0;
        try {
          u = new d.CustomEvent(a, { detail: r, bubbles: !0, cancelable: !0 });
        } catch (c) {
          ((u = o.createEvent("Event")),
            u.initEvent(a, !0, !0),
            (u.detail = r));
        }
  ...
  function M(e) {
    ...
    function n(a) {
      if (a.target === this)
        for (e.call(this, a), t = 0; t < i.length; t += 1) r.off(i[t], n);
    }
    if (e) for (t = 0; t < i.length; t += 1) r.on(i[t], n);
    return this;
  }
  function P(e) {
    if (this.length > 0) {
  ...
  function O(e) {
    for (var t = [], i = this, r = 0; r < i.length; r += 1)
      e.call(i[r], r, i[r]) && t.push(i[r]);
    return new c(t);
  }
  function I(e) {
  ...
  function G(e) {
    ...
    if ("string" === typeof e) {
      ...
      for (t = p(e), i = 0; i < t.length; i += 1) if (t[i] === r) return !0;
      return !1;
    }
    if (e === o) return r === o;
    if (e === d) return r === d;
    ...
    for (var r = 0; r < t.length; r += 1) {
      ...
      for (var n = 0; n < this.length; n += 1)
        if ("string" === typeof e) {
          ...
          a.innerHTML = e;
          while (a.firstChild) this[n].appendChild(a.firstChild);
  ...
  function j(e) {
    for (var t = [], i = 0; i < this.length; i += 1) {
      ...
      while (r) (e ? p(r).is(e) && t.push(r) : t.push(r), (r = r.parentNode));
    }
    return p(h(t));
  }
  function q(e) {
  ...
  function U(e) {
    for (var t = [], i = 0; i < this.length; i += 1)
      for (var r = this[i].childNodes, n = 0; n < r.length; n += 1)
        e
          ? 1 === r[n].nodeType && p(r[n]).is(e) && t.push(r[n])
  ...
  function Z() {
    ...
    for (i = 0; i < e.length; i += 1) {
      var a = p(e[i]);
      for (r = 0; r < a.length; r += 1) ((n[n.length] = a[r]), (n.length += 1));
    }
    return n;
  }
  ...
  var Q = {
      ...
      extend: function () {
        ...
        for (
          ...
          if (void 0 !== a && null !== a)
            for (
              var s = Object.keys(Object(a)).filter(function (e) {
              ...
              void 0 !== u &&
                u.enumerable &&
                (Q.isObject(i[d]) && Q.isObject(a[d])
                  ? Q.extend(i[d], a[d])
                  : !Q.isObject(i[d]) && Q.isObject(a[d])
                    ? ((i[d] = {}), Q.extend(i[d], a[d]))
                    : (i[d] = a[d]));
            }
        }
        return i;
    ...
    ee = (function () {
      return {
        ...
        observer: (function () {
          return "MutationObserver" in d || "WebkitMutationObserver" in d;
        })(),
      ...
      return (
        ...
        (e.prototype.once = function (e, t, i) {
          ...
          function n() {
            for (var i = [], a = 0; a < arguments.length; a++)
              i[a] = arguments[a];
            (r.off(e, n), n.f7proxy && delete n.f7proxy, t.apply(r, i));
          }
        ...
        (e.prototype.emit = function () {
          ...
          "string" === typeof e[0] || Array.isArray(e[0])
            ? ((i = e[0]), (r = e.slice(1, e.length)), (n = a))
            : ((i = e[0].events), (r = e[0].data), (n = e[0].context || a));
        ...
        (e.use = function (e) {
          ...
          return Array.isArray(e)
            ? (e.forEach(function (e) {
              ...
              r)
            : r.installModule.apply(r, (0, n.ev)([e], t));
        }),
        e
      );
    })();
  function ie() {
    var e,
      ...
      r = i.$el;
    ((e =
      "undefined" !== typeof i.params.width
        ? i.params.width
        : r[0].clientWidth),
      (t =
      ...
      (0 === e && i.isHorizontal()) ||
        ...
        Q.extend(i, { width: e, height: t, size: i.isHorizontal() ? e : t })));
  }
  function re() {
    var e = this,
      t = e.params,
      ...
      for (
        ...
        if (t.slidesPerColumn > 1) {
          ...
          if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
            var I = Math.floor(L / (t.slidesPerGroup * t.slidesPerColumn)),
              A = L - t.slidesPerColumn * t.slidesPerGroup * I,
              G =
                0 === I
                  ? t.slidesPerGroup
                  : Math.min(
                      Math.ceil((u - I * M * t.slidesPerGroup) / M),
                      t.slidesPerGroup,
                    );
            ((O = Math.floor(A / G)),
              (D = A - O * G + I * t.slidesPerGroup),
              ($ = D + (O * x) / M),
              z.css({
        ...
        if ("none" !== z.css("display")) {
          if ("auto" === t.slidesPerView) {
            var B = d.getComputedStyle(z[0], null),
              X = z[0].style.transform,
              Y = z[0].style.webkitTransform;
            if (
              (X && (z[0].style.transform = "none"),
              Y && (z[0].style.webkitTransform = "none"),
              t.roundLengths)
            )
              S = e.isHorizontal() ? z.outerWidth(!0) : z.outerHeight(!0);
            else if (e.isHorizontal()) {
              var W = parseFloat(B.getPropertyValue("width")),
              ...
              S = R && "border-box" === R ? W + F + N : W + H + V + F + N;
            } else {
              ...
              R = B.getPropertyValue("box-sizing");
              S = R && "border-box" === R ? j + U + K : j + q + _ + U + K;
            }
            (X && (z[0].style.transform = X),
              Y && (z[0].style.webkitTransform = Y),
              t.roundLengths && (S = Math.floor(S)));
          } else
            ((S = (r - (t.slidesPerView - 1) * w) / t.slidesPerView),
              t.roundLengths && (S = Math.floor(S)),
              l[L] &&
                (e.isHorizontal()
                  ? (l[L].style.width = S + "px")
                  : (l[L].style.height = S + "px")));
      ...
      if (
        ...
        for (L = 0; L < c.length; L += 1) {
          ...
          (t.roundLengths && (Z = Math.floor(Z)),
            c[L] < e.virtualSize + c[0] && C.push(Z));
        }
        c = C;
      }
      if (!t.centeredSlides) {
  ...
  function ne(e) {
    ...
    if (
      ...
      if (i.params.centeredSlides)
        i.visibleSlides.each(function (e, t) {
          r.push(t);
        });
      else
  ...
  function oe(e) {
    ...
    (0 === n
      ? ((a = 0), (s = !0), (o = !0))
      : ((a = (e - t.minTranslate()) / n), (s = a <= 0), (o = a >= 1)),
      Q.extend(t, { progress: a, isBeginning: s, isEnd: o }),
  ...
  function le() {
    ...
    r.loop && 0 === l.length && ((l = i.eq(0)), l.addClass(r.slideNextClass));
    var d = e
      .prevAll("." + r.slideClass)
      .eq(0)
      .addClass(r.slidePrevClass);
    (r.loop && 0 === d.length && ((d = i.eq(-1)), d.addClass(r.slidePrevClass)),
      r.loop &&
  ...
  function de(e) {
    ...
    if ("undefined" === typeof u) {
      for (var c = 0; c < n.length; c += 1)
        "undefined" !== typeof n[c + 1]
          ? r >= n[c] && r < n[c + 1] - (n[c + 1] - n[c]) / 2
            ? (u = c)
            : r >= n[c] && r < n[c + 1] && (u = c + 1)
          : r >= n[c] && (u = c);
  ...
  function he(e, t) {
    var i,
      ...
      u = 0,
      c = 0;
    (r.isHorizontal() ? (d = n ? -e : e) : (u = e),
      a.roundLengths && ((d = Math.floor(d)), (u = Math.floor(u))),
      a.cssMode
        ? (o[r.isHorizontal() ? "scrollLeft" : "scrollTop"] = r.isHorizontal()
            ? -d
            : -u)
        : a.virtualTranslate ||
          s.transform("translate3d(" + d + "px, " + u + "px, " + c + "px)"),
      (r.previousTranslate = r.translate),
      (r.translate = r.isHorizontal() ? d : u));
    var p = r.maxTranslate() - r.minTranslate();
    ((i = 0 === p ? 0 : (e - r.minTranslate()) / p),
      i !== l && r.updateProgress(e),
  ...
  function me(e, t, i, r, n) {
    ...
    return (
      0 === t
        ? (s.setTransition(0),
          s.setTranslate(d),
          i && (s.emit("beforeTransitionStart", t, n), s.emit("transitionEnd")))
        : (s.setTransition(t),
          s.setTranslate(d),
          i &&
            (s.emit("beforeTransitionStart", t, n), s.emit("transitionStart")),
          s.animating ||
            ((s.animating = !0),
  ...
  var Te = { setTransition: be, transitionStart: we, transitionEnd: ye };
  function Ee(e, t, i, r) {
    var n;
    (void 0 === e && (e = 0),
      void 0 === t && (t = this.params.speed),
    ...
    var v = Math.min(a.params.slidesPerGroupSkip, s),
      f = v + Math.floor((s - v) / a.params.slidesPerGroup);
    ...
    if ((a.updateProgress(g), o.normalizeSlideIndex))
      for (var b = 0; b < d.length; b += 1)
        -Math.floor(100 * g) >= Math.floor(100 * d[b]) && (s = b);
    ...
    if (o.cssMode) {
      var w = a.isHorizontal(),
        y = -g;
      return (
        p && (y = h.scrollWidth - h.offsetWidth - y),
        0 === t
  ...
  function Ce(e, t, i) {
    ...
    return (
      ...
      "undefined" !== typeof v &&
        ((h = o.indexOf(v)), h < 0 && (h = r.activeIndex - 1)),
      r.slideTo(h, e, t, i)
    );
  }
  function Me(e, t, i) {
  ...
  function Pe(e, t, i, r) {
    ...
    if (l >= n.snapGrid[o]) {
      var d = n.snapGrid[o],
        u = n.snapGrid[o + 1];
      l - d > (u - d) * r && (a += n.params.slidesPerGroup);
    } else {
      var c = n.snapGrid[o - 1];
      d = n.snapGrid[o];
      l - c <= (d - c) * r && (a -= n.params.slidesPerGroup);
    }
    return (
      (a = Math.max(a, 0)),
  ...
  function ze() {
    ...
    if (t.loopFillGroupWithBlank) {
      ...
      if (n !== t.slidesPerGroup) {
        for (var a = 0; a < n; a += 1) {
          var s = p(o.createElement("div")).addClass(
    ...
    r.each(function (t, i) {
      ...
      (t < e.loopedSlides && d.push(i),
        t < r.length && t >= r.length - e.loopedSlides && l.push(i),
        n.attr("data-swiper-slide-index", t));
    });
    for (a = 0; a < d.length; a += 1)
      i.append(p(d[a].cloneNode(!0)).addClass(t.slideDuplicateClass));
    for (a = l.length - 1; a >= 0; a -= 1)
      i.prepend(p(l[a].cloneNode(!0)).addClass(t.slideDuplicateClass));
  }
  function $e() {
    var e = this;
  ...
  var Oe = { loopCreate: ze, loopFix: $e, loopDestroy: De };
  function Ie(e) {
    var t = this;
    if (
      !(
  ...
  var Ge = { setGrabCursor: Ie, unsetGrabCursor: Ae };
  function Be(e) {
    var t = this,
      i = t.$wrapperEl,
      n = t.params;
    if ((n.loop && t.loopDestroy(), "object" === (0, r.Z)(e) && "length" in e))
      for (var a = 0; a < e.length; a += 1) e[a] && i.append(e[a]);
    else i.append(e);
    (n.loop && t.loopCreate(), (n.observer && ee.observer) || t.update());
  }
  function Xe(e) {
    var t = this,
      i = t.params,
    ...
    var s = a + 1;
    if ("object" === (0, r.Z)(e) && "length" in e) {
      for (var o = 0; o < e.length; o += 1) e[o] && n.prepend(e[o]);
      s = a + e.length;
    } else n.prepend(e);
    (i.loop && t.loopCreate(),
      (i.observer && ee.observer) || t.update(),
      t.slideTo(s, 0, !1));
  }
  function Ye(e, t) {
    var i = this,
    ...
    if (e <= 0) i.prependSlide(t);
      ...
      for (var d = o > e ? o + 1 : o, u = [], c = l - 1; c >= e; c -= 1) {
        var p = i.slides.eq(c);
        (p.remove(), u.unshift(p));
      }
      if ("object" === (0, r.Z)(t) && "length" in t) {
        for (c = 0; c < t.length; c += 1) t[c] && n.append(t[c]);
        d = o > e ? o + t.length : o;
      } else n.append(t);
      for (c = 0; c < u.length; c += 1) n.append(u[c]);
      (a.loop && i.loopCreate(),
        (a.observer && ee.observer) || i.update(),
  ...
  function We(e) {
    ...
    if ("object" === (0, r.Z)(e) && "length" in e) {
      for (var d = 0; d < e.length; d += 1)
        ((o = e[d]), t.slides[o] && t.slides.eq(o).remove(), o < l && (l -= 1));
      l = Math.max(l, 0);
    } else
      ((o = e),
  ...
  function Ne(e) {
    ...
    if (!t.animating || !r.preventInteractionOnTransition) {
      ...
      var s = p(a.target);
      if (
        ("wrapper" !== r.touchEventsTarget || s.closest(t.wrapperEl).length) &&
        ...
        if (
          ...
          if (!c || !(l <= h || l >= d.screen.width - h)) {
            if (
              ...
              var v = !0;
              (s.is(i.formElements) && (v = !1),
                o.activeElement &&
                  p(o.activeElement).is(i.formElements) &&
                  o.activeElement !== s[0] &&
                  o.activeElement.blur());
              var f = v && t.allowTouchMove && r.touchStartPreventDefault;
      ...
      if (!i.isTouchEvent || "touchmove" === s.type) {
        ...
        if (!t.allowTouchMove)
          return (
            ...
            void (
              i.isTouched &&
              (Q.extend(n, { startX: d, startY: u, currentX: d, currentY: u }),
              (i.touchStartTime = Q.now()))
            )
          );
        ...
        if (
          ...
          p(s.target).is(i.formElements)
        )
          return ((i.isMoved = !0), void (t.allowClick = !1));
        if (
          (i.allowTouchCallbacks && t.emit("touchMove", s),
          ...
          if (
            !(
              t.params.threshold &&
              Math.sqrt(Math.pow(c, 2) + Math.pow(h, 2)) < t.params.threshold
            )
          ) {
                  ...
                  ? ((m = !1),
                    r.resistance &&
                      (i.currentTranslate =
                        t.minTranslate() -
                        1 +
                        Math.pow(-t.minTranslate() + i.startTranslate + f, g)))
                  : f < 0 &&
                    ...
                    r.resistance &&
                      (i.currentTranslate =
                        t.maxTranslate() +
                        1 -
                        Math.pow(t.maxTranslate() - i.startTranslate - f, g))),
  ...
  function je(e) {
    ...
    if (
      ...
      if (r.freeMode) {
        ...
        for (
          var k = 0, L = t.slidesSizesGrid[0], z = 0;
          z < o.length;
          z += z < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup
        ) {
          var $ = z < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
          "undefined" !== typeof o[z + $]
            ? u >= o[z] && u < o[z + $] && ((k = z), (L = o[z + $] - o[z]))
            : u >= o[z] && ((k = z), (L = o[o.length - 1] - o[o.length - 2]));
        }
        var D = (u - o[k]) / L,
          O = k < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
        if (p > r.longSwipesMs) {
          if (!r.longSwipes) return void t.slideTo(t.activeIndex);
          ("next" === t.swipeDirection &&
            (D >= r.longSwipesRatio ? t.slideTo(k + O) : t.slideTo(k)),
            "prev" === t.swipeDirection &&
              (D > 1 - r.longSwipesRatio ? t.slideTo(k + O) : t.slideTo(k)));
        } else {
  ...
  function Je() {
    ...
    ((e.onTouchStart = Ne.bind(e)),
      ...
      t.cssMode && (e.onScroll = Ue.bind(e)),
      (e.onClick = _e.bind(e)));
    var a = !!t.nested;
    if (!ee.touch && ee.pointerEvents)
      (r.addEventListener(i.start, e.onTouchStart, !1),
        o.addEventListener(i.move, e.onTouchMove, a),
      ...
      if (ee.touch) {
        ...
        (r.addEventListener(i.start, e.onTouchStart, s),
          r.addEventListener(
            i.move,
            e.onTouchMove,
            ee.passiveListener ? { passive: !1, capture: a } : a,
          ),
          r.addEventListener(i.end, e.onTouchEnd, s),
          i.cancel && r.addEventListener(i.cancel, e.onTouchEnd, s),
          Ke || (o.addEventListener("touchstart", Ze), (Ke = !0)));
      }
      ((t.simulateTouch && !Fe.ios && !Fe.android) ||
        (t.simulateTouch && !ee.touch && Fe.ios)) &&
    ...
    if (!ee.touch && ee.pointerEvents)
      ...
      if (ee.touch) {
        ...
        (r.removeEventListener(i.start, e.onTouchStart, s),
          ...
          i.cancel && r.removeEventListener(i.cancel, e.onTouchEnd, s));
      }
      ((t.simulateTouch && !Fe.ios && !Fe.android) ||
        (t.simulateTouch && !ee.touch && Fe.ios)) &&
  ...
  var et = { attachEvents: Je, detachEvents: Qe };
  function tt() {
    var e = this,
      t = e.activeIndex,
      i = e.initialized,
  ...
  var rt = { setBreakpoint: tt, getBreakpoint: it };
  function nt() {
    var e = this,
      t = e.classNames,
      i = e.params,
  ...
  var st = { addClasses: nt, removeClasses: at };
  function ot(e, t, i, r, n, a) {
    var s;
    function o() {
      a && a();
    }
    var l = p(e).parent("picture")[0];
    l || (e.complete && n)
      ? o()
      : t
        ? ((s = new d.Image()),
  ...
  var dt = { loadImage: ot, preloadImages: lt };
  function ut() {
    var e = this,
      t = e.params,
      i = e.isLocked,
  ...
  var ct = { checkOverflow: ut },
    ...
    ft = (function (e) {
      function t() {
        ...
        (1 === i.length && i[0].constructor && i[0].constructor === Object
          ...
          Object.keys(ht).forEach(function (e) {
            Object.keys(ht[e]).forEach(function (i) {
              t.prototype[i] || (t.prototype[i] = ht[e][i]);
            });
          }));
        var l = o;
        ...
        (l.useModulesParams(d),
          (l.params = Q.extend({}, d, vt, s)),
          (l.originalParams = Q.extend({}, l.params)),
          (l.passedParams = Q.extend({}, s)),
          (l.$ = p));
        var u = p(l.params.el);
        if (((a = u[0]), a)) {
          if (u.length > 1) {
          ...
          return (
            ...
            a && a.shadowRoot && a.shadowRoot.querySelector
              ? ((h = p(
                  a.shadowRoot.querySelector("." + l.params.wrapperClass),
                )),
            ...
            Q.extend(l, {
              ...
              rtl:
                "rtl" === a.dir.toLowerCase() || "rtl" === u.css("direction"),
              rtlTranslate:
              ...
              touchEvents: (function () {
                ...
                return (
                  ...
                  ee.touch || !l.params.simulateTouch
                    ? l.touchEventsTouch
                    : l.touchEventsDesktop
                );
              })(),
      ...
      return (
        ...
        (t.prototype.slidesPerViewDynamic = function () {
          ...
          if (t.centeredSlides) {
            for (
              var o = i[a].swiperSlideSize, l = void 0, d = a + 1;
              d < i.length;
              d += 1
            )
              i[d] &&
                !l &&
                ((o += i[d].swiperSlideSize), (s += 1), o > n && (l = !0));
            for (d = a - 1; d >= 0; d -= 1)
              i[d] &&
                !l &&
                ((o += i[d].swiperSlideSize), (s += 1), o > n && (l = !0));
          } else
            for (d = a + 1; d < i.length; d += 1) r[d] - r[a] < n && (s += 1);
          return s;
        }),
    ...
    mt = { name: "device", proto: { device: Fe }, static: { device: Fe } },
    gt = { name: "support", proto: { support: ee }, static: { support: ee } },
    bt = (function () {
      function e() {
    ...
    wt = { name: "browser", proto: { browser: bt }, static: { browser: bt } },
    yt = {
      name: "resize",
      create: function () {
        var e = this;
      ...
      on: {
        init: function () {
          var e = this;
          (d.addEventListener("resize", e.resize.resizeHandler),
            d.addEventListener(
              "orientationchange",
        ...
        destroy: function () {
          var e = this;
          (d.removeEventListener("resize", e.resize.resizeHandler),
    ...
    Tt = {
      ...
      init: function () {
        var e = this;
        if (ee.observer && e.params.observer) {
    ...
    xt = {
      ...
      enable: function () {
        var e = this;
        e.keyboard.enabled ||
          (p(o).on("keydown", e.keyboard.handle), (e.keyboard.enabled = !0));
      },
      disable: function () {
        var e = this;
        e.keyboard.enabled &&
          (p(o).off("keydown", e.keyboard.handle), (e.keyboard.enabled = !1));
      },
    },
    St = {
      name: "keyboard",
      ...
      create: function () {
        ...
        Q.extend(e, {
          keyboard: {
            enabled: !1,
            enable: xt.enable.bind(e),
            disable: xt.disable.bind(e),
            handle: xt.handle.bind(e),
          },
        });
      },
      on: {
  ...
  function Ct() {
    ...
    return (
      !t &&
        ...
        (t = o.implementation.hasFeature("Events.wheel", "3.0")),
      t
    );
  }
  var Mt = {
      ...
      recentWheelEvents: [],
      event: function () {
        return d.navigator.userAgent.indexOf("firefox") > -1
          ? "DOMMouseScroll"
          : Ct()
            ? "wheel"
            : "mousewheel";
      ...
      normalize: function (e) {
        ...
        return (
          ...
          (s || o) &&
            e.deltaMode &&
            (1 === e.deltaMode ? ((s *= i), (o *= i)) : ((s *= r), (o *= r))),
          s && !n && (n = s < 1 ? -1 : 1),
          o && !a && (a = o < 1 ? -1 : 1),
          { spinX: n, spinY: a, pixelX: s, pixelY: o }
        );
      },
      ...
      handle: function (e) {
        ...
        if (
          ...
          !i.mouseEntered && !n[0].contains(t.target) && !r.releaseOnEdges)
        )
          return !0;
        ...
        if (r.forceToAxis)
          ...
          a =
            Math.abs(o.pixelX) > Math.abs(o.pixelY) ? -o.pixelX * s : -o.pixelY;
        if (0 === a) return !0;
        if ((r.invert && (a = -a), i.params.freeMode)) {
          ...
          if (!u) {
            ...
            var c = i.getTranslate() + a * r.sensitivity,
              h = i.isBeginning,
              v = i.isEnd;
            if (
              ...
              f.length >= 15 && f.shift();
              y = f.length ? f[f.length - 1] : void 0;
              var m = f[0];
              if (
                (f.push(l),
                y && (l.delta > y.delta || l.direction !== y.direction))
              )
                f.splice(0);
              else if (
                f.length >= 15 &&
      ...
      animateSlider: function (e) {
        var t = this;
        return (
          (e.delta >= 6 && Q.now() - t.mousewheel.lastScrollTime < 60) ||
          (e.direction < 0
        ...
        if (
          ...
          if (
            ...
            if (
              (i.dynamicBullets &&
                ...
                (l = o + (Math.min(d.length, i.dynamicMainBullets) - 1)),
                (u = (l + o) / 2)),
              d.removeClass(
                i.bulletActiveClass +
                  " " +
          ...
          if (
            ("fraction" === i.type &&
              ...
              a.find("." + i.totalClass).text(i.formatFractionTotal(s))),
            "progressbar" === i.type)
          ) {
            var y = void 0;
      ...
      init: function () {
        ...
        if (t.el) {
          ...
          0 !== i.length &&
            ...
            Q.extend(e.pagination, { $el: i, el: i[0] }));
        }
      },
      destroy: function () {
        var e = this,
      ...
      enableDraggable: function () {
        ...
        if (e.params.scrollbar.el) {
          var t = e.scrollbar,
            ...
            a = t.$el,
            s = a[0],
            l = !(!ee.passiveListener || !n.passiveListeners) && {
              passive: !1,
              capture: !1,
            },
            d = !(!ee.passiveListener || !n.passiveListeners) && {
              passive: !0,
              capture: !1,
            };
          ee.touch
            ? (s.addEventListener(i.start, e.scrollbar.onDragStart, l),
              ...
              s.addEventListener(i.end, e.scrollbar.onDragEnd, d))
            : (s.addEventListener(r.start, e.scrollbar.onDragStart, l),
              o.addEventListener(r.move, e.scrollbar.onDragMove, l),
              o.addEventListener(r.end, e.scrollbar.onDragEnd, d));
        }
      },
        ...
        if (e.params.scrollbar.el) {
          ...
          ee.touch
            ? (s.removeEventListener(i.start, e.scrollbar.onDragStart, l),
              ...
              s.removeEventListener(i.end, e.scrollbar.onDragEnd, d))
            : (s.removeEventListener(r.start, e.scrollbar.onDragStart, l),
              o.removeEventListener(r.move, e.scrollbar.onDragMove, l),
              o.removeEventListener(r.end, e.scrollbar.onDragEnd, d));
        }
      },
      init: function () {
        var e = this;
      ...
      create: function () {
        ...
        Q.extend(e, {
          scrollbar: {
            ...
            updateSize: Lt.updateSize.bind(e),
            setTranslate: Lt.setTranslate.bind(e),
            setTransition: Lt.setTransition.bind(e),
            enableDraggable: Lt.enableDraggable.bind(e),
            disableDraggable: Lt.disableDraggable.bind(e),
            setDragPosition: Lt.setDragPosition.bind(e),
            getPointerPosition: Lt.getPointerPosition.bind(e),
            onDragStart: Lt.onDragStart.bind(e),
            onDragMove: Lt.onDragMove.bind(e),
            onDragEnd: Lt.onDragEnd.bind(e),
            isTouched: !1,
            timeout: null,
            dragTimeout: null,
          },
    ...
    $t = {
      ...
      onGestureStart: function (e) {
        var t = this,
          ...
          n = r.gesture;
        if (
          ((r.fakeGestureTouched = !1), (r.fakeGestureMoved = !1), !ee.gestures)
        ) {
          if (
            "touchstart" !== e.type ||
          ...
          ((r.fakeGestureTouched = !0),
            (n.scaleStart = $t.getDistanceBetweenTouches(e)));
        }
        (n.$slideEl && n.$slideEl.length) ||
        ((n.$slideEl = p(e.target).closest("." + t.params.slideClass)),
      ...
      onGestureChange: function (e) {
        ...
        if (!ee.gestures) {
          ...
          ((r.fakeGestureMoved = !0),
            (n.scaleMove = $t.getDistanceBetweenTouches(e)));
        }
        n.$imageEl &&
          0 !== n.$imageEl.length &&
          (ee.gestures
            ? (r.scale = e.scale * r.currentScale)
            : (r.scale = (n.scaleMove / n.scaleStart) * r.currentScale),
          r.scale > n.maxRatio &&
            (r.scale =
              n.maxRatio - 1 + Math.pow(r.scale - n.maxRatio + 1, 0.5)),
          r.scale < i.minRatio &&
            (r.scale =
      ...
      onGestureEnd: function (e) {
        ...
        n.$imageEl &&
          0 !== n.$imageEl.length &&
          ((r.scale = Math.max(Math.min(r.scale, n.maxRatio), i.minRatio)),
          n.$imageEl
      ...
      onTouchStart: function (e) {
        ...
        r.$imageEl &&
          0 !== r.$imageEl.length &&
          (n.isTouched ||
            (Fe.android && e.cancelable && e.preventDefault(),
            (n.isTouched = !0),
            (n.touchesStart.x =
      ...
      onTouchMove: function (e) {
        ...
        if (
          ...
          n.isMoved ||
            ...
            (n.startX = Q.getTranslate(r.$imageWrapEl[0], "x") || 0),
            (n.startY = Q.getTranslate(r.$imageWrapEl[0], "y") || 0),
          ...
          if (!(s < r.slideWidth && o < r.slideHeight)) {
            if (
              ((n.minX = Math.min(r.slideWidth / 2 - s / 2, 0)),
              (n.maxX = -n.minX),
              (n.minY = Math.min(r.slideHeight / 2 - o / 2, 0)),
              (n.maxY = -n.minY),
              (n.touchesCurrent.x =
      ...
      onTouchEnd: function () {
        ...
        if (i.$imageEl && 0 !== i.$imageEl.length) {
          ...
          var a = 300,
            ...
            d = n.y * s,
            u = r.currentY + d;
          (0 !== n.x && (a = Math.abs((l - r.currentX) / n.x)),
            0 !== n.y && (s = Math.abs((u - r.currentY) / n.y)));
          var c = Math.max(a, s);
          ...
          ((r.minX = Math.min(i.slideWidth / 2 - p / 2, 0)),
            (r.maxX = -r.minX),
            (r.minY = Math.min(i.slideHeight / 2 - h / 2, 0)),
            (r.maxY = -r.minY),
      ...
      in: function (e) {
        ...
        (E.$slideEl ||
          (w.params.virtual && w.params.virtual.enabled && w.virtual
            ? (E.$slideEl = w.$wrapperEl.children(
                "." + w.params.slideActiveClass,
              ))
            : (E.$slideEl = w.slides.eq(w.activeIndex)),
          (E.$imageEl = E.$slideEl.find(
            "img, svg, canvas, picture, .swiper-zoom-target",
          )),
          (E.$imageWrapEl = E.$imageEl.parent("." + T.containerClass))),
        E.$imageEl && 0 !== E.$imageEl.length) &&
          (E.$slideEl.addClass("" + T.zoomedSlideClass),
          "undefined" === typeof x.touchesStart.x && e
            ? ((t =
                "touchend" === e.type ? e.changedTouches[0].pageX : e.pageX),
              (i = "touchend" === e.type ? e.changedTouches[0].pageY : e.pageY))
            : ((t = x.touchesStart.x), (i = x.touchesStart.y)),
          (y.scale = E.$imageWrapEl.attr("data-swiper-zoom") || T.maxRatio),
          (y.currentScale =
            E.$imageWrapEl.attr("data-swiper-zoom") || T.maxRatio),
          e
            ? ((g = E.$slideEl[0].offsetWidth),
              (b = E.$slideEl[0].offsetHeight),
              (r = E.$slideEl.offset().left),
              (n = E.$slideEl.offset().top),
              (a = r + g / 2 - t),
              (s = n + b / 2 - i),
              (d = E.$imageEl[0].offsetWidth),
              (u = E.$imageEl[0].offsetHeight),
              (c = d * y.scale),
              (p = u * y.scale),
              (h = Math.min(g / 2 - c / 2, 0)),
      ...
      enable: function () {
        ...
        if (!t.enabled) {
          ...
          var i = !(
            ...
            r = !ee.passiveListener || { passive: !1, capture: !0 },
          ...
          (ee.gestures
            ...
            : "touchstart" === e.touchEvents.start &&
              ...
              e.$wrapperEl.on(e.touchEvents.move, n, t.onGestureChange, r),
    ...
    At = [mt, gt, wt, yt, Et];
  ("undefined" === typeof ft.use &&
    ((ft.use = ft.Class.use), (ft.installModule = ft.Class.installModule)),
    ft.use(At),
    ft.use([kt, zt, It, St, Dt]));
};
