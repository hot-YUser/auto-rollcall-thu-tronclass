// Source: decompiled/web-modules-acorn/chunk-vendors-af4e84d4.50b2eb4a/50774.js
// Webpack module id: 50774
const __webpack_module_50774 = function (t, e, i) {
  (i.r(e),
    i.d(e, {
      ion_item: function () {
        return p;
      },
      ion_item_divider: function () {
        return g;
      },
      ...
      ion_list_header: function () {
        return E;
      },
      ion_note: function () {
        return T;
      },
      ion_skeleton_text: function () {
        return O;
      },
    }));
  (i(51532),
  ...
  var n = i(70655),
    ...
    p = (function () {
      ...
      return (
        (t.prototype.labelColorChanged = function (t) {
          var e = this.color;
        ...
        (t.prototype.itemStyle = function (t) {
          ...
          (Object.keys(i).forEach(function (t) {
            ...
            a || Object.keys(n).length === Object.keys(r).length || (a = !0),
            a && (this.itemStyles.set(e, n), (0, o.j)(this)));
        }),
        (t.prototype.componentDidUpdate = function () {
          var t = this,
            e = this.getFirstInput();
          e &&
            !this.clickListener &&
            ((this.clickListener = function (i) {
              return t.delegateFocus(i, e);
            }),
            this.el.addEventListener("click", this.clickListener));
        }),
        (t.prototype.disconnectedCallback = function () {
          var t = this.getFirstInput();
          t &&
            this.clickListener &&
        ...
        (t.prototype.componentDidLoad = function () {
          var t = this;
          (0, a.r)(function () {
            (t.setMultipleInputs(), (t.focusable = t.isFocusable()));
          });
        }),
        ...
        (t.prototype.hasCover = function () {
          ...
          return 1 === t.length && !this.multipleInputs;
        }),
        ...
        (t.prototype.isFocusable = function () {
          var t = this.el.querySelector(".ion-focusable");
          return this.canActivate() || null !== t;
        }),
        (t.prototype.getFirstInput = function () {
          var t = this.el.querySelectorAll("ion-input, ion-textarea");
          return t[0];
        }),
        (t.prototype.delegateFocus = function (t, e) {
          var i = "ION-ITEM" === t.target.tagName,
            n = !1;
          (document.activeElement &&
            (n = e.querySelector("input, textarea") === document.activeElement),
            i &&
              n &&
              ((e.fireFocusEvents = !1),
              e.setBlur(),
        ...
        (t.prototype.render = function () {
          var t,
            ...
            v = this.isClickable(),
            x = this.canActivate(),
            w = v ? (void 0 === p ? "button" : "a") : "div",
            k =
              "button" === w
                ? { type: this.type }
                : { download: a, href: p, rel: h, target: u },
            y = v
              ? {
                  onClick: function (t) {
                    (0, s.o)(p, t, b, g);
              ...
              : {},
            C = void 0 !== i ? i : "ios" === f && v;
          this.itemStyles.forEach(function (t) {
            Object.assign(m, t);
          });
          var z = c || m["item-interactive-disabled"] ? "true" : null;
          return (0, o.h)(
            o.H,
            {
              "aria-disabled": z,
              class: Object.assign(
                ...
                (0, s.c)(
                  ...
                  ((t = { item: !0 }),
                  (t[f] = !0),
                  (t["item-lines-" + d] = void 0 !== d),
                  (t["item-disabled"] = c),
                  (t["in-list"] = (0, s.h)("ion-list", this.el)),
                  (t["item-multiple-inputs"] = this.multipleInputs),
                  (t["ion-activatable"] = x),
                  (t["ion-focusable"] = this.focusable),
                  t),
                ),
              ),
            },
            (0, o.h)(
              ...
              Object.assign(
                {},
                k,
                { class: "item-native", part: "native", disabled: c },
                y,
              ),
              (0, o.h)("slot", { name: "start" }),
              (0, o.h)(
                "div",
                { class: "item-inner" },
                (0, o.h)(
                ...
                (0, o.h)("div", { class: "item-inner-highlight" }),
              ),
              x && "md" === f && (0, o.h)("ion-ripple-effect", null),
            ),
            (0, o.h)("div", { class: "item-highlight" }),
          );
        }),
          ...
          return (0, o.h)(
            o.H,
            {
              class: (0, s.c)(
                ...
                ((t = {}),
                (t[e] = !0),
                (t["item-divider-sticky"] = this.sticky),
                (t["item"] = !0),
                t),
              ),
            },
  ...
  g.style = { ios: h, md: u };
  var b = "ion-item-group{display:block}",
    m = "ion-item-group{display:block}",
    f = (function () {
      function t(t) {
        (0, o.r)(this, t);
      }
  ...
  var v =
    ...
    w = (function () {
      function t(t) {
        ((0, o.r)(this, t),
          (this.ionColor = (0, o.e)(this, "ionColor", 7)),
          (this.ionStyle = (0, o.e)(this, "ionStyle", 7)),
          (this.inRange = !1),
          (this.noAnimate = !1));
      }
      return (
        ...
        (t.prototype.emitColor = function () {
          var t,
            e = this.color;
          this.ionColor.emit(
            ((t = { "item-label-color": void 0 !== e }),
            (t["ion-color-" + e] = void 0 !== e),
            t),
          );
        }),
        (t.prototype.emitStyle = function () {
          ...
          i ||
            this.ionStyle.emit(
              ((t = { label: !0 }), (t["label-" + n] = void 0 !== n), t),
            );
        }),
        (t.prototype.render = function () {
          var t,
          ...
          return (0, o.h)(o.H, {
            class: (0, s.c)(
              ...
              ((t = {}),
              (t[i] = !0),
              (t["in-item-color"] = (0, s.h)("ion-item.ion-color", this.el)),
              (t["label-" + e] = void 0 !== e),
              (t["label-no-animate"] = this.noAnimate),
              t),
            ),
          });
        }),
  ...
  var k =
    ...
    C = (function () {
      function t(t) {
        ((0, o.r)(this, t), (this.inset = !1));
      }
      return (
        (t.prototype.closeSlidingItems = function () {
          return (0, n.mG)(this, void 0, void 0, function () {
            var t;
            return (0, n.Jh)(this, function (e) {
              return (
                (t = this.el.querySelector("ion-item-sliding")),
                t && t.closeOpened ? [2, t.closeOpened()] : [2, !1]
              );
            });
          });
        }),
        (t.prototype.render = function () {
          ...
          return (0, o.h)(o.H, {
            class:
              ...
              (t["list-" + e] = !0),
              (t["list-inset"] = a),
              (t["list-lines-" + n] = void 0 !== n),
              (t["list-" + e + "-lines-" + n] = void 0 !== n),
              t),
          });
        }),
        Object.defineProperty(t.prototype, "el", {
          ...
          return (0, o.h)(
            o.H,
            {
              class: (0, s.c)(
                ...
                ((t = {}),
                (t[i] = !0),
                (t["list-header-lines-" + e] = void 0 !== e),
                t),
              ),
            },
            (0, o.h)(
    ...
    T = (function () {
      ...
      return (
        (t.prototype.render = function () {
          ...
          return (0, o.h)(
            o.H,
            { class: (0, s.c)(this.color, ((t = {}), (t[e] = !0), t)) },
            (0, o.h)("slot", null),
          );
        }),
        t
  ...
  var I =
    ...
    O = (function () {
      function t(t) {
        ((0, o.r)(this, t), (this.animated = !1));
      }
      return (
        (t.prototype.render = function () {
          var t,
            e = this.animated && l.b.getBoolean("animated", !0),
            i =
              (0, s.h)("ion-avatar", this.el) ||
