...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public final GoogleApiClient build() {
            ...
            zaaw zaawVar = new zaaw(this.mContext, new ReentrantLock(), this.zabj, clientSettingsBuildClientSettings, this.zacd, this.zace, arrayMap, this.zacf, this.zacg, arrayMap2, this.zacb, zaaw.zaa(arrayMap2.values(), true), arrayList, false);
