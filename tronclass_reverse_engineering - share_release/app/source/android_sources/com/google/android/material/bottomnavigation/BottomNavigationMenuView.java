...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.itemHeight, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i10], Videoio.CAP_OPENNI_IMAGE_GENERATOR), iMakeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                measuredWidth += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(measuredWidth, View.MeasureSpec.makeMeasureSpec(measuredWidth, Videoio.CAP_OPENNI_IMAGE_GENERATOR), 0), View.resolveSizeAndState(this.itemHeight, iMakeMeasureSpec, 0));
    }
