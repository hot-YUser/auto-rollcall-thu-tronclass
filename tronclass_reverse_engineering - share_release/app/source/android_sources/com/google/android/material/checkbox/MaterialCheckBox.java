...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet, int i) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.MaterialCheckBox_buttonTint)) {
            CompoundButtonCompat.setButtonTintList(this, MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, R.styleable.MaterialCheckBox_buttonTint));
        }
