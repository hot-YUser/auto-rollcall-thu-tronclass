...
public class MaterialRadioButton extends AppCompatRadioButton {
    ...
    public MaterialRadioButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MaterialRadioButton, i, i2, new int[0]);
