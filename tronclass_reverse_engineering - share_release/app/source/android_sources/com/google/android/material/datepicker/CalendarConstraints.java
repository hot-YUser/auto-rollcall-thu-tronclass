...
public final class CalendarConstraints implements Parcelable {
    ...
    public static final class Builder {
        ...
        static final long DEFAULT_START = UtcDates.canonicalYearMonthDay(Month.create(Videoio.CAP_FFMPEG, 0).timeInMillis);
        static final long DEFAULT_END = UtcDates.canonicalYearMonthDay(Month.create(Videoio.CAP_ARAVIS, 11).timeInMillis);
