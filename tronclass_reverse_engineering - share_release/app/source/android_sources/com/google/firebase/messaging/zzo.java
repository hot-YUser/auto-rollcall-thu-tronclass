...
public final class zzo {
    ...
    private static void zza(String str, Intent intent) {
        ...
        if (Log.isLoggable("FirebaseMessaging", 3)) {
            ...
            Log.d("FirebaseMessaging", new StringBuilder(String.valueOf(str).length() + 37 + String.valueOf(strValueOf).length()).append("Logging to scion event=").append(str).append(" scionPayload=").append(strValueOf).toString());
        }
        AnalyticsConnector analyticsConnector = (AnalyticsConnector) FirebaseApp.getInstance().get(AnalyticsConnector.class);
        if (analyticsConnector == null) {
