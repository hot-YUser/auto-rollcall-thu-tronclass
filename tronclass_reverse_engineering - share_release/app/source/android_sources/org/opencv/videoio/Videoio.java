...
public class Videoio {
    ...
    public static final int CAP_OBSENSOR = 2600;
    public static final int CAP_OBSENSOR_BGR_IMAGE = 1;
    public static final int CAP_OBSENSOR_DEPTH_GENERATOR = 536870912;
    public static final int CAP_OBSENSOR_DEPTH_MAP = 0;
    public static final int CAP_OBSENSOR_GENERATORS_MASK = 939524096;
    public static final int CAP_OBSENSOR_IMAGE_GENERATOR = 268435456;
    public static final int CAP_OBSENSOR_IR_GENERATOR = 134217728;
    public static final int CAP_OBSENSOR_IR_IMAGE = 2;
    ...
    public static final int CAP_OPENNI2_ASTRA = 1620;
    ...
    public static final int CAP_PROP_ARAVIS_AUTOTRIGGER = 600;
    public static final int CAP_PROP_AUDIO_BASE_INDEX = 63;
    public static final int CAP_PROP_AUDIO_DATA_DEPTH = 61;
    public static final int CAP_PROP_AUDIO_POS = 59;
    public static final int CAP_PROP_AUDIO_SAMPLES_PER_SECOND = 62;
    public static final int CAP_PROP_AUDIO_SHIFT_NSEC = 60;
    public static final int CAP_PROP_AUDIO_STREAM = 58;
    public static final int CAP_PROP_AUDIO_SYNCHRONIZE = 66;
    public static final int CAP_PROP_AUDIO_TOTAL_CHANNELS = 64;
    public static final int CAP_PROP_AUDIO_TOTAL_STREAMS = 65;
    ...
    public static final int CAP_PROP_BITRATE = 47;
    ...
    public static final int CAP_PROP_CODEC_EXTRADATA_INDEX = 68;
    public static final int CAP_PROP_CODEC_PIXEL_FORMAT = 46;
    ...
    public static final int CAP_PROP_FRAME_TYPE = 69;
    ...
    public static final int CAP_PROP_HW_ACCELERATION = 50;
    public static final int CAP_PROP_HW_ACCELERATION_USE_OPENCL = 52;
    public static final int CAP_PROP_HW_DEVICE = 51;
    ...
    public static final int CAP_PROP_LRF_HAS_KEY_FRAME = 67;
    public static final int CAP_PROP_MODE = 9;
    public static final int CAP_PROP_MONOCHROME = 19;
    public static final int CAP_PROP_N_THREADS = 70;
    public static final int CAP_PROP_OBSENSOR_INTRINSIC_CX = 26003;
    public static final int CAP_PROP_OBSENSOR_INTRINSIC_CY = 26004;
    public static final int CAP_PROP_OBSENSOR_INTRINSIC_FX = 26001;
    public static final int CAP_PROP_OBSENSOR_INTRINSIC_FY = 26002;
    ...
    public static final int CAP_PROP_OPEN_TIMEOUT_MSEC = 53;
    public static final int CAP_PROP_ORIENTATION_AUTO = 49;
    public static final int CAP_PROP_ORIENTATION_META = 48;
    ...
    public static final int CAP_PROP_READ_TIMEOUT_MSEC = 54;
    ...
    public static final int CAP_PROP_STREAM_OPEN_TIME_USEC = 55;
    ...
    public static final int CAP_PROP_VIDEO_STREAM = 57;
    public static final int CAP_PROP_VIDEO_TOTAL_CHANNELS = 56;
    ...
    public static final int CAP_REALSENSE = 1500;
    public static final int CAP_UEYE = 2500;
    ...
    public static final int VIDEOWRITER_PROP_DEPTH = 5;
    public static final int VIDEOWRITER_PROP_FRAMEBYTES = 2;
    public static final int VIDEOWRITER_PROP_HW_ACCELERATION = 6;
    public static final int VIDEOWRITER_PROP_HW_ACCELERATION_USE_OPENCL = 8;
    public static final int VIDEOWRITER_PROP_HW_DEVICE = 7;
    public static final int VIDEOWRITER_PROP_IS_COLOR = 4;
    public static final int VIDEOWRITER_PROP_KEY_FLAG = 11;
    public static final int VIDEOWRITER_PROP_KEY_INTERVAL = 10;
    public static final int VIDEOWRITER_PROP_NSTRIPES = 3;
    public static final int VIDEOWRITER_PROP_QUALITY = 1;
    public static final int VIDEOWRITER_PROP_RAW_VIDEO = 9;
    public static final int VIDEO_ACCELERATION_ANY = 1;
    public static final int VIDEO_ACCELERATION_D3D11 = 2;
    public static final int VIDEO_ACCELERATION_MFX = 4;
    public static final int VIDEO_ACCELERATION_NONE = 0;
    public static final int VIDEO_ACCELERATION_VAAPI = 3;

    private static native String getBackendName_0(int i);

    private static native String getCameraBackendPluginVersion_0(int i, double[] dArr, double[] dArr2);

    private static native String getStreamBackendPluginVersion_0(int i, double[] dArr, double[] dArr2);

    private static native String getWriterBackendPluginVersion_0(int i, double[] dArr, double[] dArr2);

    private static native boolean hasBackend_0(int i);

    private static native boolean isBackendBuiltIn_0(int i);

    public static String getBackendName(int i) {
        return getBackendName_0(i);
    }

    public static boolean hasBackend(int i) {
        return hasBackend_0(i);
    }

    public static boolean isBackendBuiltIn(int i) {
        return isBackendBuiltIn_0(i);
    }

    public static String getCameraBackendPluginVersion(int i, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        String cameraBackendPluginVersion_0 = getCameraBackendPluginVersion_0(i, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
        ...
        return cameraBackendPluginVersion_0;
    }

    public static String getStreamBackendPluginVersion(int i, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        String streamBackendPluginVersion_0 = getStreamBackendPluginVersion_0(i, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
        ...
        return streamBackendPluginVersion_0;
    }

    public static String getWriterBackendPluginVersion(int i, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        String writerBackendPluginVersion_0 = getWriterBackendPluginVersion_0(i, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
        ...
        return writerBackendPluginVersion_0;
    }
}
