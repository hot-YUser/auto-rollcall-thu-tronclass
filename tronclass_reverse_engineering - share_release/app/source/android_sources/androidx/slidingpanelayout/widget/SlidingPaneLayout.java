...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:40:0x00af A[PHI: r13
  0x00af: PHI (r13v2 float) = (r13v1 float), (r13v3 float) binds: [B:36:0x00a4, B:38:0x00ab] A[DONT_GENERATE, DONT_INLINE]] */
    /* high-level source view WARN: Removed duplicated region for block: B:73:0x0140  */
    ...
    */
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width != 0) {
                    ...
                    if (layoutParams.width == -2) {
                        ...
                        iMakeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i8, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                    } else {
                        iMakeMeasureSpec3 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                    }
                    if (layoutParams.height == -2) {
                        iMakeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE);
                    } else if (layoutParams.height == -1) {
                        iMakeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingTop, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                    } else {
                        iMakeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                    }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width == 0) {
                                    if (layoutParams2.height == -2) {
                                        ...
                                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingTop, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                                    } else {
                                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                                    }
                                } else {
                                    iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                                }
                                if (z2) {
                                    int i11 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i4 = i9;
                                    int iMakeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(i11, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                                    if (measuredWidth2 != i11) {
                                        childAt2.measure(iMakeMeasureSpec5, iMakeMeasureSpec);
                                    }
                                } else {
                                    i4 = i9;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i7)) / f)), Videoio.CAP_OPENNI_IMAGE_GENERATOR), iMakeMeasureSpec);
                                }
                            }
                            ...
                            if (z4) {
                                if (layoutParams2.height == -2) {
                                    ...
                                    i5 = Videoio.CAP_OPENNI_IMAGE_GENERATOR;
                                } else if (layoutParams2.height == -1) {
                                    i5 = Videoio.CAP_OPENNI_IMAGE_GENERATOR;
                                    iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(paddingTop, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                                } else {
                                    i5 = Videoio.CAP_OPENNI_IMAGE_GENERATOR;
                                    iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                                }
                            } else {
                                i5 = Videoio.CAP_OPENNI_IMAGE_GENERATOR;
                                iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                            }
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    int iMin = (Math.min(paddingRight, i12 - this.mOverhangSize) - i10) - (layoutParams.leftMargin + layoutParams.rightMargin);
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:9:0x001c  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
