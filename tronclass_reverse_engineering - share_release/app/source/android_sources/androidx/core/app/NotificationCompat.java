...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public RemoteViews createContentView() {
            ...
            Style style = this.mStyle;
            return (style == null || (remoteViewsMakeContentView = style.makeContentView(notificationCompatBuilder)) == null) ? Notification.Builder.recoverBuilder(this.mContext, notificationCompatBuilder.build()).createContentView() : remoteViewsMakeContentView;
        }
        ...
        public RemoteViews createBigContentView() {
            ...
            NotificationCompatBuilder notificationCompatBuilder = new NotificationCompatBuilder(this);
            Style style = this.mStyle;
            return (style == null || (remoteViewsMakeBigContentView = style.makeBigContentView(notificationCompatBuilder)) == null) ? Notification.Builder.recoverBuilder(this.mContext, notificationCompatBuilder.build()).createBigContentView() : remoteViewsMakeBigContentView;
        }
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            NotificationCompatBuilder notificationCompatBuilder = new NotificationCompatBuilder(this);
            Style style = this.mStyle;
            return (style == null || (remoteViewsMakeHeadsUpContentView = style.makeHeadsUpContentView(notificationCompatBuilder)) == null) ? Notification.Builder.recoverBuilder(this.mContext, notificationCompatBuilder.build()).createHeadsUpContentView() : remoteViewsMakeHeadsUpContentView;
        }
    ...
    public static abstract class Style {
        ...
        /* high-level source view WARN: Removed duplicated region for block: B:34:0x0118  */
        /* high-level source view WARN: Removed duplicated region for block: B:43:0x015f  */
        /* high-level source view WARN: Removed duplicated region for block: B:49:0x01ab  */
        /* high-level source view WARN: Removed duplicated region for block: B:52:0x01b0  */
        /* high-level source view WARN: Removed duplicated region for block: B:53:0x01b2  */
        /* high-level source view WARN: Removed duplicated region for block: B:57:0x01bb  */
        /*
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                ...
                if (z && this.mBuilder.mNotification.icon != 0) {
                    ...
                    remoteViews.setImageViewBitmap(R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize - (resources.getDimensionPixelSize(R.dimen.notification_small_icon_background_padding) * 2), this.mBuilder.getColor()));
    ...
    public static class BigPictureStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                Api31Impl.setContentDescription(bigPictureStyleBigPicture, this.mPictureContentDescription);
            }
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m276clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        public WearableExtender m277clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        boolean zIsAuthenticationRequired = Build.VERSION.SDK_INT >= 31 ? action.isAuthenticationRequired() : false;
        if (action.getIcon() == null && action.icon != 0) {
            return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z, i2, z2, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z, i2, z2, zIsContextual, zIsAuthenticationRequired);
    }
