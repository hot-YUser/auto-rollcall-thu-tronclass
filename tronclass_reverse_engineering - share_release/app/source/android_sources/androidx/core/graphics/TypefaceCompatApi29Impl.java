...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    private Font findBaseFont(FontFamily fontFamily, int i) {
        FontStyle fontStyle = new FontStyle((i & 1) != 0 ? Videoio.CAP_DSHOW : Videoio.CAP_PROP_XI_DOWNSAMPLING, (i & 2) != 0 ? 1 : 0);
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:9:0x001a A[Catch: IOException -> 0x005a, Exception -> 0x007a, PHI: r3
