...
public class ViewPager extends ViewGroup {
    ...
    /* high-level source view WARN: Code restructure failed: missing block: B:28:0x006a, code lost:
    
        r8 = null;
     */
    /* high-level source view WARN: Removed duplicated region for block: B:65:0x00fb A[PHI: r7 r10 r15
  ...
  0x00fb: PHI (r15v7 float) = (r15v5 float), (r15v6 float), (r15v4 float) binds: [B:63:0x00f0, B:60:0x00da, B:54:0x00c4] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    void populate(int i) {
        ...
        if (itemInfoAddNewItem != null) {
            ...
            for (int i6 = this.mCurItem - 1; i6 >= 0; i6--) {
                ...
                } else if (itemInfo2 != null && i6 == itemInfo2.position) {
            ...
            if (f2 < 2.0f) {
                ...
                while (true) {
                    ...
                    if (f2 >= paddingRight && i8 > iMin) {
                        ...
                        ItemInfo itemInfoAddNewItem2 = addNewItem(i8, i7);
                        i7++;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            boolean z2 = true;
            int i8 = Videoio.CAP_OPENNI_IMAGE_GENERATOR;
            if (i7 >= childCount) {
                break;
            }
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredHeight, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
        this.mInLayout = true;
        populate();
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.widthFactor), Videoio.CAP_OPENNI_IMAGE_GENERATOR), this.mChildHeightMeasureSpec);
            }
        }
    }
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:22:0x0073  */
    /* high-level source view WARN: Removed duplicated region for block: B:29:0x0090  */
    @Override // android.view.ViewGroup, android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
        ...
        for (int i15 = 0; i15 < childCount; i15++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (itemInfoInfoForChild = infoForChild(childAt2)) != null) {
                    float f = i14;
                    int i16 = ((int) (itemInfoInfoForChild.offset * f)) + paddingLeft;
                    if (layoutParams2.needsMeasure) {
                        layoutParams2.needsMeasure = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), Videoio.CAP_OPENNI_IMAGE_GENERATOR), View.MeasureSpec.makeMeasureSpec((i6 - paddingTop) - paddingBottom, Videoio.CAP_OPENNI_IMAGE_GENERATOR));
                    }
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:22:0x0064  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:53:0x00dc  */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:40:0x00be  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public boolean arrowScroll(int i) {
        ...
        if (viewFindNextFocus == null || viewFindNextFocus == viewFindFocus) {
            if (i == 17 || i == 1) {
                ...
                zPageLeft = (i == 66 || i == 2) ? pageRight() : false;
            }
        } else if (i == 17) {
            ...
            if (viewFindFocus != null && i2 >= i3) {
                ...
                zPageLeft = viewFindNextFocus.requestFocus();
            }
        } else if (i == 66) {
