...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:100:0x0214  */
    @Override // androidx.recyclerview.widget.LinearLayoutManager
    /*
    ...
    */
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        if (z) {
            ...
            for (int i14 = 0; i14 < i10; i14++) {
                ...
                measureChild(view2, Videoio.CAP_OPENNI_IMAGE_GENERATOR, true);
        ...
        for (int i15 = 0; i15 < i10; i15++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i12) {
                ...
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = getChildMeasureSpec(spaceForSpanRange, Videoio.CAP_OPENNI_IMAGE_GENERATOR, i17, layoutParams.width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i12 - i16, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                } else {
                    int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i12 - i17, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
                    childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, Videoio.CAP_OPENNI_IMAGE_GENERATOR, i16, layoutParams.height, false);
        ...
        while (i18 < i10) {
            ...
            if (this.mOrientation == 1) {
                if (isLayoutRTL()) {
                    ...
                    decoratedMeasurementInOther3 = i5;
                    ...
                    layoutDecoratedWithMargins(view4, i7, i6, decoratedMeasurementInOther2, decoratedMeasurementInOther3);
                ...
                i6 = paddingTop;
                decoratedMeasurementInOther2 = i4;
    ...
    public static abstract class SpanSizeLookup {
        ...
        /* high-level source view WARN: Removed duplicated region for block: B:12:0x0024  */
        /* high-level source view WARN: Removed duplicated region for block: B:18:0x0033  */
        /* high-level source view WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:14:0x002b -> B:17:0x0030). Please report as a decompilation issue!!! */
        /* high-level source view WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:15:0x002d -> B:17:0x0030). Please report as a decompilation issue!!! */
        /* high-level source view WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:16:0x002f -> B:17:0x0030). Please report as a decompilation issue!!! */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
    ...
    /* high-level source view WARN: Code restructure failed: missing block: B:54:0x00d2, code lost:
    
        if (r13 == (r2 > r15)) goto L45;
     */
    /* high-level source view WARN: Removed duplicated region for block: B:70:0x00fa  */
    /* high-level source view WARN: Removed duplicated region for block: B:71:0x010f  */
    @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
