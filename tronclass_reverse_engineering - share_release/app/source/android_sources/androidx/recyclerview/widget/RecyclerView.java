...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    private String getFullClassName(Context context, String str) {
        ...
        return str.contains(".") ? str : RecyclerView.class.getPackage().getName() + FilenameUtils.EXTENSION_SEPARATOR + str;
    }
    ...
    /* high-level source view WARN: Type inference failed for: r0v1, types: [boolean] */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:12:0x0040  */
    /* high-level source view WARN: Removed duplicated region for block: B:13:0x0056  */
    /*
    ...
    */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:21:0x004e  */
    @Override // android.view.ViewGroup, android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* high-level source view WARN: Multi-variable type inference failed */
    /* high-level source view WARN: Removed duplicated region for block: B:47:0x00de A[PHI: r0
  0x00de: PHI (r0v36 int) = (r0v26 int), (r0v40 int) binds: [B:41:0x00c7, B:45:0x00da] A[DONT_GENERATE, DONT_INLINE]] */
    /* high-level source view WARN: Removed duplicated region for block: B:49:0x00e1  */
    /* high-level source view WARN: Removed duplicated region for block: B:55:0x00f7  */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:28:0x0062  */
    /* high-level source view WARN: Removed duplicated region for block: B:31:0x0068  */
    /* high-level source view WARN: Removed duplicated region for block: B:33:0x006c  */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            if (this.mLayout.shouldMeasureTwice()) {
                this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), Videoio.CAP_OPENNI_IMAGE_GENERATOR), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Videoio.CAP_OPENNI_IMAGE_GENERATOR));
                this.mState.mIsMeasuring = true;
                dispatchLayoutStep2();
                this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                return;
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:15:0x002a  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    public final class Recycler {
        ...
        /* high-level source view WARN: Removed duplicated region for block: B:100:0x020f  */
        /* high-level source view WARN: Removed duplicated region for block: B:106:0x022b A[ADDED_TO_REGION] */
        /* high-level source view WARN: Removed duplicated region for block: B:108:0x022e  */
        /* high-level source view WARN: Removed duplicated region for block: B:18:0x0037  */
        /* high-level source view WARN: Removed duplicated region for block: B:27:0x005c  */
        /* high-level source view WARN: Removed duplicated region for block: B:29:0x005f  */
        /* high-level source view WARN: Removed duplicated region for block: B:73:0x0182 A[PHI: r1 r4
  0x0182: PHI (r1v18 androidx.recyclerview.widget.RecyclerView$ViewHolder) = 
  (r1v17 androidx.recyclerview.widget.RecyclerView$ViewHolder)
  (r1v43 androidx.recyclerview.widget.RecyclerView$ViewHolder)
 binds: [B:28:0x005d, B:59:0x00fe] A[DONT_GENERATE, DONT_INLINE]
  0x0182: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:59:0x00fe] A[DONT_GENERATE, DONT_INLINE]] */
        /* high-level source view WARN: Removed duplicated region for block: B:82:0x01a3  */
        /* high-level source view WARN: Removed duplicated region for block: B:88:0x01d1  */
        /* high-level source view WARN: Removed duplicated region for block: B:99:0x0201  */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
    ...
    public static abstract class LayoutManager {
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = Videoio.CAP_OPENNI_IMAGE_GENERATOR;
            this.mHeightMode = Videoio.CAP_OPENNI_IMAGE_GENERATOR;
        }
        ...
        /* high-level source view WARN: Removed duplicated region for block: B:6:0x000d  */
        /* high-level source view WARN: Removed duplicated region for block: B:8:0x0011 A[PHI: r3
  0x0011: PHI (r3v3 int) = (r3v0 int), (r3v2 int), (r3v0 int) binds: [B:7:0x000f, B:11:0x0016, B:4:0x000a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        /* high-level source view WARN: Removed duplicated region for block: B:14:0x0020  */
        /* high-level source view WARN: Removed duplicated region for block: B:21:0x002f  */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        ...
        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), Videoio.CAP_OPENNI_IMAGE_GENERATOR), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), Videoio.CAP_OPENNI_IMAGE_GENERATOR));
        }
