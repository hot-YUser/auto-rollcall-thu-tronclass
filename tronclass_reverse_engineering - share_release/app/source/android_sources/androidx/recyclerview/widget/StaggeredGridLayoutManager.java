...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:37:0x0086  */
    /*
    ...
    */
        ...
        while (i2 != childCount) {
            ...
            if (!layoutParams.mFullSpan && (i = i2 + i3) != childCount) {
                ...
                if (this.mShouldReverseLayout) {
                    ...
                    if (decoratedEnd == decoratedEnd2) {
                        if ((layoutParams.mSpan.mIndex - ((LayoutParams) childAt2.getLayoutParams()).mSpan.mIndex < 0) != (b < 0)) {
                            return childAt;
                        }
                    } else {
                        continue;
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:86:0x015f  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:21:0x003c  */
    /* high-level source view WARN: Removed duplicated region for block: B:23:0x0043 A[RETURN] */
    /* high-level source view WARN: Removed duplicated region for block: B:24:0x0044  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* high-level source view WARN: Type inference failed for: r0v44 */
    /* high-level source view WARN: Type inference failed for: r16v0, types: [androidx.recyclerview.widget.StaggeredGridLayoutManager] */
    /* high-level source view WARN: Type inference failed for: r3v0 */
    /* high-level source view WARN: Type inference failed for: r3v1 */
    /* high-level source view WARN: Type inference failed for: r3v10 */
    /* high-level source view WARN: Type inference failed for: r3v2 */
    /* high-level source view WARN: Type inference failed for: r9v0 */
    /* high-level source view WARN: Type inference failed for: r9v1, types: [boolean, int] */
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                ...
                if (r3 != 0 && layoutParams.mFullSpan) {
