...
public class ExifData {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag(ExifInterface.TAG_IMAGE_WIDTH, 256, 3, 4), new ExifTag(ExifInterface.TAG_IMAGE_LENGTH, 257, 3, 4), new ExifTag(ExifInterface.TAG_MAKE, 271, 2), new ExifTag(ExifInterface.TAG_MODEL, Imgcodecs.IMWRITE_JPEG2000_COMPRESSION_X1000, 2), new ExifTag(ExifInterface.TAG_ORIENTATION, 274, 3), new ExifTag(ExifInterface.TAG_X_RESOLUTION, 282, 5), new ExifTag(ExifInterface.TAG_Y_RESOLUTION, 283, 5), new ExifTag(ExifInterface.TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(ExifInterface.TAG_SOFTWARE, Videoio.CAP_PROP_PVAPI_BINNINGY, 2), new ExifTag(ExifInterface.TAG_DATETIME, Videoio.CAP_PROP_PVAPI_PIXELFORMAT, 2), new ExifTag(ExifInterface.TAG_Y_CB_CR_POSITIONING, Videoio.CAP_PROP_XI_TRANSPORT_PIXEL_FORMAT, 3), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4)};
