...
public class ExcludedSupportedSizesQuirk implements Quirk {
    ...
    private List<Size> getOnePlus6ExcludedSizes(String str, int i) {
        ...
        if (str.equals("0") && i == 256) {
            ...
            arrayList.add(new Size(com.king.logx.logger.Logger.MAX_LOG_LENGTH, 3000));
        }
        return arrayList;
    }
    ...
    private List<Size> getHuaweiP20LiteExcludedSizes(String str, int i, Class<?> cls) {
        ...
        if (str.equals("0") && (i == 34 || i == 35 || cls != null)) {
            arrayList.add(new Size(ResolutionCameraConfig.IMAGE_QUALITY_720P, ResolutionCameraConfig.IMAGE_QUALITY_720P));
            arrayList.add(new Size(Videoio.CAP_PROP_XI_DOWNSAMPLING, Videoio.CAP_PROP_XI_DOWNSAMPLING));
        }
        return arrayList;
    }
    ...
    private List<Size> getSamsungJ7PrimeApi27AboveExcludedSizes(String str, int i, Class<?> cls) {
        ...
        if (str.equals("0")) {
            if (i == 34 || cls != null) {
                ...
                arrayList.add(new Size(1920, ResolutionCameraConfig.IMAGE_QUALITY_1080P));
            } else if (i == 35) {
                arrayList.add(new Size(4128, 2322));
                arrayList.add(new Size(3088, 3088));
                arrayList.add(new Size(3264, 2448));
    ...
    private List<Size> getSamsungJ7Api27AboveExcludedSizes(String str, int i, Class<?> cls) {
        ...
        if (str.equals("0")) {
            ...
            arrayList.add(new Size(2560, OneSignalRemoteParams.DEFAULT_INDIRECT_ATTRIBUTION_WINDOW));
            arrayList.add(new Size(1920, 1920));
            arrayList.add(new Size(2048, 1536));
            arrayList.add(new Size(2048, 1152));
            arrayList.add(new Size(1920, ResolutionCameraConfig.IMAGE_QUALITY_1080P));
