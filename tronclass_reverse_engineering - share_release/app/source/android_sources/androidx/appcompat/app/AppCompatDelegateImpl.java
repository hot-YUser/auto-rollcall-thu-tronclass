...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        Configuration configurationCreateOverrideConfigurationForDayNight = createOverrideConfigurationForDayNight(context, iMapNightMode, configuration2.equals(configuration3) ? null : generateConfigDelta(configuration2, configuration3));
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:15:0x0048  */
    @Override // androidx.appcompat.app.AppCompatDelegate
    /*
    ...
    */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:34:0x0062  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:17:0x0047  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private boolean updateForNightMode(int i, boolean z) {
        ...
        boolean z3 = true;
        if (i2 != i3 && z && !zIsActivityManifestHandlingUiMode && this.mBaseContextAttached && (sCanReturnDifferentContext || this.mCreated)) {
            Object obj = this.mHost;
    ...
    private boolean isActivityManifestHandlingUiMode() {
        if (!this.mActivityHandlesUiModeChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                ActivityInfo activityInfo = packageManager.getActivityInfo(new ComponentName(this.mContext, this.mHost.getClass()), Build.VERSION.SDK_INT >= 29 ? 269221888 : 786432);
