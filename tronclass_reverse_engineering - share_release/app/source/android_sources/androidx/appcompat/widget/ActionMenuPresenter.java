...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    /* high-level source view WARN: Multi-variable type inference failed */
    /* high-level source view WARN: Type inference failed for: r0v1, types: [androidx.appcompat.widget.ActionMenuPresenter] */
    /* high-level source view WARN: Type inference failed for: r0v10 */
    /* high-level source view WARN: Type inference failed for: r0v11 */
    /* high-level source view WARN: Type inference failed for: r0v2, types: [boolean] */
    ...
    /* high-level source view WARN: Type inference failed for: r15v1, types: [androidx.appcompat.view.menu.MenuItemImpl] */
    /* high-level source view WARN: Type inference failed for: r3v0 */
    /* high-level source view WARN: Type inference failed for: r3v1, types: [int] */
    /* high-level source view WARN: Type inference failed for: r3v12 */
    @Override // androidx.appcompat.view.menu.BaseMenuPresenter, androidx.appcompat.view.menu.MenuPresenter
    public boolean flagActionItems() {
        ...
        while (i10 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                View itemView = r02.getItemView(menuItemImpl2, view, viewGroup);
                if (r02.mStrictWidthLimit) {
                    iMeasureChildForCells -= ActionMenuView.measureChildForCells(itemView, i, iMeasureChildForCells, iMakeMeasureSpec, r3);
                } else {
                ...
                boolean z3 = (i8 > 0 || z2) && i4 > 0 && (!r02.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z4 = z3;
                i2 = size;
                if (z3) {
                    View itemView2 = r02.getItemView(menuItemImpl2, null, viewGroup);
                    if (r02.mStrictWidthLimit) {
                    ...
                    z3 = z5 & (!r02.mStrictWidthLimit ? i4 + i11 <= 0 : i4 < 0);
                }
                if (z3 && groupId2 != 0) {
