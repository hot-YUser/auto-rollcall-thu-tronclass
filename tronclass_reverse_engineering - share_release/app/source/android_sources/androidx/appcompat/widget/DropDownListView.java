...
class DropDownListView extends ListView {
    ...
    public int measureHeightOfChildrenCompat(int i, int i2, int i3, int i4, int i5) {
        ...
        while (i6 < count) {
            ...
            if (layoutParams.height > 0) {
                iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(layoutParams.height, Videoio.CAP_OPENNI_IMAGE_GENERATOR);
            } else {
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:23:0x004a  */
    /* high-level source view WARN: Removed duplicated region for block: B:25:0x004f  */
    /* high-level source view WARN: Removed duplicated region for block: B:29:0x0065  */
    /* high-level source view WARN: Removed duplicated region for block: B:9:0x0011  */
    /*
