...
public class Toolbar extends ViewGroup {
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:104:0x029e A[LOOP:0: B:103:0x029c->B:104:0x029e, LOOP_END] */
    /* high-level source view WARN: Removed duplicated region for block: B:107:0x02c0 A[LOOP:1: B:106:0x02be->B:107:0x02c0, LOOP_END] */
    /* high-level source view WARN: Removed duplicated region for block: B:111:0x02ea  */
    /* high-level source view WARN: Removed duplicated region for block: B:116:0x02f9 A[LOOP:2: B:115:0x02f7->B:116:0x02f9, LOOP_END] */
    /* high-level source view WARN: Removed duplicated region for block: B:19:0x005f  */
    /* high-level source view WARN: Removed duplicated region for block: B:24:0x0076  */
    /* high-level source view WARN: Removed duplicated region for block: B:29:0x00b3  */
    /* high-level source view WARN: Removed duplicated region for block: B:34:0x00ca  */
    /* high-level source view WARN: Removed duplicated region for block: B:39:0x00e7  */
    /* high-level source view WARN: Removed duplicated region for block: B:40:0x00fe  */
    /* high-level source view WARN: Removed duplicated region for block: B:42:0x0103  */
    /* high-level source view WARN: Removed duplicated region for block: B:43:0x011b  */
    /* high-level source view WARN: Removed duplicated region for block: B:49:0x0129  */
    /* high-level source view WARN: Removed duplicated region for block: B:50:0x012b  */
    /* high-level source view WARN: Removed duplicated region for block: B:51:0x012e  */
    /* high-level source view WARN: Removed duplicated region for block: B:53:0x0132  */
    /* high-level source view WARN: Removed duplicated region for block: B:54:0x0135  */
    /* high-level source view WARN: Removed duplicated region for block: B:66:0x0166  */
    /* high-level source view WARN: Removed duplicated region for block: B:76:0x01a5  */
    /* high-level source view WARN: Removed duplicated region for block: B:78:0x01b4  */
    /* high-level source view WARN: Removed duplicated region for block: B:90:0x0224  */
    @Override // android.view.ViewGroup, android.view.View
    /*
        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            if (z2) {
                ...
                if (zShouldLayout) {
                    ...
                    i5 = paddingRight;
                    measuredHeight = layoutParams.topMargin + this.mTitleTextView.getMeasuredHeight() + layoutParams.bottomMargin;
                }
                if (zShouldLayout2) {
                    i6 = width;
                } else {
                ...
                if (!zShouldLayout || zShouldLayout2) {
                    ...
                    if (z2) {
                        ...
                        while (i10 < size3) {
                            iLayoutChildLeft2 = layoutChildLeft(this.mTempViews.get(i10), iLayoutChildLeft2, iArr, i27);
                            i10++;
                        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                layoutParamsGenerateDefaultLayoutParams.gravity = (Toolbar.this.mButtonGravity & 112) | GravityCompat.START;
                layoutParamsGenerateDefaultLayoutParams.mViewType = 2;
