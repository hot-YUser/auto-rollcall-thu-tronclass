...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            ...
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iResolveMinimumHeight, Videoio.CAP_OPENNI_IMAGE_GENERATOR));
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:32:0x00a8  */
