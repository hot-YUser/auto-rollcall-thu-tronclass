...
public class TransitionSet extends Transition {
    ...
    String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            string = string + IOUtils.LINE_SEPARATOR_UNIX + this.mTransitions.get(i).toString(str + "  ");
        }
        return string;
    }
    ...
    public Transition mo307clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo307clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo307clone());
        }
