...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo307clone = transition.mo307clone();
        transitionMo307clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo307clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo307clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo307clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo307clone = transition.mo307clone();
        sceneChangeSetup(viewGroup, transitionMo307clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo307clone);
    }
