...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, Videoio.CAP_OPENNI_IMAGE_GENERATOR), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, Videoio.CAP_OPENNI_IMAGE_GENERATOR));
        this.mCircleViewIndex = -1;
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:36:0x0058  */
    @Override // android.view.ViewGroup
    /*
    ...
    */
    ...
    private void moveSpinner(float f) {
        ...
        float fMax = (((float) Math.max(((double) fMin) - 0.4d, AudioStats.AUDIO_AMPLITUDE_NONE)) * 5.0f) / 3.0f;
