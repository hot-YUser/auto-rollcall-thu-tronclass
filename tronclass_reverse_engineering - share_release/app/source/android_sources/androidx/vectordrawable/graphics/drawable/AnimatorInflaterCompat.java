...
public class AnimatorInflaterCompat {
    ...
    /* high-level source view WARN: Code restructure failed: missing block: B:37:0x00de, code lost:
    
        if (r23 == null) goto L46;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:38:0x00e0, code lost:
    
        if (r13 == null) goto L46;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:39:0x00e2, code lost:
    
        r1 = new android.animation.Animator[r13.size()];
        r2 = r13.iterator();
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:41:0x00f0, code lost:
    
        if (r2.hasNext() == false) goto L58;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:42:0x00f2, code lost:
    
        r1[r14] = (android.animation.Animator) r2.next();
        r14 = r14 + 1;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:43:0x00fe, code lost:
    
        if (r24 != 0) goto L45;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:44:0x0100, code lost:
    
        r23.playTogether(r1);
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:45:0x0104, code lost:
    
        r23.playSequentially(r1);
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:46:0x0107, code lost:
