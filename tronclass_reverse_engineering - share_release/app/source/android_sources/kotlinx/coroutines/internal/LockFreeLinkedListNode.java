...
public class LockFreeLinkedListNode {
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo1884remove()) {
    ...
    /* high-level source view WARN: Type inference failed for: r0v1, types: [T, java.lang.Object, kotlinx.coroutines.internal.LockFreeLinkedListNode] */
    public final /* synthetic */ <T> T removeFirstIfIsInstanceOfOrPeekIf(Function1<? super T, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((predicate.invoke(lockFreeLinkedListNode).booleanValue() && !lockFreeLinkedListNode.isRemoved()) || (lockFreeLinkedListNodeRemoveOrNext = lockFreeLinkedListNode.removeOrNext()) == null) {
                return lockFreeLinkedListNode;
            }
    ...
    public static class AddLastDesc<T extends LockFreeLinkedListNode> extends AbstractAtomicDesc {
        ...
        public AddLastDesc(LockFreeLinkedListNode lockFreeLinkedListNode, T t) {
            ...
            this.node = t;
            if (DebugKt.getASSERTIONS_ENABLED() && (t._next != t || t._prev != t)) {
    ...
    public static final class PrepareOp extends OpDescriptor {
        ...
        public Object perform(Object affected) {
            ...
            if (DebugKt.getASSERTIONS_ENABLED() && affected != this.affected) {
                throw new AssertionError();
            }
            if (affected != null) {
                ...
                if (objOnPrepare != null) {
                    objDecide = getAtomicOp().decide(objOnPrepare);
                } else {
                    objDecide = getAtomicOp().get_consensus();
                }
                if (objDecide == AtomicKt.NO_DECISION) {
                    objUpdatedNext = getAtomicOp();
                } else if (objDecide == null) {
                    objUpdatedNext = this.desc.updatedNext(lockFreeLinkedListNode, this.next);
                } else {
                    objUpdatedNext = this.next;
                }
                AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode, this, objUpdatedNext);
                return null;
            }
    ...
    public static abstract class AbstractAtomicDesc extends AtomicDesc {
        ...
        /* high-level source view WARN: Code restructure failed: missing block: B:29:0x0055, code lost:
        
            if (kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED() == false) goto L34;
         */
        /* high-level source view WARN: Code restructure failed: missing block: B:30:0x0057, code lost:
        
            if (r4 != null) goto L32;
         */
        /* high-level source view WARN: Code restructure failed: missing block: B:33:0x005f, code lost:
        
            throw new java.lang.AssertionError();
         */
        /* high-level source view WARN: Code restructure failed: missing block: B:34:0x0060, code lost:
        ...
        */
                    ...
                    if (retry(lockFreeLinkedListNodeTakeAffectedNode, obj)) {
                        ...
                        if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNodeTakeAffectedNode, obj, prepareOp)) {
                            try {
                                ...
                                if (objPerform != LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                                    break;
                                }
                            } catch (Throwable th) {
        ...
        public final void complete(AtomicOp<?> op, Object failure) {
            ...
            if (queue == null) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, affectedNode, op, z ? updatedNext(affectedNode, queue) : queue) && z) {
    ...
    /* high-level source view WARN: Code restructure failed: missing block: B:28:0x0048, code lost:
    ...
    */
    ...
    public final void validateNode$kotlinx_coroutines_core(LockFreeLinkedListNode prev, LockFreeLinkedListNode next) {
        if (DebugKt.getASSERTIONS_ENABLED() && prev != this._prev) {
            throw new AssertionError();
        }
        if (DebugKt.getASSERTIONS_ENABLED() && next != this._next) {
            throw new AssertionError();
        }
    }
