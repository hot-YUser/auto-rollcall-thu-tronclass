...
public final class LockFreeTaskQueueCore<E> {
    ...
    /* high-level source view WARN: Code restructure failed: missing block: B:17:0x004c, code lost:
    ...
    public final int addLast(E element) {
        while (true) {
            ...
            if (!this.singleConsumer && this.array.get(i2 & i3) != null) {
                ...
                while ((lockFreeTaskQueueCoreFillPlaceholder._state & 1152921504606846976L) != 0 && (lockFreeTaskQueueCoreFillPlaceholder = lockFreeTaskQueueCoreFillPlaceholder.next().fillPlaceholder(i2, element)) != null) {
                }
                return 0;
            }
        }
