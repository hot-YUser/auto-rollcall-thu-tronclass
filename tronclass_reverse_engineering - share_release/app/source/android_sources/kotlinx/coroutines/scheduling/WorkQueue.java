...
public final class WorkQueue {
    ...
    public final long tryStealFrom(WorkQueue victim) {
        if (DebugKt.getASSERTIONS_ENABLED() && getBufferSize$kotlinx_coroutines_core() != 0) {
            throw new AssertionError();
        }
        Task taskPollBuffer = victim.pollBuffer();
        if (taskPollBuffer != null) {
            Task taskAdd$default = add$default(this, taskPollBuffer, false, 2, null);
            if (!DebugKt.getASSERTIONS_ENABLED() || taskAdd$default == null) {
                return -1L;
            }
            throw new AssertionError();
        }
    ...
    public final long tryStealBlockingFrom(WorkQueue victim) {
        ...
        for (int i2 = victim.consumerIndex; i2 != i; i2++) {
            ...
            if (task != null && task.taskContext.getTaskMode() == 1 && ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceArray, i3, task, null)) {
    ...
    private final long tryStealLastScheduled(WorkQueue victim, boolean blockingOnly) {
        ...
        do {
            ...
            if (blockingOnly && task.taskContext.getTaskMode() != 1) {
                return -2L;
            }
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(lastScheduledTask$FU, victim, task, null));
        add$default(this, task, false, 2, null);
        return -1L;
    }
