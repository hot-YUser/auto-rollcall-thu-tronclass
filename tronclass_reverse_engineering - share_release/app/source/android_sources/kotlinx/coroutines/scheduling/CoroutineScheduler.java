...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:31:0x006b  */
    /*
    ...
    */
    public final void shutdown(long timeout) {
        ...
        if (_isTerminated$FU.compareAndSet(this, 0, 1)) {
            ...
            if (DebugKt.getASSERTIONS_ENABLED() && ((int) ((this.controlState & CPU_PERMITS_MASK) >> 42)) != this.corePoolSize) {
                throw new AssertionError();
            }
            this.parkedWorkersStack = 0L;
