...
public final class ChannelKt {
    ...
    public static final <T> T m1840getOrElseWpGqRn0(Object obj, Function1<? super Throwable, ? extends T> function1) {
        return obj instanceof ChannelResult.Failed ? function1.invoke(ChannelResult.m1848exceptionOrNullimpl(obj)) : obj;
    }
    public static final <T> Object m1843onSuccessWpGqRn0(Object obj, Function1<? super T, Unit> function1) {
        if (!(obj instanceof ChannelResult.Failed)) {
            function1.invoke(obj);
        }
        return obj;
    }
    public static final <T> Object m1842onFailureWpGqRn0(Object obj, Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m1848exceptionOrNullimpl(obj));
        }
        return obj;
    }
    public static final <T> Object m1841onClosedWpGqRn0(Object obj, Function1<? super Throwable, Unit> function1) {
