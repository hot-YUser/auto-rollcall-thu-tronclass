...
public interface ReceiveChannel<E> {
    ...
    Object mo1837receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);
    Object mo1838tryReceivePtdJZtk();
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1838tryReceivePtdJZtk = receiveChannel.mo1838tryReceivePtdJZtk();
            if (ChannelResult.m1854isSuccessimpl(objMo1838tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1850getOrThrowimpl(objMo1838tryReceivePtdJZtk);
            }
            Throwable thM1848exceptionOrNullimpl = ChannelResult.m1848exceptionOrNullimpl(objMo1838tryReceivePtdJZtk);
            if (thM1848exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1848exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo1837receiveCatchingJP2dKIU = receiveChannel.mo1837receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m1849getOrNullimpl(objMo1837receiveCatchingJP2dKIU);
        }
