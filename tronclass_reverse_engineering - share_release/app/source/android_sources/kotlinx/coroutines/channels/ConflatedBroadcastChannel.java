...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    private final Subscriber<E>[] removeSubscriber(Subscriber<E>[] list, Subscriber<E> subscriber) {
        ...
        int iIndexOf = ArraysKt.indexOf(list, subscriber);
        if (DebugKt.getASSERTIONS_ENABLED() && iIndexOf < 0) {
        ...
        ArraysKt.copyInto$default(list, subscriberArr, 0, 0, iIndexOf, 6, (Object) null);
        ArraysKt.copyInto$default(list, subscriberArr, iIndexOf, iIndexOf + 1, 0, 8, (Object) null);
    ...
    @Override // kotlinx.coroutines.channels.SendChannel
    public Object mo1839trySendJP2dKIU(E element) {
        Closed closedOfferInternal = offerInternal(element);
        return closedOfferInternal != null ? ChannelResult.INSTANCE.m1857closedJP2dKIU(closedOfferInternal.getSendException()) : ChannelResult.INSTANCE.m1859successJP2dKIU(Unit.INSTANCE);
    }
