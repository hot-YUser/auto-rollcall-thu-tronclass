...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            return ChannelResult.m1844boximpl(Result.m340isSuccessimpl(objM333constructorimpl) ? ChannelResult.INSTANCE.m1859successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1857closedJP2dKIU(Result.m336exceptionOrNullimpl(objM333constructorimpl)));
        }
    }

    /* high-level source view WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1839trySendJP2dKIU = sendChannel.mo1839trySendJP2dKIU(e);
        if (objMo1839trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1854isSuccessimpl(sendChannel.mo1839trySendJP2dKIU(e))) {
            return;
        }
