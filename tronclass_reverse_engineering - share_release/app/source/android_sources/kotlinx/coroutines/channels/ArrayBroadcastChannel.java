...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    private static final class Subscriber<E> extends AbstractChannel<E> implements ReceiveChannel<E> {
        ...
        /* high-level source view WARN: Code restructure failed: missing block: B:35:0x006a, code lost:
        
            if (r2 == null) goto L37;
         */
        /* high-level source view WARN: Code restructure failed: missing block: B:36:0x006c, code lost:
        
            close(r2.closeCause);
         */
        /* high-level source view WARN: Code restructure failed: missing block: B:37:0x0071, code lost:
