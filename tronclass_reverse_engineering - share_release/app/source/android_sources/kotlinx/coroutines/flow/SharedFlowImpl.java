...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    */
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation<Unit> continuation : continuationArrFindSlotsToResumeLocked) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m333constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    /* high-level source view WARN: Multi-variable type inference failed */
    /* high-level source view WARN: Type inference failed for: r11v0, types: [kotlin.coroutines.Continuation<kotlin.Unit>[]] */
    /* high-level source view WARN: Type inference failed for: r11v1 */
    /* high-level source view WARN: Type inference failed for: r11v10 */
    /* high-level source view WARN: Type inference failed for: r11v11 */
    /* high-level source view WARN: Type inference failed for: r11v12 */
    /* high-level source view WARN: Type inference failed for: r11v13 */
    /* high-level source view WARN: Type inference failed for: r11v3 */
    /* high-level source view WARN: Type inference failed for: r11v4 */
    /* high-level source view WARN: Type inference failed for: r11v5 */
        ...
        if (((AbstractSharedFlow) sharedFlowImpl).nCollectors != 0 && (abstractSharedFlowSlotArr = ((AbstractSharedFlow) sharedFlowImpl).slots) != null) {
            ...
            while (i < length2) {
                ...
                if (abstractSharedFlowSlot != null && (continuation = (sharedFlowSlot = (SharedFlowSlot) abstractSharedFlowSlot).cont) != null && tryPeekLocked(sharedFlowSlot) >= 0) {
                    Object[] objArr = (Object[]) resumesIn;
                    resumesIn = resumesIn;
                    if (length >= objArr.length) {
                        Object[] objArrCopyOf = Arrays.copyOf(objArr, Math.max(2, objArr.length * 2));
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m333constructorimpl(Unit.INSTANCE));
        ...
        for (Continuation<Unit> continuation2 : continuationArrFindSlotsToResumeLocked) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m333constructorimpl(Unit.INSTANCE));
            }
        }
