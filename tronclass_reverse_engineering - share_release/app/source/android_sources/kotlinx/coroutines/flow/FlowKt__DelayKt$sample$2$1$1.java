...
final class FlowKt__DelayKt$sample$2$1$1 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m1869invokeWpGqRn0(channelResult.getHolder(), continuation);
    }
    public final Object m1869invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$sample$2$1$1) create(ChannelResult.m1844boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* high-level source view WARN: Type inference failed for: r4v4, types: [T, java.lang.Object] */
    /* high-level source view WARN: Type inference failed for: r4v9, types: [T, kotlinx.coroutines.internal.Symbol] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (z) {
            Throwable thM1848exceptionOrNullimpl = ChannelResult.m1848exceptionOrNullimpl(holder);
