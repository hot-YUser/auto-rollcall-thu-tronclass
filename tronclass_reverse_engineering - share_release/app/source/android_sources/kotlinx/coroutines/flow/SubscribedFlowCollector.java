...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.SubscribedFlowCollector", f = "Share.kt", i = {0, 0}, l = {Videoio.CAP_PROP_XI_AEAG_LEVEL, Videoio.CAP_PROP_XI_GAIN_SELECTOR}, m = "onSubscription", n = {"this", "safeCollector"}, s = {"L$0", "L$1"})
    ...
    /* high-level source view WARN: Type inference failed for: r2v1, types: [kotlinx.coroutines.flow.internal.SafeCollector] */
    /* high-level source view WARN: Type inference failed for: r2v4, types: [boolean] */
    /*
