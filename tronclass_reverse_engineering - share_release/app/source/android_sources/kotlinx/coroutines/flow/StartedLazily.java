...
final class StartedLazily implements SharingStarted {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.StartedLazily$command$1", f = "SharingStarted.kt", i = {}, l = {Imgproc.COLOR_COLORCVT_MAX}, m = "invokeSuspend", n = {}, s = {})
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$subscriptionCount.collect(new C00271(booleanRef, flowCollector), this) == coroutine_suspended) {
        ...
        static final class C00271<T> implements FlowCollector {
            ...
            C00271(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
