...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1866debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1824toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1824toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    static final class C01342<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* high-level source view WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* high-level source view WARN: Multi-variable type inference failed */
        C01342(long j, Flow<? extends T> flow, Continuation<? super C01342> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C01342 c01342 = new C01342(this.$periodMillis, this.$this_sample, continuation);
            c01342.L$0 = coroutineScope;
            c01342.L$1 = flowCollector;
            return c01342.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (objectRef.element != NullSurrogateKt.DONE) {
                ...
                this.label = 1;
                C01342<T> c01342 = this;
                SelectBuilderImpl selectBuilderImpl = new SelectBuilderImpl(c01342);
                try {
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c01342);
                }
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C01342(j, flow, null));
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope coroutineScope, long j, long j2) {
        ...
        return ProduceKt.produce$default(coroutineScope, null, 0, new C01333(j2, j, null), 1, null);
    }
    ...
    static final class C01333 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* high-level source view WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01333(long j, long j2, Continuation<? super C01333> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01333 c01333 = new C01333(this.$initialDelayMillis, this.$delayMillis, continuation);
            c01333.L$0 = obj;
            return c01333;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C01333) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* high-level source view WARN: Removed duplicated region for block: B:17:0x0055 A[RETURN] */
        /* high-level source view WARN: Removed duplicated region for block: B:20:0x0065 A[RETURN] */
        /* high-level source view WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:19:0x0063 -> B:15:0x0042). Please report as a decompilation issue!!! */
        /*  high-level source view ERROR: high-level source viewOverflowException in pass: RegionMakerVisitor
            high-level source view.core.utils.exceptions.high-level source viewOverflowException: Regions count limit reached
            	at high-level source view.core.utils.ErrorsCounter.addError(ErrorsCounter.java:59)
            	at high-level source view.core.utils.ErrorsCounter.error(ErrorsCounter.java:31)
            	at high-level source view.core.dex.attributes.nodes.NotificationAttrNode.addError(NotificationAttrNode.java:19)
            */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L56:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C01333.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    public static final <T> Flow<T> m1867sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1824toDelayMillisLRDsOJo(j));
    }
}
