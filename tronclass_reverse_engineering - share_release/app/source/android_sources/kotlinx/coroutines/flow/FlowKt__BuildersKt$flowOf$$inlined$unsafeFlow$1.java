...
public final class FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:16:0x004f  */
    /* high-level source view WARN: Removed duplicated region for block: B:20:0x0066  */
    /* high-level source view WARN: Removed duplicated region for block: B:7:0x0014  */
    /* high-level source view WARN: Type inference failed for: r9v10 */
    ...
    /* high-level source view WARN: Type inference failed for: r9v7, types: [java.lang.Object, kotlinx.coroutines.flow.FlowCollector] */
    /* high-level source view WARN: Type inference failed for: r9v8 */
    /* high-level source view WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:17:0x0061 -> B:19:0x0064). Please report as a decompilation issue!!! */
