...
public final class DebugKt {
    ...
    /* high-level source view WARN: Code restructure failed: missing block: B:19:0x003a, code lost:
    
        if (r1.equals(kotlinx.coroutines.DebugKt.DEBUG_PROPERTY_VALUE_ON) != false) goto L23;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:22:0x0043, code lost:
    
        if (r1.equals("") != false) goto L23;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:23:0x0045, code lost:
    ...
    private static final void m1822assert(Function0<Boolean> function0) {
