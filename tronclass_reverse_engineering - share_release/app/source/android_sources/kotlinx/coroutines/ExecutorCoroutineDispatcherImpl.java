...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1885dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            ...
            if (timeSource == null || (runnableWrapTask = timeSource.wrapTask(block)) == null) {
            ...
            Dispatchers.getIO().mo1885dispatch(context, block);
        }
    }
    ...
    public void mo1886scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        ...
        ScheduledFuture<?> scheduledFutureScheduleBlock = scheduledExecutorService != null ? scheduleBlock(scheduledExecutorService, new ResumeUndispatchedRunnable(this, continuation), continuation.getContext(), timeMillis) : null;
        if (scheduledFutureScheduleBlock != null) {
            JobKt.cancelFutureOnCancellation(continuation, scheduledFutureScheduleBlock);
        } else {
            DefaultExecutor.INSTANCE.mo1886scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
