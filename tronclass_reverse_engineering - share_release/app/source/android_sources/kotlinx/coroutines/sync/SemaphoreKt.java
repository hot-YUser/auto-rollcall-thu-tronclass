...
public final class SemaphoreKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.sync.SemaphoreKt", f = "Semaphore.kt", i = {0, 0}, l = {Imgproc.COLOR_YUV2RGB}, m = "withPermit", n = {"$this$withPermit", "action"}, s = {"L$0", "L$1"})
