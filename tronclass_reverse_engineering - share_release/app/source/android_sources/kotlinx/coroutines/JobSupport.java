...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:15:0x0028  */
    /*
    ...
    */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:15:0x002e  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    private final Object tryMakeCompletingSlowPath(Incomplete state, Object proposedUpdate) throws Throwable {
        ...
        synchronized (finishing) {
            ...
            objectRef.element = Boolean.valueOf(true ^ zIsCancelling).booleanValue() ? finishing.getRootCause() : 0;
            Unit unit = Unit.INSTANCE;
    ...
    private static final class Finishing implements Incomplete {
        ...
        /* high-level source view WARN: Type inference failed for: r0v0, types: [boolean, int] */
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:15:0x0025  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private final void notifyCompletion(NodeList nodeList, Throwable th) throws Throwable {
        ...
        CompletionHandlerException completionHandlerException = null;
        for (LockFreeLinkedListNode nextNode = (LockFreeLinkedListNode) nodeList2.getNext(); !Intrinsics.areEqual(nextNode, nodeList2); nextNode = nextNode.getNextNode()) {
