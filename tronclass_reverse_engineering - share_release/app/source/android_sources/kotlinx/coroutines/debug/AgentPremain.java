...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM333constructorimpl = Result.m333constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM333constructorimpl = Result.m333constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m339isFailureimpl(objM333constructorimpl) ? null : objM333constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1862installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable unused) {
        }
    }
    public static final void m1862installSignalHandler$lambda1(Signal signal) {
