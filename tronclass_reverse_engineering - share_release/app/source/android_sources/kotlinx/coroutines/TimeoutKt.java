...
public final class TimeoutKt {
    ...
    public static final <T> Object m1832withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1824toDelayMillisLRDsOJo(j), function2, continuation);
    }

    /* high-level source view WARN: Removed duplicated region for block: B:7:0x0014  */
    /* high-level source view WARN: Type inference failed for: r4v1, types: [T, kotlinx.coroutines.TimeoutCoroutine] */
    /*
    ...
    */
    ...
    public static final <T> Object m1833withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1824toDelayMillisLRDsOJo(j), function2, continuation);
    }
