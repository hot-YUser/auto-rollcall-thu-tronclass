...
class Huffman {
    ...
    int encodedLength(ByteString byteString) {
        ...
        for (int i = 0; i < byteString.size(); i++) {
            j += (long) CODE_LENGTHS[byteString.getByte(i) & UByte.MAX_VALUE];
        }
        return (int) ((j + 7) >> 3);
    }
