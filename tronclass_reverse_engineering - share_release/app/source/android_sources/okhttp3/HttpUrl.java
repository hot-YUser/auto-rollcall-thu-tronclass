...
public final class HttpUrl {
    ...
    public boolean isHttps() {
        return this.scheme.equals(Bridge.CAPACITOR_HTTPS_SCHEME);
    }
    ...
    public List<String> encodedPathSegments() {
        ...
        while (iIndexOf < iDelimiterOffset) {
            int i = iIndexOf + 1;
            int iDelimiterOffset2 = Util.delimiterOffset(this.url, i, iDelimiterOffset, IOUtils.DIR_SEPARATOR_UNIX);
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = AnonymousClass1.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult[parseResult.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i == 2) {
    ...
    public static final class Builder {
        ...
        public Builder scheme(String str) {
            ...
            if (str.equalsIgnoreCase(Bridge.CAPACITOR_HTTP_SCHEME)) {
                this.scheme = Bridge.CAPACITOR_HTTP_SCHEME;
            } else if (str.equalsIgnoreCase(Bridge.CAPACITOR_HTTPS_SCHEME)) {
                this.scheme = Bridge.CAPACITOR_HTTPS_SCHEME;
            } else {
        ...
        ParseResult parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (schemeDelimiterOffset(str, iSkipLeadingAsciiWhitespace, iSkipTrailingAsciiWhitespace) != -1) {
                ...
                iSkipLeadingAsciiWhitespace += length;
    ...
    /* high-level source view WARN: Removed duplicated region for block: B:15:0x0039  */
    /*
