...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    public static final class Companion {
        ...
        /* high-level source view WARN: Code restructure failed: missing block: B:10:0x003f, code lost:
        ...
        public final String getClassSimpleName(Class<?> jClass) {
            ...
            if (jClass.isLocalClass()) {
                ...
                if (enclosingMethod != null) {
                    ...
                    strSubstringAfter$default = StringsKt.substringAfter$default(name, enclosingMethod.getName() + Typography.dollar, (String) null, 2, (Object) null);
                }
    ...
    static {
        ...
        map.put(Globalization.LONG, "kotlin.Long");
        ...
        for (String kotlinName : collectionValues) {
            ...
            Pair pair = TuplesKt.to(sb.append(StringsKt.substringAfterLast$default(kotlinName, FilenameUtils.EXTENSION_SEPARATOR, (String) null, 2, (Object) null)).append("CompanionObject").toString(), kotlinName + ".Companion");
        ...
        while (it.hasNext()) {
            ...
            linkedHashMap.put(entry2.getKey(), StringsKt.substringAfterLast$default((String) entry2.getValue(), FilenameUtils.EXTENSION_SEPARATOR, (String) null, 2, (Object) null));
        }
