...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String str, String oldValue, String newValue, boolean z) {
        ...
        do {
            sb.append((CharSequence) str2, i, iIndexOf).append(newValue);
            i = iIndexOf + length;
        ...
        String string = sb.append((CharSequence) str2, i, str.length()).toString();
    ...
    /* high-level source view WARN: Type inference failed for: r4v3, types: [kotlin.collections.IntIterator] */
