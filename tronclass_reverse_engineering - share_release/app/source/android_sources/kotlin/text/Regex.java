...
public final class Regex implements Serializable {
    ...
    /* high-level source view WARN: Illegal instructions before constructor call */
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C00871(input, limit, null));
    }
    ...
    static final class C00871 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* high-level source view WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00871(CharSequence charSequence, int i, Continuation<? super C00871> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00871 c00871 = Regex.this.new C00871(this.$input, this.$limit, continuation);
            c00871.L$0 = obj;
            return c00871;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C00871) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* high-level source view WARN: Removed duplicated region for block: B:20:0x0073 A[RETURN] */
        /* high-level source view WARN: Removed duplicated region for block: B:23:0x007e  */
        /* high-level source view WARN: Removed duplicated region for block: B:27:0x00a2 A[RETURN] */
        /* high-level source view WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:19:0x0071 -> B:21:0x0074). Please report as a decompilation issue!!! */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i2 == 0) {
                ...
                if (this.$limit == 1 || !matcher2.find()) {
                    ...
                    this.I$0 = i;
                    this.label = 2;
                    if (sequenceScope.yield(this.$input.subSequence(iEnd, matcher.start()).toString(), this) == coroutine_suspended) {
                    }
                    iEnd = matcher.end();
                    i++;
                    if (i != this.$limit - 1) {
                    ...
                    this.L$1 = null;
                    this.label = 3;
                    if (sequenceScope.yield(charSequence.subSequence(iEnd, charSequence.length()).toString(), this) == coroutine_suspended) {
                    }
