...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    /* high-level source view WARN: Type inference failed for: r4v5, types: [kotlin.collections.IntIterator] */
    ...
    /* high-level source view WARN: Type inference failed for: r2v4, types: [kotlin.collections.IntIterator] */
    ...
    /* high-level source view WARN: Type inference failed for: r8v2, types: [kotlin.collections.IntIterator] */
    ...
    public static final Sequence<String> lineSequence(CharSequence charSequence) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return StringsKt.splitToSequence$default(charSequence, new String[]{IOUtils.LINE_SEPARATOR_WINDOWS, IOUtils.LINE_SEPARATOR_UNIX, "\r"}, false, 0, 6, (Object) null);
    }
