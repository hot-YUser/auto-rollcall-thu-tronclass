...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1554getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public boolean isEmpty() {
        if (this.step > 0) {
            if (Integer.compare(this.first ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) > 0) {
                return true;
            }
        } else if (Integer.compare(this.first ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) < 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) UInt.m475toStringimpl(this.first)).append("..").append((Object) UInt.m475toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) UInt.m475toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m475toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1570fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
