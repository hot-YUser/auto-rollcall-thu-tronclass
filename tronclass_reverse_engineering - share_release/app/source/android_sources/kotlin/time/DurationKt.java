...
public final class DurationKt {
    ...
    private static final long m1786timesmvk6XK0(int i, long j) {
        return Duration.m1698timesUwyO8pc(j, i);
    }
    private static final long m1785timeskIfJnKk(double d, long j) {
        return Duration.m1697timesUwyO8pc(j, d);
    }
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1762getZEROUwyO8pc = Duration.INSTANCE.m1762getZEROUwyO8pc();
        ...
        if (str2.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str2.charAt(i3) != 'T') {
                    ...
                    int iIndexOf$default = StringsKt.indexOf$default((CharSequence) str3, FilenameUtils.EXTENSION_SEPARATOR, 0, false, 6, (Object) null);
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        z4 = z7;
                        long jM1696plusLRDsOJo = Duration.m1696plusLRDsOJo(jM1762getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1762getZEROUwyO8pc = Duration.m1696plusLRDsOJo(jM1696plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        z4 = z7;
                        jM1762getZEROUwyO8pc = Duration.m1696plusLRDsOJo(jM1762getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    z7 = z4;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, "Infinity".length()), true)) {
                jM1762getZEROUwyO8pc = Duration.INSTANCE.m1760getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < i) {
                    ...
                    String str7 = str5;
                    int iIndexOf$default2 = StringsKt.indexOf$default((CharSequence) str6, FilenameUtils.EXTENSION_SEPARATOR, 0, false, 6, (Object) null);
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1696plusLRDsOJo2 = Duration.m1696plusLRDsOJo(jM1762getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1762getZEROUwyO8pc = Duration.m1696plusLRDsOJo(jM1696plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM1762getZEROUwyO8pc = Duration.m1696plusLRDsOJo(jM1762getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1712unaryMinusUwyO8pc(jM1762getZEROUwyO8pc) : jM1762getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1660constructorimpl(j << 1);
    }
    public static final long durationOfMillis(long j) {
        return Duration.m1660constructorimpl((j << 1) + 1);
    }
    public static final long durationOf(long j, int i) {
        return Duration.m1660constructorimpl((j << 1) + ((long) i));
    }
