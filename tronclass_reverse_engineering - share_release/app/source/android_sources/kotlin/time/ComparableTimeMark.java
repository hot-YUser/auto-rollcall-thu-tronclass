...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1650minusLRDsOJo(long duration);
    long mo1651minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    ComparableTimeMark mo1652plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1655minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1652plusLRDsOJo(Duration.m1712unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1659compareToLRDsOJo(comparableTimeMark.mo1651minusUwyO8pc(other), Duration.INSTANCE.m1762getZEROUwyO8pc());
        }
    }
}
