    ...
    public final R runCallLoop() throws Throwable {
        while (true) {
            ...
            if (continuation != null) {
                if (!Result.m335equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                    this.result = DeepRecursiveKt.UNDEFINED_RESULT;
                    ...
                    try {
                        ...
                        Object objInvoke = ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function3, 3)).invoke(this, obj, continuation);
                        if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            Result.Companion companion = Result.INSTANCE;
                            continuation.resumeWith(Result.m333constructorimpl(objInvoke));
                        }
                    } catch (Throwable th) {
