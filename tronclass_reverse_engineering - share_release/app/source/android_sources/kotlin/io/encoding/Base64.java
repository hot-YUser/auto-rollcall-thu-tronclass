...
public class Base64 {
    ...
    /* high-level source view WARN: Code restructure failed: missing block: B:29:0x00d2, code lost:
    
        if (r7 == (-2)) goto L36;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:30:0x00d4, code lost:
    
        r3 = skipIllegalSymbolsIfMime(r19, r5, r23);
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:31:0x00d8, code lost:
    
        if (r3 < r23) goto L34;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:33:0x00dc, code lost:
    
        return r8 - r21;
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:34:0x00dd, code lost:
     ...
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:35:0x011b, code lost:
     ...
     */
    /* high-level source view WARN: Code restructure failed: missing block: B:37:0x0123, code lost:
    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (i3 == i && iHandlePaddingSymbol + 3 < endIndex) {
                ...
                int i6 = (iArr[source[iHandlePaddingSymbol] & UByte.MAX_VALUE] << 18) | (iArr[source[iHandlePaddingSymbol + 1] & UByte.MAX_VALUE] << 12) | (iArr[source[iHandlePaddingSymbol + 2] & UByte.MAX_VALUE] << 6) | iArr[source[iHandlePaddingSymbol + 3] & UByte.MAX_VALUE];
                if (i6 >= 0) {
                    destination[i2] = (byte) (i6 >> 16);
                    int i7 = i2 + 2;
                    destination[i2 + 1] = (byte) (i6 >> 8);
                    i2 += 3;
                    destination[i7] = (byte) i6;
                    iHandlePaddingSymbol = i5;
                }
                i = -8;
            }
            int i8 = source[iHandlePaddingSymbol] & UByte.MAX_VALUE;
            int i9 = iArr[i8];
            if (i9 >= 0) {
                ...
                if (!this.isMimeScheme) {
                    StringBuilder sbAppend = new StringBuilder("Invalid symbol '").append((char) i8).append("'(");
