    ...
    public static final boolean copyRecursively(File file, File target, boolean z, final Function2<? super File, ? super IOException, ? extends OnErrorAction> onError) {
        ...
        try {
            for (File file2 : FilesKt.walkTopDown(file).onFail(new Function2<File, IOException, Unit>() { // from class: kotlin.io.FilesKt__UtilsKt.copyRecursively.2
                ...
                public final void invoke2(File f, IOException e) throws TerminateException {
                ...
                if (!file2.exists()) {
                    ...
                    if (file2.isDirectory()) {
                        file3.mkdirs();
                    } else if (FilesKt.copyTo$default(file2, file3, z, 0, 4, null).length() != file2.length() && onError.invoke(file2, new IOException("Source file wasn't copied completely, length of destination file differs.")) == OnErrorAction.TERMINATE) {
                        return false;
                    }
                }
            }
