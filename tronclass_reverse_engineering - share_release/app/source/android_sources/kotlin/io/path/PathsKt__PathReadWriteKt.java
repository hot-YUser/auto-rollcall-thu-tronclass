...
class PathsKt__PathReadWriteKt {
    ...
    public static final void appendText(Path path, CharSequence text, Charset charset) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(outputStreamNewOutputStream, "newOutputStream(this, StandardOpenOption.APPEND)");
        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(outputStreamNewOutputStream, charset);
        try {
            outputStreamWriter.append(text);
            CloseableKt.closeFinally(outputStreamWriter, null);
    ...
    static /* synthetic */ void forEachLine$default(Path path, Charset charset, Function1 action, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(bufferedReaderNewBufferedReader, "newBufferedReader(this, charset)");
    ...
    static /* synthetic */ Path writeLines$default(Path path, Iterable lines, Charset charset, OpenOption[] options, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(pathWrite, "write(this, lines, charset, *options)");
        return pathWrite;
    }
    ...
    static /* synthetic */ Path writeLines$default(Path path, Sequence lines, Charset charset, OpenOption[] options, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(pathWrite, "write(this, lines.asIterable(), charset, *options)");
        return pathWrite;
    }
    ...
    static /* synthetic */ Path appendLines$default(Path path, Iterable lines, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(pathWrite, "write(this, lines, chars…tandardOpenOption.APPEND)");
        return pathWrite;
    }
    ...
    static /* synthetic */ Path appendLines$default(Path path, Sequence lines, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(pathWrite, "write(this, lines.asIter…tandardOpenOption.APPEND)");
        return pathWrite;
    }
