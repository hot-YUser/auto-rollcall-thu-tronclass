...
from troTHU.app_shell_dashboard import build_shell_dashboard_cards, build_shell_policy, format_shell_dashboard_cards, sanitize_shell_dashboard_value
...
# --- merged from tests/test_app_shell_dashboard.py ---
