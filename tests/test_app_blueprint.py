...
class AppBlueprintTest(unittest.TestCase):
    def test_blueprint_contains_required_screens_actions_contracts_and_targets(self) -> None:
        ...
        self.assertIn("provider_ready_gate", blueprint["actions"])
    ...
    def test_endpoint_contract_contains_required_future_paths(self) -> None:
        ...
        self.assertEqual(endpoints["provider_ready_gate"]["path"], "/app/api/provider/ready-gate")
        self.assertTrue(endpoints["provider_ready_gate"]["served_now"])
        ...
        self.assertEqual(endpoints["validation_summary"]["path"], "/app/api/validation/summary")
        self.assertTrue(endpoints["validation_summary"]["served_now"])
