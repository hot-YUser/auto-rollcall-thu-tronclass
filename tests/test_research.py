...
from troTHU.research_sandbox import ResearchCaptureError, append_research_capture, build_browser_capture_metadata, capture_research_api_target, sanitize_research_value, validate_research_target
from tests.fake_tron_server import FakeTronServer
from troTHU.debug_capture import append_debug_capture, sanitize_debug_payload


# --- merged from tests/test_research_sandbox.py ---
...
# --- merged from tests/test_debug_capture.py ---
TEST_WORKSPACE_DIR = Path(__file__).resolve().parents[1]
