...
class PackageDiagnosticsTest(unittest.TestCase):
    ...
    def test_pyinstaller_spec_excludes_local_secrets_and_tracks_hidden_imports(self) -> None:
        ...
        self.assertIn("troTHU.provider_ready_gate", report["hidden_imports"])
        self.assertIn("troTHU.provider_fixture_review", report["hidden_imports"])
        self.assertIn("troTHU.provider_verification", report["hidden_imports"])
    ...
    def test_hidden_import_gap_detection_reports_missing_runtime_module(self) -> None:
        ...
        self.assertIn("troTHU.provider_ready_gate", gaps)
        self.assertIn("troTHU.provider_fixture_review", gaps)
        self.assertIn("troTHU.provider_verification", gaps)
    ...
    def test_ci_workflow_is_unittest_only_and_does_not_reference_secrets(self) -> None:
        ...
        self.assertIn("tests.test_provider_verification", text)
        self.assertIn("tests.test_provider_ready_gate", text)
