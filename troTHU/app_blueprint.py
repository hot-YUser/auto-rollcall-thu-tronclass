...
def build_app_blueprint(config: Mapping[str, Any] | None = None) -> Dict[str, Any]:
    ...
    data_sources = {
        ...
        "provider_ready_gate": "FJU/TKU ready-gate criteria and sanitized acceptance state.",
    ...
    actions = {
        ...
        "provider_ready_gate": "Inspect FJU/TKU ready-gate blockers without changing provider state.",
    ...
    screens = [
        ...
        _screen(
            ...
            details={
                ...
                "experimental_provider_rule": "FJU/TKU imports require provider and WebView experimental gates.",
            },
        ),
        _screen(
            "diagnostics",
