...
_LEGACY_EXPORTS = {
    ...
    'activity_runtime_key': ('troTHU.autoanswer_runtime', 'activity_runtime_key'),
    ...
    'is_completed_radar_rollcall': ('troTHU.rollcall_runtime', 'is_completed_radar_rollcall'),
    'is_completed_self_registration_rollcall': ('troTHU.rollcall_runtime', 'is_completed_self_registration_rollcall'),
    ...
    'mark_completed_radar_rollcall': ('troTHU.rollcall_runtime', 'mark_completed_radar_rollcall'),
    'mark_completed_self_registration_rollcall': ('troTHU.rollcall_runtime', 'mark_completed_self_registration_rollcall'),
    ...
    'radar_rollcall_key': ('troTHU.rollcall_runtime', 'radar_rollcall_key'),
    'self_registration_rollcall_key': ('troTHU.rollcall_runtime', 'self_registration_rollcall_key'),
    'rollcall_completion_key': ('troTHU.rollcall_runtime', 'rollcall_completion_key'),
    ...
    'refresh_monitor_identity': ('troTHU.config_editor', 'refresh_monitor_identity'),
    ...
    'qr_rollcall_key': ('troTHU.qr_runtime', 'qr_rollcall_key'),
    'is_completed_qr_rollcall': ('troTHU.qr_runtime', 'is_completed_qr_rollcall'),
    'mark_completed_qr_rollcall': ('troTHU.qr_runtime', 'mark_completed_qr_rollcall'),
    'submit_prepared_teacher_qr': ('troTHU.qr_teacher_runtime', 'submit_prepared_teacher_qr'),
    'qr_remote_config': ('troTHU.qr_remote_runtime', 'qr_remote_config'),
    'normalize_qr_remote_config_section': ('troTHU.qr_remote_runtime', 'normalize_qr_remote_config_section'),
    'qr_remote_base_url_allowed': ('troTHU.qr_remote_runtime', 'qr_remote_base_url_allowed'),
