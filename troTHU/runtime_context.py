...
_LEGACY_EXPORTS = {
    ...
    'build_module_rollcall_payload': ('troTHU.teacher_rollcall', 'build_module_rollcall_payload'),
    'build_student_rollcall_history_update_payload': ('troTHU.teacher_rollcall', 'build_student_rollcall_history_update_payload'),
    'build_teacher_rollcall_payload': ('troTHU.teacher_rollcall', 'build_teacher_rollcall_payload'),
    'build_teacher_rollcall_update_payload': ('troTHU.teacher_rollcall', 'build_teacher_rollcall_update_payload'),
    'infer_course_role': ('troTHU.teacher_rollcall', 'infer_course_role'),
    'merge_course_role': ('troTHU.teacher_rollcall', 'merge_course_role'),
    ...
    'api_state_audit_enabled': ('troTHU.api_state_audit', 'api_state_audit_enabled'),
    'api_state_audit_options': ('troTHU.api_state_audit', 'api_state_audit_options'),
    'build_audit_context': ('troTHU.api_state_audit', 'build_audit_context'),
    'build_rollcall_state_signature': ('troTHU.api_state_audit', 'build_rollcall_state_signature'),
    'load_api_operation_rows': ('troTHU.api_state_audit', 'load_api_operation_rows'),
    'normalize_audit_method': ('troTHU.api_state_audit', 'normalize_audit_method'),
    'resolve_operation_url': ('troTHU.api_state_audit', 'resolve_operation_url'),
    'rollcall_state_has_activity': ('troTHU.api_state_audit', 'rollcall_state_has_activity'),
    'run_api_state_audit': ('troTHU.api_state_audit', 'run_api_state_audit'),
    ...
    'schedule_api_state_audit_on_change': ('troTHU.rollcall_runtime', 'schedule_api_state_audit_on_change'),
