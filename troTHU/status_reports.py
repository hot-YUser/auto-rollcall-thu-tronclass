...
def provider_block_message(action: str='daily automation') -> str:
    ...
    return "Provider {} is {} and is blocked for {}. Set provider.allow_experimental=true only after verifying this school's endpoints.".format(report.get('key', ctx.DEFAULT_PROVIDER), report.get('support_level', 'unsupported'), action)
